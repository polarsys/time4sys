...
public class LibraryTests extends TestSuite {
	...
	public static Test suite() {
		...
		suite.addTestSuite(TDMATest.class);
		suite.addTestSuite(DeadlineMonotonicSchedulingPolicyTest.class);
		suite.addTestSuite(RateMonotonicSchedulingPolicyTest.class);
		suite.addTestSuite(HardwareCANBusTest.class);
		return suite;
	}
