...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>mapping</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class MappingExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.mapping"));
				Link root = MappingFactory.eINSTANCE.createLink();
