...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>annotation</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class AnnotationExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.annotation"));
				ModelingConcern root = AnnotationFactory.eINSTANCE.createModelingConcern();
