...
public class PetrinetAdapterFactory extends AdapterFactoryImpl {
	...
	protected PetrinetSwitch<Adapter> modelSwitch =
		new PetrinetSwitch<Adapter>() {
			...
			@Override
			public Adapter caseTimedInhibitorArc(TimedInhibitorArc object) {
				return createTimedInhibitorArcAdapter();
			}
			@Override
			public Adapter caseFlushArc(FlushArc object) {
				return createFlushArcAdapter();
			}
			@Override
			public Adapter caseNormalArc(NormalArc object) {
				return createNormalArcAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link petrinet.Connection <em>Connection</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link petrinet.TimedInhibitorArc <em>Timed Inhibitor Arc</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTimedInhibitorArcAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link petrinet.FlushArc <em>Flush Arc</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFlushArcAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link petrinet.NormalArc <em>Normal Arc</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createNormalArcAdapter() {
		return null;
	}
