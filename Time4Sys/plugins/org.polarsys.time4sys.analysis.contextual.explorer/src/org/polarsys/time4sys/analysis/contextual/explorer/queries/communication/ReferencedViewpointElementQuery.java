...
package org.polarsys.time4sys.analysis.contextual.explorer.queries.communication;
...
public class ReferencedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		Communication object = (Communication) object_p;
		if (object.getBus() != null)
			result.add(object.getBus());
