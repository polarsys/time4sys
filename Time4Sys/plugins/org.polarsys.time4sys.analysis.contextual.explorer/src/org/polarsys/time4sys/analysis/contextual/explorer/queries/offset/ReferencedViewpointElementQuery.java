...
package org.polarsys.time4sys.analysis.contextual.explorer.queries.offset;
...
public class ReferencedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		Offset object = (Offset) object_p;
		if (object.getEventModel() != null)
			result.add(object.getEventModel());
