...
package org.polarsys.time4sys.analysis.contextual.explorer.queries.task;
...
public class ReferencedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		Task object = (Task) object_p;
		if (object.getMappedTo() != null)
			result.add(object.getMappedTo());
		if (object.getFirst() != null)
			result.add(object.getFirst());
