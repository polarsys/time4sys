...
package org.polarsys.time4sys.analysis.contextual.explorer.queries.eventmodel;
...
public class OwnedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		EventModel object = (EventModel) object_p;

		for (EObject eObject : object.getOffsets())
			result.add(eObject);
