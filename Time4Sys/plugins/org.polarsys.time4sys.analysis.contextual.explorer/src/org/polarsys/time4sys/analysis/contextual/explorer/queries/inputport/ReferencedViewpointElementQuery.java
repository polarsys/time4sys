...
package org.polarsys.time4sys.analysis.contextual.explorer.queries.inputport;
...
public class ReferencedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		InputPort object = (InputPort) object_p;
		if (object.getReceiveFrom() != null)
			result.add(object.getReceiveFrom());
