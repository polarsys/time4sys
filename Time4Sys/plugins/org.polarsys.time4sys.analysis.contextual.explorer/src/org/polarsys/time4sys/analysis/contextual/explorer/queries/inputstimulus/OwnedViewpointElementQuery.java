...
package org.polarsys.time4sys.analysis.contextual.explorer.queries.inputstimulus;
...
public class OwnedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		InputStimulus object = (InputStimulus) object_p;

		for (EObject eObject : object.getOutputPorts())
			result.add(eObject);
