...
package org.polarsys.time4sys.analysis.contextual.explorer.queries.delay;
...
public class ReferencedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		Delay object = (Delay) object_p;
		if (object.getParent() != null)
			result.add(object.getParent());
		if (object.getReferencedEvent() != null)
			result.add(object.getReferencedEvent());
