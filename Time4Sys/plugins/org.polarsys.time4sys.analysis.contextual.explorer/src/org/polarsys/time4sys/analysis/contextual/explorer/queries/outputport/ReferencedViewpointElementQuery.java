...
package org.polarsys.time4sys.analysis.contextual.explorer.queries.outputport;
...
public class ReferencedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		OutputPort object = (OutputPort) object_p;
		if (object.getSendTo() != null)
			result.add(object.getSendTo());
