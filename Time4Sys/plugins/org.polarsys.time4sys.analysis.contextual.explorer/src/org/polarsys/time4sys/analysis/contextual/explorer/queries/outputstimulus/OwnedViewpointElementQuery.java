...
package org.polarsys.time4sys.analysis.contextual.explorer.queries.outputstimulus;
...
public class OwnedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		OutputStimulus object = (OutputStimulus) object_p;

		for (EObject eObject : object.getInputPorts())
			result.add(eObject);
