...
package org.polarsys.time4sys.analysis.contextual.explorer.queries.computingresource;
...
public class ReferencedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		ComputingResource object = (ComputingResource) object_p;
		for (EObject eObject : object.getTasksAffectedOn())
			result.add(eObject);
		for (EObject eObject : object.getLinkedBy())
			result.add(eObject);
