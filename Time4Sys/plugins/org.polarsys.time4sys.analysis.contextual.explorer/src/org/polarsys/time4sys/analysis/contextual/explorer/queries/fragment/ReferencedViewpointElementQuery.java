...
package org.polarsys.time4sys.analysis.contextual.explorer.queries.fragment;
...
public class ReferencedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		Fragment object = (Fragment) object_p;
		if (object.getNext() != null)
			result.add(object.getNext());
		if (object.getPrevious() != null)
			result.add(object.getPrevious());
		if (object.getTask() != null)
			result.add(object.getTask());
