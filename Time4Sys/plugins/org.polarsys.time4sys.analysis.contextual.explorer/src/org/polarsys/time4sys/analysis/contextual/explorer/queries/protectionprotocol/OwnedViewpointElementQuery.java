...
package org.polarsys.time4sys.analysis.contextual.explorer.queries.protectionprotocol;
...
public class OwnedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		ProtectionProtocol object = (ProtectionProtocol) object_p;

		for (EObject eObject : object.getRequiredParameters())
			result.add(eObject);
		for (EObject eObject : object.getResourceParameterValue())
			result.add(eObject);
