...
package org.polarsys.time4sys.analysis.contextual.explorer.queries.constraintcontainer;
...
public class ReferencedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		ConstraintContainer object = (ConstraintContainer) object_p;
		if (object.getAnalyzedSystem() != null)
			result.add(object.getAnalyzedSystem());
