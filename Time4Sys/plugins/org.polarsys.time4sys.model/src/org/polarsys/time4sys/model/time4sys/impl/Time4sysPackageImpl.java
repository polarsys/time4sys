...
public class Time4sysPackageImpl extends EPackageImpl implements Time4sysPackage {
	 ...
	 * @see org.polarsys.time4sys.model.time4sys.Time4sysPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Time4sysPackageImpl() {
		super(eNS_URI, Time4sysFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Time4sysPackage#eINSTANCE} when that field is accessed.
	...
	public static Time4sysPackage init() {
		if (isInited) return (Time4sysPackage)EPackage.Registry.INSTANCE.getEPackage(Time4sysPackage.eNS_URI);

		// Obtain or create and register package
		Time4sysPackageImpl theTime4sysPackage = (Time4sysPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Time4sysPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Time4sysPackageImpl());
		...
		theTime4sysPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theTime4sysPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Time4sysPackage.eNS_URI, theTime4sysPackage);
		return theTime4sysPackage;
	}
