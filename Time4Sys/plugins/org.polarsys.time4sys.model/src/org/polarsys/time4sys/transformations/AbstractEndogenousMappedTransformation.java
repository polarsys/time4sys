 ...
 *
 */
public abstract class AbstractEndogenousMappedTransformation extends IdentityDerivation implements Observer {
	 ...
	 * @param source
	 */
	public AbstractEndogenousMappedTransformation(Project project, DesignModel source, final String transName) {
