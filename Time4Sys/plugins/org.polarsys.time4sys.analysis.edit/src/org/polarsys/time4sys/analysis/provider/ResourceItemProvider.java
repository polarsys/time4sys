...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.analysis.Resource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Resource_scheduler_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Resource_scheduler_feature", "_UI_Resource_type"),
				 AnalysisPackage.Literals.RESOURCE__SCHEDULER,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSpeedFactorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Resource_speedFactor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Resource_speedFactor_feature", "_UI_Resource_type"),
				 AnalysisPackage.Literals.RESOURCE__SPEED_FACTOR,
				 true,
				 false,
				 false,
	...
	protected void addDelayPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Resource_delay_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Resource_delay_feature", "_UI_Resource_type"),
				 AnalysisPackage.Literals.RESOURCE__DELAY,
				 true,
				 false,
				 false,
