...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.analysis.MemoryResource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MemoryResourceItemProvider extends ResourceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MemoryResource_size_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MemoryResource_size_feature", "_UI_MemoryResource_type"),
				 AnalysisPackage.Literals.MEMORY_RESOURCE__SIZE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MemoryResource.class)) {
			case AnalysisPackage.MEMORY_RESOURCE__SIZE:
