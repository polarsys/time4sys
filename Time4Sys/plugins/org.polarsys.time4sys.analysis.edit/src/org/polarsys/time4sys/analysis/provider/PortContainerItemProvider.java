...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.analysis.PortContainer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortContainerItemProvider 
	 ...
	 * @generated
	 */
	public PortContainerItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		InputJoinBehaviorKind labelValue = ((PortContainer)object).getBehaviorKind();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_PortContainer_type") :
			getString("_UI_PortContainer_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PortContainer.class)) {
