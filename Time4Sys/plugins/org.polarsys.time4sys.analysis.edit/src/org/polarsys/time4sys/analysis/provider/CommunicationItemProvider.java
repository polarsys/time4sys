...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.analysis.Communication} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommunicationItemProvider extends SchedulableElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Communication_bus_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Communication_bus_feature", "_UI_Communication_type"),
				 AnalysisPackage.Literals.COMMUNICATION__BUS,
				 true,
				 false,
				 true,
				 null,
