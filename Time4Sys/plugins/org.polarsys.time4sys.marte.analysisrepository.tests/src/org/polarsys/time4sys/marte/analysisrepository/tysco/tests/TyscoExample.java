...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>tysco</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class TyscoExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(TyscoPackage.eNS_URI, 
			 TyscoPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.tysco"));
				AnalysisRepository root = TyscoFactory.eINSTANCE.createAnalysisRepository();
