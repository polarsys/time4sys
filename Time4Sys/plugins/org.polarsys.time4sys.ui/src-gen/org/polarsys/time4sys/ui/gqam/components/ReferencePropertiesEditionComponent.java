...
public class ReferencePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(GqamViewsRepository.General.Properties.referenceName))
				generalPart.setReferenceName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, reference.getReferenceName()));
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == GqamViewsRepository.General.Properties.referenceName) {
			return GqamPackage.eINSTANCE.getReference_ReferenceName();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (GqamViewsRepository.General.Properties.referenceName == event.getAffectedEditor()) {
			reference.setReferenceName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
	}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (GqamPackage.eINSTANCE.getReference_ReferenceName().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && generalPart != null && isAccessible(GqamViewsRepository.General.Properties.referenceName)) {
				if (msg.getNewValue() != null) {
					generalPart.setReferenceName(EcoreUtil.convertToString(EcorePackage.Literals.ESTRING, msg.getNewValue()));
				} else {
					generalPart.setReferenceName("");
				}
			}
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			GqamPackage.eINSTANCE.getReference_ReferenceName()		);
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == GqamViewsRepository.General.Properties.referenceName || key == GqamViewsRepository.General.Properties.class;
	}
