 ...
 * 
 */
public class HardwareStorageManagerTimingPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public HardwareStorageManagerTimingPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject hardwareStorageManager, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(HrmViewsRepository.Timing.TimingProperties.accCtrlPolicy)) {
				accCtrlPolicySettings = new ReferencesTableSettings(hardwareStorageManager, GrmPackage.eINSTANCE.getResourceBroker_AccCtrlPolicy());
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == HrmViewsRepository.Timing.TimingProperties.accCtrlPolicy || key == HrmViewsRepository.Timing.TimingProperties.class;
	}
