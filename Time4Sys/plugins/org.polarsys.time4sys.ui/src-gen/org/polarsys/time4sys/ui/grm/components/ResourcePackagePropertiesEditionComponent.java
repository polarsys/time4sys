 ...
 * 
 */
public class ResourcePackagePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public ResourcePackagePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject resourcePackage, String editing_mode) {
		super(editingContext, resourcePackage, editing_mode);
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final ResourcePackage resourcePackage = (ResourcePackage)elt;
			final GeneralPropertiesEditionPart generalPart = (GeneralPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(GrmViewsRepository.General.Properties.name))
				generalPart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, resourcePackage.getName()));
			
			if (isAccessible(GrmViewsRepository.General.Properties.ownedElement)) {
				ownedElementSettings = new ReferencesTableSettings(resourcePackage, CoreElementsPackage.eINSTANCE.getPackage_OwnedElement());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == GrmViewsRepository.General.Properties.ownedElement) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		ResourcePackage resourcePackage = (ResourcePackage)semanticObject;
		if (GrmViewsRepository.General.Properties.name == event.getAffectedEditor()) {
			resourcePackage.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (GrmViewsRepository.General.Properties.ownedElement == event.getAffectedEditor()) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (CoreElementsPackage.eINSTANCE.getPackage_OwnedElement().equals(msg.getFeature()) && isAccessible(GrmViewsRepository.General.Properties.ownedElement))
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == GrmViewsRepository.General.Properties.name || key == GrmViewsRepository.General.Properties.ownedElement || key == GrmViewsRepository.General.Properties.class;
	}
