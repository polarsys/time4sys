 ...
 * 
 */
public class TimingPropertiesEditionPartImpl extends CompositePropertiesEditionPart
		implements ISWTPropertiesEditionPart, TimingPropertiesEditionPart {
		...
		composer = new PartComposer(timingStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == SrmViewsRepository.Timing.Properties.isPreemptable) {
					return createIsPreemptableCheckbox(parent);
				}
				if (key == SrmViewsRepository.Timing.Properties.isFixedMessageSize) {
					return createIsFixedMessageSizeCheckbox(parent);
				}
				...
				if (key == SrmViewsRepository.Timing.Properties.arrivalPattern) {
					return createArrivalPatternText(parent);
				}
				...
				if (key == SrmViewsRepository.Timing.Properties.waitingQueueCapacity) {
					return createWaitingQueueCapacityText(parent);
				}
				if (key == SrmViewsRepository.Timing.Properties.waitingQueuePolicy) {
					return createWaitingQueuePolicyEMFComboViewer(parent);
				}
				...
				if (key == SrmViewsRepository.Timing.Properties.messageQueuePolicy) {
					return createMessageQueuePolicyEMFComboViewer(parent);
				}
				if (key == SrmViewsRepository.Timing.Properties.mechanism) {
					return createMechanismEMFComboViewer(parent);
				}
				...
				if (key == SrmViewsRepository.Timing.Properties.accessTokenElements) {
					return createAccessTokenElementsAdvancedReferencesTable(parent);
				}
				...
				if (key == SrmViewsRepository.Timing.Properties.timers) {
					return createTimersAdvancedReferencesTable(parent);
				}
				...
				if (key == SrmViewsRepository.Timing.Properties.concurrentResources) {
					return createConcurrentResourcesAdvancedReferencesTable(parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(SrmMessages.TimingPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createCapacityText(Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TimingPropertiesEditionPartImpl.this, SrmViewsRepository.Timing.Properties.capacity,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Timing.Properties.capacity, SrmViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createIsFixedMessageSizeCheckbox(Composite parent) {
		isFixedMessageSize = new Button(parent, SWT.CHECK);
		isFixedMessageSize.setText(getDescription(SrmViewsRepository.Timing.Properties.isFixedMessageSize,
		...
		isFixedMessageSize.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TimingPropertiesEditionPartImpl.this,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				SrmViewsRepository.Timing.Properties.isFixedMessageSize, SrmViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createDurationText(Composite parent) {
		...
		duration.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TimingPropertiesEditionPartImpl.this, SrmViewsRepository.Timing.Properties.duration,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Timing.Properties.duration, SrmViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createArrivalPatternText(Composite parent) {
		...
		arrivalPattern = SWTUtils.createScrollableText(parent, SWT.BORDER);
		...
		arrivalPattern.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TimingPropertiesEditionPartImpl.this, SrmViewsRepository.Timing.Properties.arrivalPattern,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				SrmViewsRepository.Timing.Properties.arrivalPattern, SrmViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createPacketTimeText(Composite parent) {
		...
		packetTime.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TimingPropertiesEditionPartImpl.this, SrmViewsRepository.Timing.Properties.packetTime,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Timing.Properties.packetTime, SrmViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createBlockingTimeText(Composite parent) {
		...
		blockingTime.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TimingPropertiesEditionPartImpl.this, SrmViewsRepository.Timing.Properties.blockingTime,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Timing.Properties.blockingTime, SrmViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createWaitingQueueCapacityText(Composite parent) {
		...
		waitingQueueCapacity = SWTUtils.createScrollableText(parent, SWT.BORDER);
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				SrmViewsRepository.Timing.Properties.waitingQueueCapacity, SrmViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createWaitingQueuePolicyEMFComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				SrmViewsRepository.Timing.Properties.waitingQueuePolicy, SrmViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createPolicyEMFComboViewer(Composite parent) {
		...
		policy.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TimingPropertiesEditionPartImpl.this, SrmViewsRepository.Timing.Properties.policy,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Timing.Properties.policy, SrmViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createMessageQueuePolicyEMFComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				SrmViewsRepository.Timing.Properties.messageQueuePolicy, SrmViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createMechanismEMFComboViewer(Composite parent) {
		...
		mechanism.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TimingPropertiesEditionPartImpl.this, SrmViewsRepository.Timing.Properties.mechanism,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Timing.Properties.mechanism, SrmViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createTransmModeEMFComboViewer(Composite parent) {
		...
		transmMode.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TimingPropertiesEditionPartImpl.this, SrmViewsRepository.Timing.Properties.transmMode,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Timing.Properties.transmMode, SrmViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createConcurrentAccessProtocolEMFComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				SrmViewsRepository.Timing.Properties.concurrentAccessProtocol, SrmViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createAccessPolicyEMFComboViewer(Composite parent) {
		...
		accessPolicy.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TimingPropertiesEditionPartImpl.this, SrmViewsRepository.Timing.Properties.accessPolicy,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Timing.Properties.accessPolicy, SrmViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createDurationElementsMultiValuedEditor(Composite parent) {
		durationElements = SWTUtils.createScrollableText(parent, SWT.BORDER | SWT.READ_ONLY);
		...
		editDurationElements = new Button(parent, SWT.NONE);
		editDurationElements.setText(getDescription(SrmViewsRepository.Timing.Properties.durationElements,
		...
		editDurationElements.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TimingPropertiesEditionPartImpl.this, SrmViewsRepository.Timing.Properties.durationElements,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
	...
	protected Composite createMessageQueueCapacityElementsMultiValuedEditor(Composite parent) {
		messageQueueCapacityElements = SWTUtils.createScrollableText(parent, SWT.BORDER | SWT.READ_ONLY);
		...
		editMessageQueueCapacityElements = new Button(parent, SWT.NONE);
		editMessageQueueCapacityElements
				.setText(getDescription(SrmViewsRepository.Timing.Properties.messageQueueCapacityElements,
	...
	protected Composite createPriorityElementsMultiValuedEditor(Composite parent) {
		priorityElements = SWTUtils.createScrollableText(parent, SWT.BORDER | SWT.READ_ONLY);
		...
		editPriorityElements = new Button(parent, SWT.NONE);
		editPriorityElements.setText(getDescription(SrmViewsRepository.Timing.Properties.priorityElements,
		...
		editPriorityElements.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TimingPropertiesEditionPartImpl.this, SrmViewsRepository.Timing.Properties.priorityElements,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
	...
	protected Composite createMessageSizeElementsMultiValuedEditor(Composite parent) {
		messageSizeElements = SWTUtils.createScrollableText(parent, SWT.BORDER | SWT.READ_ONLY);
		...
		editMessageSizeElements = new Button(parent, SWT.NONE);
		editMessageSizeElements.setText(getDescription(SrmViewsRepository.Timing.Properties.messageSizeElements,
	...
	protected Composite createOccurenceCountElementsMultiValuedEditor(Composite parent) {
		occurenceCountElements = SWTUtils.createScrollableText(parent, SWT.BORDER | SWT.READ_ONLY);
		...
		editOccurenceCountElements = new Button(parent, SWT.NONE);
		editOccurenceCountElements.setText(getDescription(SrmViewsRepository.Timing.Properties.occurenceCountElements,
	...
	protected Composite createWaitingPolicyElementsMultiValuedEditor(Composite parent) {
		waitingPolicyElements = SWTUtils.createScrollableText(parent, SWT.BORDER | SWT.READ_ONLY);
		...
		editWaitingPolicyElements = new Button(parent, SWT.NONE);
		editWaitingPolicyElements.setText(getDescription(SrmViewsRepository.Timing.Properties.waitingPolicyElements,
	...
	protected Composite createDeadlineElementsMultiValuedEditor(Composite parent) {
		deadlineElements = SWTUtils.createScrollableText(parent, SWT.BORDER | SWT.READ_ONLY);
		...
		editDeadlineElements = new Button(parent, SWT.NONE);
		editDeadlineElements.setText(getDescription(SrmViewsRepository.Timing.Properties.deadlineElements,
		...
		editDeadlineElements.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TimingPropertiesEditionPartImpl.this, SrmViewsRepository.Timing.Properties.deadlineElements,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
	...
	protected Composite createDeadlineTypeElementsMultiValuedEditor(Composite parent) {
		deadlineTypeElements = SWTUtils.createScrollableText(parent, SWT.BORDER | SWT.READ_ONLY);
		...
		editDeadlineTypeElements = new Button(parent, SWT.NONE);
		editDeadlineTypeElements.setText(getDescription(SrmViewsRepository.Timing.Properties.deadlineTypeElements,
	...
	protected Composite createTimeSliceElementsMultiValuedEditor(Composite parent) {
		timeSliceElements = SWTUtils.createScrollableText(parent, SWT.BORDER | SWT.READ_ONLY);
		...
		editTimeSliceElements = new Button(parent, SWT.NONE);
		editTimeSliceElements.setText(getDescription(SrmViewsRepository.Timing.Properties.timeSliceElements,
	...
	protected Composite createAccCtrlPolicyAdvancedTableComposition(Composite parent) {
		...
		this.accCtrlPolicy.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Timing.Properties.accCtrlPolicy, SrmViewsRepository.SWT_KIND));
	...
	protected Composite createResCtrlPolicyAdvancedTableComposition(Composite parent) {
		...
		this.resCtrlPolicy.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Timing.Properties.resCtrlPolicy, SrmViewsRepository.SWT_KIND));
	 ...
	 * 
	 */
	protected Composite createAccessTokenElementsAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SrmViewsRepository.Timing.Properties.accessTokenElements,
				SrmMessages.TimingPropertiesEditionPart_AccessTokenElementsLabel);
		this.accessTokenElements = new ReferencesTable(label, new ReferencesTableListener() {
			public void handleAdd() {
		...
		this.accessTokenElements.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Timing.Properties.accessTokenElements, SrmViewsRepository.SWT_KIND));
		this.accessTokenElements.createControls(parent);
	...
	protected void moveAccessTokenElements(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				TimingPropertiesEditionPartImpl.this, SrmViewsRepository.Timing.Properties.accessTokenElements,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		accessTokenElements.refresh();
	}
	...
	protected Composite createMutualExclusionResourcesAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SrmViewsRepository.Timing.Properties.mutualExclusionResources,
		...
		this.mutualExclusionResources.setHelpText(propertiesEditionComponent.getHelpContent(
				SrmViewsRepository.Timing.Properties.mutualExclusionResources, SrmViewsRepository.SWT_KIND));
	...
	protected void moveMutualExclusionResources(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				TimingPropertiesEditionPartImpl.this, SrmViewsRepository.Timing.Properties.mutualExclusionResources,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		mutualExclusionResources.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createTimersAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SrmViewsRepository.Timing.Properties.timers,
				SrmMessages.TimingPropertiesEditionPart_TimersLabel);
		this.timers = new ReferencesTable(label, new ReferencesTableListener() {
			public void handleAdd() {
				addTimers();
			}
		...
		this.timers.createControls(parent);
	...
	protected Composite createProtectParamsAdvancedTableComposition(Composite parent) {
		...
		this.protectParams.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Timing.Properties.protectParams, SrmViewsRepository.SWT_KIND));
	 ...
	 * 
	 */
	protected Composite createConcurrentResourcesAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SrmViewsRepository.Timing.Properties.concurrentResources,
				SrmMessages.TimingPropertiesEditionPart_ConcurrentResourcesLabel);
		this.concurrentResources = new ReferencesTable(label, new ReferencesTableListener() {
			public void handleAdd() {
		...
		this.concurrentResources.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Timing.Properties.concurrentResources, SrmViewsRepository.SWT_KIND));
		this.concurrentResources.createControls(parent);
	...
	protected void moveConcurrentResources(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				TimingPropertiesEditionPartImpl.this, SrmViewsRepository.Timing.Properties.concurrentResources,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		concurrentResources.refresh();
	}
