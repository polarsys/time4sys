 ...
 * 
 */
public class ResourceServicePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public ResourceServicePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject resourceService, String editing_mode) {
		super(editingContext, resourceService, editing_mode);
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		ResourceService resourceService = (ResourceService)semanticObject;
		if (GrmViewsRepository.General.Properties.name == event.getAffectedEditor()) {
			resourceService.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
	}
