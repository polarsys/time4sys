 ...
 * 
 */
public class HardwareActuatorTimingPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public HardwareActuatorTimingPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject hardwareActuator, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(HrmViewsRepository.Timing.TimingProperties.clock)) {
				// init part
				clockSettings = new EObjectFlatComboSettings(hardwareActuator, HrmPackage.eINSTANCE.getHardwareResource_Clock());
