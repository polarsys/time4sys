 ...
 * 
 */
public class HardwareClockTimingPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public HardwareClockTimingPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject hardwareClock, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(HrmViewsRepository.Timing.TimingProperties.clock)) {
				// init part
				clockSettings = new EObjectFlatComboSettings(hardwareClock, HrmPackage.eINSTANCE.getHardwareResource_Clock());
