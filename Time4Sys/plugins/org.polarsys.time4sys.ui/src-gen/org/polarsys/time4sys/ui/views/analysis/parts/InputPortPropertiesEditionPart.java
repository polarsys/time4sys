 ...
 * @generated
 */
public interface InputPortPropertiesEditionPart {
	...
	/**
	 * @return the receiveFrom
	 * @generated
	 */
	public EObject getReceiveFrom();

	/**
	 * Init the receiveFrom
	 * @param settings the combo setting
	 */
	public void initReceiveFrom(EObjectFlatComboSettings settings);

	/**
	 * Defines a new receiveFrom
	 * @param newValue the new receiveFrom to set
	 * @generated
	 */
	...
	/**
	 * Adds the given filter to the receiveFrom edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
