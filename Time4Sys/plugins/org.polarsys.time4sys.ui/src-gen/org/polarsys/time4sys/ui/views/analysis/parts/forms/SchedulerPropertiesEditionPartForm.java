 ...
 * @generated
 */
public class SchedulerPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, SchedulerPropertiesEditionPart {
	 ...
	 */
	public SchedulerPropertiesEditionPartForm() { super(); }
	 ...
	 * @generated
	 */
	public SchedulerPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(schedulerStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == AnalysisViewsRepository.Scheduler.Properties.policyKind) {
					return createPolicyKindEMFComboViewer(widgetFactory, parent);
				}
				if (key == AnalysisViewsRepository.Scheduler.Properties.scheduledElements) {
					return createScheduledElementsReferencesTable(widgetFactory, parent);
				}
				if (key == AnalysisViewsRepository.Scheduler.Properties.usedBy) {
					return createUsedByFlatComboViewer(parent, widgetFactory);
				}
				...
				if (key == AnalysisViewsRepository.Scheduler.Properties.preferredPolicy) {
					return createPreferredPolicyText(widgetFactory, parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(AnalysisMessages.SchedulerPropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							SchedulerPropertiesEditionPartForm.this,
							AnalysisViewsRepository.Scheduler.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SchedulerPropertiesEditionPartForm.this, AnalysisViewsRepository.Scheduler.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, AnalysisViewsRepository.Scheduler.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Scheduler.Properties.name, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPolicyKindEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		policyKind.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SchedulerPropertiesEditionPartForm.this, AnalysisViewsRepository.Scheduler.Properties.policyKind, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getPolicyKind()));
			}

		});
		policyKind.setID(AnalysisViewsRepository.Scheduler.Properties.policyKind);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Scheduler.Properties.policyKind, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * @generated
	 */
	protected Composite createScheduledElementsReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.scheduledElements = new ReferencesTable(getDescription(AnalysisViewsRepository.Scheduler.Properties.scheduledElements, AnalysisMessages.SchedulerPropertiesEditionPart_ScheduledElementsLabel), new ReferencesTableListener	() {
		...
		this.scheduledElements.setHelpText(propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Scheduler.Properties.scheduledElements, AnalysisViewsRepository.FORM_KIND));
		this.scheduledElements.createControls(parent, widgetFactory);
		this.scheduledElements.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SchedulerPropertiesEditionPartForm.this, AnalysisViewsRepository.Scheduler.Properties.scheduledElements, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		// Start of user code for createScheduledElementsReferencesTable
		...
		"scheduledElements", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SchedulerPropertiesEditionPartForm.this, AnalysisViewsRepository.Scheduler.Properties.scheduledElements,
	...
	protected void moveScheduledElements(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SchedulerPropertiesEditionPartForm.this, AnalysisViewsRepository.Scheduler.Properties.scheduledElements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		scheduledElements.refresh();
	}
	...
	protected void removeFromScheduledElements(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SchedulerPropertiesEditionPartForm.this, AnalysisViewsRepository.Scheduler.Properties.scheduledElements, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		scheduledElements.refresh();
	}
	 ...
	 * @generated
	 */
	protected Composite createUsedByFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		usedBy = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(AnalysisViewsRepository.Scheduler.Properties.usedBy, AnalysisViewsRepository.FORM_KIND));
		widgetFactory.adapt(usedBy);
		...
		usedBy.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SchedulerPropertiesEditionPartForm.this, AnalysisViewsRepository.Scheduler.Properties.usedBy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getUsedBy()));
			}

		});
		usedBy.setID(AnalysisViewsRepository.Scheduler.Properties.usedBy);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Scheduler.Properties.usedBy, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createRequiredParametersTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.requiredParameters = new ReferencesTable(getDescription(AnalysisViewsRepository.Scheduler.Properties.requiredParameters, AnalysisMessages.SchedulerPropertiesEditionPart_RequiredParametersLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SchedulerPropertiesEditionPartForm.this, AnalysisViewsRepository.Scheduler.Properties.requiredParameters, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				requiredParameters.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SchedulerPropertiesEditionPartForm.this, AnalysisViewsRepository.Scheduler.Properties.requiredParameters, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				requiredParameters.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SchedulerPropertiesEditionPartForm.this, AnalysisViewsRepository.Scheduler.Properties.requiredParameters, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				requiredParameters.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SchedulerPropertiesEditionPartForm.this, AnalysisViewsRepository.Scheduler.Properties.requiredParameters, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				requiredParameters.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.requiredParameters.setHelpText(propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Scheduler.Properties.requiredParameters, AnalysisViewsRepository.FORM_KIND));
		...
		this.requiredParameters.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SchedulerPropertiesEditionPartForm.this, AnalysisViewsRepository.Scheduler.Properties.requiredParameters, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createParent_FlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		parent_ = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(AnalysisViewsRepository.Scheduler.Properties.parent_, AnalysisViewsRepository.FORM_KIND));
		...
		parent_.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SchedulerPropertiesEditionPartForm.this, AnalysisViewsRepository.Scheduler.Properties.parent_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getParent_()));
			}

		});
		parent_.setID(AnalysisViewsRepository.Scheduler.Properties.parent_);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Scheduler.Properties.parent_, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createResourceParameterValueTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.resourceParameterValue = new ReferencesTable(getDescription(AnalysisViewsRepository.Scheduler.Properties.resourceParameterValue, AnalysisMessages.SchedulerPropertiesEditionPart_ResourceParameterValueLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SchedulerPropertiesEditionPartForm.this, AnalysisViewsRepository.Scheduler.Properties.resourceParameterValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				resourceParameterValue.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SchedulerPropertiesEditionPartForm.this, AnalysisViewsRepository.Scheduler.Properties.resourceParameterValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				resourceParameterValue.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SchedulerPropertiesEditionPartForm.this, AnalysisViewsRepository.Scheduler.Properties.resourceParameterValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				resourceParameterValue.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SchedulerPropertiesEditionPartForm.this, AnalysisViewsRepository.Scheduler.Properties.resourceParameterValue, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				resourceParameterValue.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.resourceParameterValue.setHelpText(propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Scheduler.Properties.resourceParameterValue, AnalysisViewsRepository.FORM_KIND));
		...
		this.resourceParameterValue.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SchedulerPropertiesEditionPartForm.this, AnalysisViewsRepository.Scheduler.Properties.resourceParameterValue, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createPreferredPolicyText(FormToolkit widgetFactory, Composite parent) {
		...
		preferredPolicy = widgetFactory.createText(parent, ""); //$NON-NLS-1$
		preferredPolicy.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
		widgetFactory.paintBordersFor(parent);
		...
		preferredPolicy.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							SchedulerPropertiesEditionPartForm.this,
							AnalysisViewsRepository.Scheduler.Properties.preferredPolicy,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, preferredPolicy.getText()));
					propertiesEditionComponent
							.firePropertiesChanged(new PropertiesEditionEvent(
									SchedulerPropertiesEditionPartForm.this,
									AnalysisViewsRepository.Scheduler.Properties.preferredPolicy,
									PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST,
									null, preferredPolicy.getText()));
				}
			}
		...
		preferredPolicy.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(SchedulerPropertiesEditionPartForm.this, AnalysisViewsRepository.Scheduler.Properties.preferredPolicy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, preferredPolicy.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Scheduler.Properties.preferredPolicy, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
