 ...
 * @generated
 */
public class ResourceSchedulingParameterValuePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ResourceSchedulingParameterValuePropertiesEditionPart {
	 ...
	 */
	public ResourceSchedulingParameterValuePropertiesEditionPartForm() { super(); }
	 ...
	 * @generated
	 */
	public ResourceSchedulingParameterValuePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ResourceSchedulingParameterValuePropertiesEditionPartForm.this,
							AnalysisViewsRepository.ResourceSchedulingParameterValue.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ResourceSchedulingParameterValuePropertiesEditionPartForm.this, AnalysisViewsRepository.ResourceSchedulingParameterValue.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, AnalysisViewsRepository.ResourceSchedulingParameterValue.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.ResourceSchedulingParameterValue.Properties.name, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createValueText(FormToolkit widgetFactory, Composite parent) {
		...
		value.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ResourceSchedulingParameterValuePropertiesEditionPartForm.this,
							AnalysisViewsRepository.ResourceSchedulingParameterValue.Properties.value,
		...
		value.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ResourceSchedulingParameterValuePropertiesEditionPartForm.this, AnalysisViewsRepository.ResourceSchedulingParameterValue.Properties.value, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, value.getText()));
				}
			}
		});
		EditingUtils.setID(value, AnalysisViewsRepository.ResourceSchedulingParameterValue.Properties.value);
		EditingUtils.setEEFtype(value, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.ResourceSchedulingParameterValue.Properties.value, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
