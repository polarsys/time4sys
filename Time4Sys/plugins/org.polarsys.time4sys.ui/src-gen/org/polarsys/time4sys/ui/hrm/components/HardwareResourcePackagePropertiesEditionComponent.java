 ...
 * 
 */
public class HardwareResourcePackagePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public HardwareResourcePackagePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject hardwareResourcePackage, String editing_mode) {
		super(editingContext, hardwareResourcePackage, editing_mode);
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final HardwareResourcePackage hardwareResourcePackage = (HardwareResourcePackage)elt;
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		HardwareResourcePackage hardwareResourcePackage = (HardwareResourcePackage)semanticObject;
		if (HrmViewsRepository.General.Properties.name == event.getAffectedEditor()) {
			hardwareResourcePackage.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
