 ...
 * 
 */
public class MemoryPartitionTimingPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public MemoryPartitionTimingPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject memoryPartition, String editing_mode) {
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == SrmViewsRepository.Timing.Properties.concurrentResources) {
			return SrmPackage.eINSTANCE.getMemoryPartition_ConcurrentResources();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (SrmViewsRepository.Timing.Properties.concurrentResources == event.getAffectedEditor()) {
			// FIXME INVALID CASE you must override the template 'declareEObjectUpdater' for the case : concurrentResources, Timing, MemoryPartition.
		}
	}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			// FIXME INVALID CASE INTO template public liveUpdater(editionElement : PropertiesEditionElement, view : View, pec : PropertiesEditionComponent) in widgetControl.mtl module, with the values : concurrentResources, Timing, MemoryPartition.
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			SrmPackage.eINSTANCE.getMemoryPartition_ConcurrentResources()		);
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == SrmViewsRepository.Timing.Properties.resCtrlPolicy || key == SrmViewsRepository.Timing.Properties.concurrentResources || key == SrmViewsRepository.Timing.Properties.class;
	}
