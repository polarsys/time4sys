 ...
 * 
 */
public class HardwareBranchPredictorOtherPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public HardwareBranchPredictorOtherPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject hardwareBranchPredictor, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(HrmViewsRepository.Other.Properties.pServices)) {
				pServicesSettings = new ReferencesTableSettings(hardwareBranchPredictor, GrmPackage.eINSTANCE.getResource_PServices());
				otherPart.initPServices(pServicesSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.ownedPort)) {
				ownedPortSettings = new ReferencesTableSettings(hardwareBranchPredictor, GrmPackage.eINSTANCE.getResource_OwnedPort());
				otherPart.initOwnedPort(ownedPortSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.rServices)) {
				rServicesSettings = new ReferencesTableSettings(hardwareBranchPredictor, GrmPackage.eINSTANCE.getResource_RServices());
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == HrmViewsRepository.Other.Properties.pServices || key == HrmViewsRepository.Other.Properties.ownedPort || key == HrmViewsRepository.Other.Properties.rServices || key == HrmViewsRepository.Other.Properties.class;
	}
