 ...
 * 
 */
public class StaticUsagePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public StaticUsagePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject staticUsage, String editing_mode) {
		super(editingContext, staticUsage, editing_mode);
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final StaticUsage staticUsage = (StaticUsage)elt;
			final GeneralPropertiesEditionPart generalPart = (GeneralPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(GrmViewsRepository.General.Properties.workload)) {
				workloadSettings = new ReferencesTableSettings(staticUsage, GrmPackage.eINSTANCE.getResourceUsage_Workload());
				generalPart.initWorkload(workloadSettings);
			}
			if (isAccessible(GrmViewsRepository.General.Properties.requiredAmount)) {
				requiredAmountSettings = new ReferencesTableSettings(staticUsage, GrmPackage.eINSTANCE.getResourceUsage_RequiredAmount());
				generalPart.initRequiredAmount(requiredAmountSettings);
			}
			if (isAccessible(GrmViewsRepository.General.Properties.usedResource)) {
				usedResourceSettings = new ReferencesTableSettings(staticUsage, GrmPackage.eINSTANCE.getResourceUsage_UsedResource());
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		StaticUsage staticUsage = (StaticUsage)semanticObject;
