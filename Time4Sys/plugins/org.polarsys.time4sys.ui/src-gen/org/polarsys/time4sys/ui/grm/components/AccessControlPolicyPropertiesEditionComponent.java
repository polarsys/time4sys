 ...
 * 
 */
public class AccessControlPolicyPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public AccessControlPolicyPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject accessControlPolicy, String editing_mode) {
		super(editingContext, accessControlPolicy, editing_mode);
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final AccessControlPolicy accessControlPolicy = (AccessControlPolicy)elt;
			final GeneralPropertiesEditionPart generalPart = (GeneralPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(GrmViewsRepository.General.Properties.name))
				generalPart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, accessControlPolicy.getName()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		AccessControlPolicy accessControlPolicy = (AccessControlPolicy)semanticObject;
		if (GrmViewsRepository.General.Properties.name == event.getAffectedEditor()) {
			accessControlPolicy.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
	}
