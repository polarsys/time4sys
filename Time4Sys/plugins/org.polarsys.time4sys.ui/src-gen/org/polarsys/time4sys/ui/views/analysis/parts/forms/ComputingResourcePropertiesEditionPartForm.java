 ...
 * @generated
 */
public class ComputingResourcePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ComputingResourcePropertiesEditionPart {
	 ...
	 */
	public ComputingResourcePropertiesEditionPartForm() { super(); }
	 ...
	 * @generated
	 */
	public ComputingResourcePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(computingResourceStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == AnalysisViewsRepository.ComputingResource.Properties.tasksAffectedOn) {
					return createTasksAffectedOnReferencesTable(widgetFactory, parent);
				}
				if (key == AnalysisViewsRepository.ComputingResource.Properties.linkedBy) {
					return createLinkedByReferencesTable(widgetFactory, parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(AnalysisMessages.ComputingResourcePropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ComputingResourcePropertiesEditionPartForm.this,
							AnalysisViewsRepository.ComputingResource.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComputingResourcePropertiesEditionPartForm.this, AnalysisViewsRepository.ComputingResource.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, AnalysisViewsRepository.ComputingResource.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.ComputingResource.Properties.name, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createSchedulerFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		scheduler = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(AnalysisViewsRepository.ComputingResource.Properties.scheduler, AnalysisViewsRepository.FORM_KIND));
		...
		scheduler.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComputingResourcePropertiesEditionPartForm.this, AnalysisViewsRepository.ComputingResource.Properties.scheduler, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getScheduler()));
			}

		});
		scheduler.setID(AnalysisViewsRepository.ComputingResource.Properties.scheduler);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.ComputingResource.Properties.scheduler, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createParent_FlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		parent_ = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(AnalysisViewsRepository.ComputingResource.Properties.parent_, AnalysisViewsRepository.FORM_KIND));
		...
		parent_.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComputingResourcePropertiesEditionPartForm.this, AnalysisViewsRepository.ComputingResource.Properties.parent_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getParent_()));
			}

		});
		parent_.setID(AnalysisViewsRepository.ComputingResource.Properties.parent_);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.ComputingResource.Properties.parent_, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createSpeedFactorText(FormToolkit widgetFactory, Composite parent) {
		...
		speedFactor.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ComputingResourcePropertiesEditionPartForm.this,
							AnalysisViewsRepository.ComputingResource.Properties.speedFactor,
		...
		speedFactor.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComputingResourcePropertiesEditionPartForm.this, AnalysisViewsRepository.ComputingResource.Properties.speedFactor, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, speedFactor.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.ComputingResource.Properties.speedFactor, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createDelayText(FormToolkit widgetFactory, Composite parent) {
		...
		delay.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ComputingResourcePropertiesEditionPartForm.this,
							AnalysisViewsRepository.ComputingResource.Properties.delay,
		...
		delay.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComputingResourcePropertiesEditionPartForm.this, AnalysisViewsRepository.ComputingResource.Properties.delay, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, delay.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.ComputingResource.Properties.delay, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * @generated
	 */
	protected Composite createTasksAffectedOnReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.tasksAffectedOn = new ReferencesTable(getDescription(AnalysisViewsRepository.ComputingResource.Properties.tasksAffectedOn, AnalysisMessages.ComputingResourcePropertiesEditionPart_TasksAffectedOnLabel), new ReferencesTableListener	() {
		...
		this.tasksAffectedOn.setHelpText(propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.ComputingResource.Properties.tasksAffectedOn, AnalysisViewsRepository.FORM_KIND));
		this.tasksAffectedOn.createControls(parent, widgetFactory);
		this.tasksAffectedOn.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComputingResourcePropertiesEditionPartForm.this, AnalysisViewsRepository.ComputingResource.Properties.tasksAffectedOn, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		// Start of user code for createTasksAffectedOnReferencesTable
		...
		"tasksAffectedOn", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComputingResourcePropertiesEditionPartForm.this, AnalysisViewsRepository.ComputingResource.Properties.tasksAffectedOn,
	...
	protected void moveTasksAffectedOn(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComputingResourcePropertiesEditionPartForm.this, AnalysisViewsRepository.ComputingResource.Properties.tasksAffectedOn, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		tasksAffectedOn.refresh();
	}
	...
	protected void removeFromTasksAffectedOn(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComputingResourcePropertiesEditionPartForm.this, AnalysisViewsRepository.ComputingResource.Properties.tasksAffectedOn, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		tasksAffectedOn.refresh();
	}
	 ...
	 * @generated
	 */
	protected Composite createLinkedByReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.linkedBy = new ReferencesTable(getDescription(AnalysisViewsRepository.ComputingResource.Properties.linkedBy, AnalysisMessages.ComputingResourcePropertiesEditionPart_LinkedByLabel), new ReferencesTableListener	() {
		...
		this.linkedBy.setHelpText(propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.ComputingResource.Properties.linkedBy, AnalysisViewsRepository.FORM_KIND));
		this.linkedBy.createControls(parent, widgetFactory);
		this.linkedBy.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComputingResourcePropertiesEditionPartForm.this, AnalysisViewsRepository.ComputingResource.Properties.linkedBy, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		// Start of user code for createLinkedByReferencesTable
	...
	protected void addLinkedBy() {
		...
		"linkedBy", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComputingResourcePropertiesEditionPartForm.this, AnalysisViewsRepository.ComputingResource.Properties.linkedBy,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				linkedBy.refresh();
			}
	...
	protected void moveLinkedBy(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComputingResourcePropertiesEditionPartForm.this, AnalysisViewsRepository.ComputingResource.Properties.linkedBy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		linkedBy.refresh();
	}
	...
	protected void removeFromLinkedBy(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ComputingResourcePropertiesEditionPartForm.this, AnalysisViewsRepository.ComputingResource.Properties.linkedBy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		linkedBy.refresh();
	}
