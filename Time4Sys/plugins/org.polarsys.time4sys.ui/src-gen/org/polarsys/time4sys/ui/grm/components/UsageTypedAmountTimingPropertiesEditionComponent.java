 ...
 * 
 */
public class UsageTypedAmountTimingPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public UsageTypedAmountTimingPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject usageTypedAmount, String editing_mode) {
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == GrmViewsRepository.Timing.TimingProperties.execTime) {
			return GrmPackage.eINSTANCE.getUsageTypedAmount_ExecTime();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (GrmViewsRepository.Timing.TimingProperties.execTime == event.getAffectedEditor()) {
			usageTypedAmount.setExecTime((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
	}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (GrmPackage.eINSTANCE.getUsageTypedAmount_ExecTime().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && timingPart != null && isAccessible(GrmViewsRepository.Timing.TimingProperties.execTime)) {
				if (msg.getNewValue() != null) {
					timingPart.setExecTime(EcoreUtil.convertToString(EcorePackage.Literals.EINT, msg.getNewValue()));
				} else {
					timingPart.setExecTime("");
				}
			}
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			GrmPackage.eINSTANCE.getUsageTypedAmount_ExecTime()		);
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == GrmViewsRepository.Timing.TimingProperties.execTime || key == GrmViewsRepository.Timing.TimingProperties.class;
	}
