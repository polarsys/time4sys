 ...
 * 
 */
public class HardwareCacheGeneralPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public HardwareCacheGeneralPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject hardwareCache, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(HrmViewsRepository.General.Properties.name))
				generalPart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, hardwareCache.getName()));
			
			if (isAccessible(HrmViewsRepository.General.Properties.ownedResource)) {
				ownedResourceSettings = new ReferencesTableSettings(hardwareCache, GrmPackage.eINSTANCE.getResource_OwnedResource());
				generalPart.initOwnedResource(ownedResourceSettings);
			}
			if (isAccessible(HrmViewsRepository.General.Properties.resMult)) {
				generalPart.setResMult(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareCache.getResMult()));
			}
			
			if (isAccessible(HrmViewsRepository.General.Properties.isProtected)) {
				generalPart.setIsProtected(hardwareCache.isIsProtected());
			}
			if (isAccessible(HrmViewsRepository.General.Properties.isActive)) {
				generalPart.setIsActive(hardwareCache.isIsActive());
			}
			if (isAccessible(HrmViewsRepository.General.Properties.ownedConnector)) {
				ownedConnectorSettings = new ReferencesTableSettings(hardwareCache, GrmPackage.eINSTANCE.getResource_OwnedConnector());
				generalPart.initOwnedConnector(ownedConnectorSettings);
			}
			if (isAccessible(HrmViewsRepository.General.Properties.usedBy)) {
				usedBySettings = new ReferencesTableSettings(hardwareCache, GrmPackage.eINSTANCE.getResource_UsedBy());
				generalPart.initUsedBy(usedBySettings);
			}
			if (isAccessible(HrmViewsRepository.General.Properties.memorySize)) {
				generalPart.setMemorySize(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareCache.getMemorySize()));
			}
			
			if (isAccessible(HrmViewsRepository.General.Properties.addressSize)) {
				generalPart.setAddressSize(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareCache.getAddressSize()));
			}
			
			if (isAccessible(HrmViewsRepository.General.Properties.throughput)) {
				generalPart.setThroughput(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareCache.getThroughput()));
			}
			
			if (isAccessible(HrmViewsRepository.General.Properties.level)) {
				generalPart.setLevel(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareCache.getLevel()));
			}
			
			if (isAccessible(HrmViewsRepository.General.Properties.type)) {
				generalPart.initType(EEFUtils.choiceOfValues(hardwareCache, HrmPackage.eINSTANCE.getHardwareCache_Type()), hardwareCache.getType());
			}
			// init filters
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == HrmViewsRepository.General.Properties.level) {
			return HrmPackage.eINSTANCE.getHardwareCache_Level();
		}
		if (editorKey == HrmViewsRepository.General.Properties.type) {
			return HrmPackage.eINSTANCE.getHardwareCache_Type();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (HrmViewsRepository.General.Properties.name == event.getAffectedEditor()) {
			hardwareCache.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		...
		if (HrmViewsRepository.General.Properties.resMult == event.getAffectedEditor()) {
			hardwareCache.setResMult((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.General.Properties.isProtected == event.getAffectedEditor()) {
			hardwareCache.setIsProtected((Boolean)event.getNewValue());
		}
		if (HrmViewsRepository.General.Properties.isActive == event.getAffectedEditor()) {
			hardwareCache.setIsActive((Boolean)event.getNewValue());
		}
		...
		if (HrmViewsRepository.General.Properties.memorySize == event.getAffectedEditor()) {
			hardwareCache.setMemorySize((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.General.Properties.addressSize == event.getAffectedEditor()) {
			hardwareCache.setAddressSize((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.General.Properties.throughput == event.getAffectedEditor()) {
			hardwareCache.setThroughput((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.General.Properties.level == event.getAffectedEditor()) {
			hardwareCache.setLevel((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.General.Properties.type == event.getAffectedEditor()) {
			hardwareCache.setType((CacheType)event.getNewValue());
		}
	}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (HrmPackage.eINSTANCE.getHardwareCache_Level().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && generalPart != null && isAccessible(HrmViewsRepository.General.Properties.level)) {
				if (msg.getNewValue() != null) {
					generalPart.setLevel(EcoreUtil.convertToString(EcorePackage.Literals.EINT, msg.getNewValue()));
				} else {
					generalPart.setLevel("");
				}
			}
			if (HrmPackage.eINSTANCE.getHardwareCache_Type().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(HrmViewsRepository.General.Properties.type))
				generalPart.setType((CacheType)msg.getNewValue());
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			HrmPackage.eINSTANCE.getHardwareCache_Level(),
			HrmPackage.eINSTANCE.getHardwareCache_Type()		);
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == HrmViewsRepository.General.Properties.name || key == HrmViewsRepository.General.Properties.ownedResource || key == HrmViewsRepository.General.Properties.resMult || key == HrmViewsRepository.General.Properties.isProtected || key == HrmViewsRepository.General.Properties.isActive || key == HrmViewsRepository.General.Properties.ownedConnector || key == HrmViewsRepository.General.Properties.usedBy || key == HrmViewsRepository.General.Properties.memorySize || key == HrmViewsRepository.General.Properties.addressSize || key == HrmViewsRepository.General.Properties.throughput || key == HrmViewsRepository.General.Properties.level || key == HrmViewsRepository.General.Properties.type || key == HrmViewsRepository.General.Properties.class;
	}
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (HrmViewsRepository.General.Properties.level == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HrmPackage.eINSTANCE.getHardwareCache_Level().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HrmPackage.eINSTANCE.getHardwareCache_Level().getEAttributeType(), newValue);
				}
				if (HrmViewsRepository.General.Properties.type == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HrmPackage.eINSTANCE.getHardwareCache_Type().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HrmPackage.eINSTANCE.getHardwareCache_Type().getEAttributeType(), newValue);
				}
