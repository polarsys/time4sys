 ...
 * @generated
 */
public class ResultContainerPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ResultContainerPropertiesEditionPart {
	 ...
	 * @generated
	 */
	public ResultContainerPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(AnalysisMessages.ResultContainerPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ResultContainerPropertiesEditionPartImpl.this, AnalysisViewsRepository.ResultContainer.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.ResultContainer.Properties.name, AnalysisViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createAnalyzedSystemFlatComboViewer(Composite parent) {
		...
		analyzedSystem = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(AnalysisViewsRepository.ResultContainer.Properties.analyzedSystem, AnalysisViewsRepository.SWT_KIND));
		...
		analyzedSystem.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ResultContainerPropertiesEditionPartImpl.this, AnalysisViewsRepository.ResultContainer.Properties.analyzedSystem, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getAnalyzedSystem()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.ResultContainer.Properties.analyzedSystem, AnalysisViewsRepository.SWT_KIND), null); //$NON-NLS-1$
