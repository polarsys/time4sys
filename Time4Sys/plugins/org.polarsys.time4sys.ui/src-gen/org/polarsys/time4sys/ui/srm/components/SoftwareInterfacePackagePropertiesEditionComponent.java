 ...
 * 
 */
public class SoftwareInterfacePackagePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	/**
	 * Settings for ownedElement ReferencesTable
	 */
	protected ReferencesTableSettings ownedElementSettings;
	 ...
	 * 
	 */
	public SoftwareInterfacePackagePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject softwareInterfacePackage, String editing_mode) {
		super(editingContext, softwareInterfacePackage, editing_mode);
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final SoftwareInterfacePackage softwareInterfacePackage = (SoftwareInterfacePackage)elt;
			final GeneralPropertiesEditionPart generalPart = (GeneralPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(SrmViewsRepository.General.Properties.name))
				generalPart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, softwareInterfacePackage.getName()));
			
			if (isAccessible(SrmViewsRepository.General.Properties.ownedElement)) {
				ownedElementSettings = new ReferencesTableSettings(softwareInterfacePackage, CoreElementsPackage.eINSTANCE.getPackage_OwnedElement());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == SrmViewsRepository.General.Properties.ownedElement) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		SoftwareInterfacePackage softwareInterfacePackage = (SoftwareInterfacePackage)semanticObject;
		if (SrmViewsRepository.General.Properties.name == event.getAffectedEditor()) {
			softwareInterfacePackage.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (SrmViewsRepository.General.Properties.ownedElement == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
				...
				ownedElementSettings.removeFromReference((EObject) event.getNewValue());
			} else if (event.getKind() == PropertiesEditionEvent.MOVE) {
				ownedElementSettings.move(event.getNewIndex(), (ResourcePackageableElement) event.getNewValue());
			}
		}
	}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (CoreElementsPackage.eINSTANCE.getPackage_OwnedElement().equals(msg.getFeature()) && isAccessible(SrmViewsRepository.General.Properties.ownedElement))
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == SrmViewsRepository.General.Properties.name || key == SrmViewsRepository.General.Properties.ownedElement || key == SrmViewsRepository.General.Properties.class;
	}
