 ...
 * 
 */
public class ResourceControlPolicyPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public ResourceControlPolicyPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject resourceControlPolicy, String editing_mode) {
		super(editingContext, resourceControlPolicy, editing_mode);
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final ResourceControlPolicy resourceControlPolicy = (ResourceControlPolicy)elt;
			final GeneralPropertiesEditionPart generalPart = (GeneralPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(GrmViewsRepository.General.Properties.name))
				generalPart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, resourceControlPolicy.getName()));
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		ResourceControlPolicy resourceControlPolicy = (ResourceControlPolicy)semanticObject;
		if (GrmViewsRepository.General.Properties.name == event.getAffectedEditor()) {
			resourceControlPolicy.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
	}
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == GrmViewsRepository.General.Properties.name || key == GrmViewsRepository.General.Properties.class;
	}
