 ...
 * 
 */
public class ResourcePortGeneralPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public ResourcePortGeneralPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject resourcePort, String editing_mode) {
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == GrmViewsRepository.General.Properties.packetSize) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (GrmViewsRepository.General.Properties.name == event.getAffectedEditor()) {
			resourcePort.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (GrmViewsRepository.General.Properties.packetSize == event.getAffectedEditor()) {
			resourcePort.setPacketSize((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
	}
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == GrmViewsRepository.General.Properties.name || key == GrmViewsRepository.General.Properties.packetSize || key == GrmViewsRepository.General.Properties.class;
	}
