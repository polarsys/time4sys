 ...
 * 
 */
public class HardwareAsicTimingPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public HardwareAsicTimingPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject hardwareAsic, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(HrmViewsRepository.Timing.TimingProperties.clock)) {
				// init part
				clockSettings = new EObjectFlatComboSettings(hardwareAsic, HrmPackage.eINSTANCE.getHardwareResource_Clock());
