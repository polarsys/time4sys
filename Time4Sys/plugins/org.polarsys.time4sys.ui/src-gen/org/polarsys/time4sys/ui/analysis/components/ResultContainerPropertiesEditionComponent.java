 ...
 * @generated
 */
public class ResultContainerPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * @generated
	 */
	public ResultContainerPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject resultContainer, String editing_mode) {
		super(editingContext, resultContainer, editing_mode);
		parts = new String[] { BASE_PART };
		repositoryKey = AnalysisViewsRepository.class;
		partKey = AnalysisViewsRepository.ResultContainer.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final ResultContainer resultContainer = (ResultContainer)elt;
			final ResultContainerPropertiesEditionPart basePart = (ResultContainerPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(AnalysisViewsRepository.ResultContainer.Properties.name))
				basePart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, resultContainer.getName()));
			
			if (isAccessible(AnalysisViewsRepository.ResultContainer.Properties.analyzedSystem)) {
				// init part
				analyzedSystemSettings = new EObjectFlatComboSettings(resultContainer, AnalysisPackage.eINSTANCE.getResultContainer_AnalyzedSystem());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == AnalysisViewsRepository.ResultContainer.Properties.name) {
			return AnalysisPackage.eINSTANCE.getNamedElement_Name();
		}
		if (editorKey == AnalysisViewsRepository.ResultContainer.Properties.analyzedSystem) {
			return AnalysisPackage.eINSTANCE.getResultContainer_AnalyzedSystem();
		}
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			AnalysisPackage.eINSTANCE.getResultContainer_AnalyzedSystem()		);
