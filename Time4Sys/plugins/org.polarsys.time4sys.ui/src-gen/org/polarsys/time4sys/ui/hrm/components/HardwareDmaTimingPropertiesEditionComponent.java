 ...
 * 
 */
public class HardwareDmaTimingPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public HardwareDmaTimingPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject hardwareDma, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(HrmViewsRepository.Timing.TimingProperties.accCtrlPolicy)) {
				accCtrlPolicySettings = new ReferencesTableSettings(hardwareDma, GrmPackage.eINSTANCE.getResourceBroker_AccCtrlPolicy());
				timingPart.initAccCtrlPolicy(accCtrlPolicySettings);
			}
			if (isAccessible(HrmViewsRepository.Timing.TimingProperties.clock)) {
				// init part
				clockSettings = new EObjectFlatComboSettings(hardwareDma, HrmPackage.eINSTANCE.getHardwareResource_Clock());
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == HrmViewsRepository.Timing.TimingProperties.accCtrlPolicy || key == HrmViewsRepository.Timing.TimingProperties.clock || key == HrmViewsRepository.Timing.TimingProperties.class;
	}
