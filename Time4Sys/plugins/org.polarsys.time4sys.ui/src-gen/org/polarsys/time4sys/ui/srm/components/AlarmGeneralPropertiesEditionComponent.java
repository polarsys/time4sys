 ...
 * 
 */
public class AlarmGeneralPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public AlarmGeneralPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject alarm, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final Alarm alarm = (Alarm)elt;
			final GeneralPropertiesEditionPart generalPart = (GeneralPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(SrmViewsRepository.General.Properties.name))
				generalPart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, alarm.getName()));
			
			if (isAccessible(SrmViewsRepository.General.Properties.ownedResource)) {
				ownedResourceSettings = new ReferencesTableSettings(alarm, GrmPackage.eINSTANCE.getResource_OwnedResource());
				generalPart.initOwnedResource(ownedResourceSettings);
			}
			if (isAccessible(SrmViewsRepository.General.Properties.resMult)) {
				generalPart.setResMult(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, alarm.getResMult()));
			}
			
			if (isAccessible(SrmViewsRepository.General.Properties.isProtected)) {
				generalPart.setIsProtected(alarm.isIsProtected());
			}
			if (isAccessible(SrmViewsRepository.General.Properties.isActive)) {
				generalPart.setIsActive(alarm.isIsActive());
			}
			if (isAccessible(SrmViewsRepository.General.Properties.ownedPort)) {
				ownedPortSettings = new ReferencesTableSettings(alarm, GrmPackage.eINSTANCE.getResource_OwnedPort());
				generalPart.initOwnedPort(ownedPortSettings);
			}
			if (isAccessible(SrmViewsRepository.General.Properties.ownedConnector)) {
				ownedConnectorSettings = new ReferencesTableSettings(alarm, GrmPackage.eINSTANCE.getResource_OwnedConnector());
				generalPart.initOwnedConnector(ownedConnectorSettings);
			}
			if (isAccessible(SrmViewsRepository.General.Properties.usedBy)) {
				usedBySettings = new ReferencesTableSettings(alarm, GrmPackage.eINSTANCE.getResource_UsedBy());
				generalPart.initUsedBy(usedBySettings);
			}
			if (isAccessible(SrmViewsRepository.General.Properties.managedResource)) {
				managedResourceSettings = new ReferencesTableSettings(alarm, GrmPackage.eINSTANCE.getResourceManager_ManagedResource());
			...
			if (isAccessible(SrmViewsRepository.General.Properties.memorySizeFootprint)) {
				generalPart.setMemorySizeFootprint(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, alarm.getMemorySizeFootprint()));
			}
			
			if (isAccessible(SrmViewsRepository.General.Properties.stateElements))
				generalPart.setStateElements(alarm.getStateElements());
			
			if (isAccessible(SrmViewsRepository.General.Properties.identifierElements))
				generalPart.setIdentifierElements(alarm.getIdentifierElements());
			
			if (isAccessible(SrmViewsRepository.General.Properties.adressSpace)) {
				// init part
				adressSpaceSettings = new EObjectFlatComboSettings(alarm, SrmPackage.eINSTANCE.getSoftwareConcurrentResource_AdressSpace());
			...
			if (isAccessible(SrmViewsRepository.General.Properties.periodElements))
				generalPart.setPeriodElements(alarm.getPeriodElements());
			
			if (isAccessible(SrmViewsRepository.General.Properties.activationCapacity)) {
				generalPart.setActivationCapacity(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, alarm.getActivationCapacity()));
			}
			
			if (isAccessible(SrmViewsRepository.General.Properties.sharedDataResources)) {
				sharedDataResourcesSettings = new ReferencesTableSettings(alarm, SrmPackage.eINSTANCE.getSoftwareConcurrentResource_SharedDataResources());
			...
			if (isAccessible(SrmViewsRepository.General.Properties.messageResources)) {
				messageResourcesSettings = new ReferencesTableSettings(alarm, SrmPackage.eINSTANCE.getSoftwareConcurrentResource_MessageResources());
			...
			if (isAccessible(SrmViewsRepository.General.Properties.notificationResources)) {
				notificationResourcesSettings = new ReferencesTableSettings(alarm, SrmPackage.eINSTANCE.getSoftwareConcurrentResource_NotificationResources());
			...
			if (isAccessible(SrmViewsRepository.General.Properties.entryPoints))
				generalPart.setEntryPoints(alarm.getEntryPoints());
			
			if (isAccessible(SrmViewsRepository.General.Properties.kind)) {
				generalPart.initKind(EEFUtils.choiceOfValues(alarm, SrmPackage.eINSTANCE.getInterruptResource_Kind()), alarm.getKind());
			}
			if (isAccessible(SrmViewsRepository.General.Properties.isrEntryPoints))
				generalPart.setIsrEntryPoints(alarm.getIsrEntryPoints());
			
			if (isAccessible(SrmViewsRepository.General.Properties.isWatchdog)) {
				generalPart.setIsWatchdog(alarm.isIsWatchdog());
			}
			// init filters
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == SrmViewsRepository.General.Properties.isWatchdog) {
			return SrmPackage.eINSTANCE.getAlarm_IsWatchdog();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		Alarm alarm = (Alarm)semanticObject;
		if (SrmViewsRepository.General.Properties.name == event.getAffectedEditor()) {
			alarm.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		...
		if (SrmViewsRepository.General.Properties.resMult == event.getAffectedEditor()) {
			alarm.setResMult((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (SrmViewsRepository.General.Properties.isProtected == event.getAffectedEditor()) {
			alarm.setIsProtected((Boolean)event.getNewValue());
		}
		if (SrmViewsRepository.General.Properties.isActive == event.getAffectedEditor()) {
			alarm.setIsActive((Boolean)event.getNewValue());
		}
		...
		if (SrmViewsRepository.General.Properties.memorySizeFootprint == event.getAffectedEditor()) {
			alarm.setMemorySizeFootprint((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (SrmViewsRepository.General.Properties.stateElements == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				alarm.getStateElements().clear();
				alarm.getStateElements().addAll(((EList) event.getNewValue()));
			}
		}
		if (SrmViewsRepository.General.Properties.identifierElements == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				alarm.getIdentifierElements().clear();
				alarm.getIdentifierElements().addAll(((EList) event.getNewValue()));
			}
		}
		...
		if (SrmViewsRepository.General.Properties.periodElements == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				alarm.getPeriodElements().clear();
				alarm.getPeriodElements().addAll(((EList) event.getNewValue()));
			}
		}
		if (SrmViewsRepository.General.Properties.activationCapacity == event.getAffectedEditor()) {
			alarm.setActivationCapacity((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		...
		if (SrmViewsRepository.General.Properties.entryPoints == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				alarm.getEntryPoints().clear();
				alarm.getEntryPoints().addAll(((EList) event.getNewValue()));
			}
		}
		if (SrmViewsRepository.General.Properties.kind == event.getAffectedEditor()) {
			alarm.setKind((InterruptKind)event.getNewValue());
		}
		if (SrmViewsRepository.General.Properties.isrEntryPoints == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				alarm.getIsrEntryPoints().clear();
				alarm.getIsrEntryPoints().addAll(((EList) event.getNewValue()));
			}
		}
		if (SrmViewsRepository.General.Properties.isWatchdog == event.getAffectedEditor()) {
			alarm.setIsWatchdog((Boolean)event.getNewValue());
		}
	}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (SrmPackage.eINSTANCE.getAlarm_IsWatchdog().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && generalPart != null && isAccessible(SrmViewsRepository.General.Properties.isWatchdog))
				generalPart.setIsWatchdog((Boolean)msg.getNewValue());
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			SrmPackage.eINSTANCE.getAlarm_IsWatchdog()		);
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == SrmViewsRepository.General.Properties.name || key == SrmViewsRepository.General.Properties.ownedResource || key == SrmViewsRepository.General.Properties.resMult || key == SrmViewsRepository.General.Properties.isProtected || key == SrmViewsRepository.General.Properties.isActive || key == SrmViewsRepository.General.Properties.ownedPort || key == SrmViewsRepository.General.Properties.ownedConnector || key == SrmViewsRepository.General.Properties.usedBy || key == SrmViewsRepository.General.Properties.managedResource || key == SrmViewsRepository.General.Properties.memorySizeFootprint || key == SrmViewsRepository.General.Properties.stateElements || key == SrmViewsRepository.General.Properties.identifierElements || key == SrmViewsRepository.General.Properties.adressSpace || key == SrmViewsRepository.General.Properties.periodElements || key == SrmViewsRepository.General.Properties.activationCapacity || key == SrmViewsRepository.General.Properties.sharedDataResources || key == SrmViewsRepository.General.Properties.messageResources || key == SrmViewsRepository.General.Properties.notificationResources || key == SrmViewsRepository.General.Properties.entryPoints || key == SrmViewsRepository.General.Properties.kind || key == SrmViewsRepository.General.Properties.isrEntryPoints || key == SrmViewsRepository.General.Properties.isWatchdog || key == SrmViewsRepository.General.Properties.class;
	}
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (SrmViewsRepository.General.Properties.isWatchdog == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(SrmPackage.eINSTANCE.getAlarm_IsWatchdog().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(SrmPackage.eINSTANCE.getAlarm_IsWatchdog().getEAttributeType(), newValue);
				}
