 ...
 * 
 */
public class HardwareIpBlockTimingPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public HardwareIpBlockTimingPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject hardwareIpBlock, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(HrmViewsRepository.Timing.TimingProperties.clock)) {
				// init part
				clockSettings = new EObjectFlatComboSettings(hardwareIpBlock, HrmPackage.eINSTANCE.getHardwareResource_Clock());
