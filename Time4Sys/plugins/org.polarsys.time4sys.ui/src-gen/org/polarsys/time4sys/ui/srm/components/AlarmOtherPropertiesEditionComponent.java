 ...
 * 
 */
public class AlarmOtherPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(SrmViewsRepository.Other.Properties.pServices)) {
				pServicesSettings = new ReferencesTableSettings(alarm, GrmPackage.eINSTANCE.getResource_PServices());
				otherPart.initPServices(pServicesSettings);
			}
			if (isAccessible(SrmViewsRepository.Other.Properties.rServices)) {
				rServicesSettings = new ReferencesTableSettings(alarm, GrmPackage.eINSTANCE.getResource_RServices());
				otherPart.initRServices(rServicesSettings);
			}
			if (isAccessible(SrmViewsRepository.Other.Properties.createServices)) {
				createServicesSettings = new ReferencesTableSettings(alarm, SrmPackage.eINSTANCE.getSoftwareResource_CreateServices());
				otherPart.initCreateServices(createServicesSettings);
			}
			if (isAccessible(SrmViewsRepository.Other.Properties.deleteServices)) {
				deleteServicesSettings = new ReferencesTableSettings(alarm, SrmPackage.eINSTANCE.getSoftwareResource_DeleteServices());
			...
			if (isAccessible(SrmViewsRepository.Other.Properties.initializeServices)) {
				initializeServicesSettings = new ReferencesTableSettings(alarm, SrmPackage.eINSTANCE.getSoftwareResource_InitializeServices());
			...
			if (isAccessible(SrmViewsRepository.Other.Properties.activateServices)) {
				activateServicesSettings = new ReferencesTableSettings(alarm, SrmPackage.eINSTANCE.getSoftwareConcurrentResource_ActivateServices());
			...
			if (isAccessible(SrmViewsRepository.Other.Properties.resumeServices)) {
				resumeServicesSettings = new ReferencesTableSettings(alarm, SrmPackage.eINSTANCE.getSoftwareConcurrentResource_ResumeServices());
				otherPart.initResumeServices(resumeServicesSettings);
			}
			if (isAccessible(SrmViewsRepository.Other.Properties.suspendServices)) {
				suspendServicesSettings = new ReferencesTableSettings(alarm, SrmPackage.eINSTANCE.getSoftwareConcurrentResource_SuspendServices());
			...
			if (isAccessible(SrmViewsRepository.Other.Properties.enableConcurrencyServices)) {
				enableConcurrencyServicesSettings = new ReferencesTableSettings(alarm, SrmPackage.eINSTANCE.getSoftwareConcurrentResource_EnableConcurrencyServices());
			...
			if (isAccessible(SrmViewsRepository.Other.Properties.disableConcurrencyServices)) {
				disableConcurrencyServicesSettings = new ReferencesTableSettings(alarm, SrmPackage.eINSTANCE.getSoftwareConcurrentResource_DisableConcurrencyServices());
			...
			if (isAccessible(SrmViewsRepository.Other.Properties.terminateServices)) {
				terminateServicesSettings = new ReferencesTableSettings(alarm, SrmPackage.eINSTANCE.getSoftwareConcurrentResource_TerminateServices());
			...
			if (isAccessible(SrmViewsRepository.Other.Properties.stackSizeElements))
				otherPart.setStackSizeElements(alarm.getStackSizeElements());
			
			if (isAccessible(SrmViewsRepository.Other.Properties.heapSizeElements))
				otherPart.setHeapSizeElements(alarm.getHeapSizeElements());
			
			if (isAccessible(SrmViewsRepository.Other.Properties.isMaskable)) {
				otherPart.setIsMaskable(alarm.isIsMaskable());
			}
			if (isAccessible(SrmViewsRepository.Other.Properties.routineConnectServices)) {
				routineConnectServicesSettings = new ReferencesTableSettings(alarm, SrmPackage.eINSTANCE.getInterruptResource_RoutineConnectServices());
			...
			if (isAccessible(SrmViewsRepository.Other.Properties.routineDisconnectServices)) {
				routineDisconnectServicesSettings = new ReferencesTableSettings(alarm, SrmPackage.eINSTANCE.getInterruptResource_RoutineDisconnectServices());
			...
			if (isAccessible(SrmViewsRepository.Other.Properties.maskElements))
				otherPart.setMaskElements(alarm.getMaskElements());
			
			if (isAccessible(SrmViewsRepository.Other.Properties.vectorElements))
				otherPart.setVectorElements(alarm.getVectorElements());
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (SrmViewsRepository.Other.Properties.stackSizeElements == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				alarm.getStackSizeElements().clear();
				alarm.getStackSizeElements().addAll(((EList) event.getNewValue()));
			}
		}
		if (SrmViewsRepository.Other.Properties.heapSizeElements == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				alarm.getHeapSizeElements().clear();
				alarm.getHeapSizeElements().addAll(((EList) event.getNewValue()));
			}
		}
		if (SrmViewsRepository.Other.Properties.isMaskable == event.getAffectedEditor()) {
			alarm.setIsMaskable((Boolean)event.getNewValue());
		}
		...
		if (SrmViewsRepository.Other.Properties.maskElements == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				alarm.getMaskElements().clear();
				alarm.getMaskElements().addAll(((EList) event.getNewValue()));
			}
		}
		if (SrmViewsRepository.Other.Properties.vectorElements == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				alarm.getVectorElements().clear();
				alarm.getVectorElements().addAll(((EList) event.getNewValue()));
			}
		}
	}
