 ...
 * 
 */
public class HardwareBranchPredictorTimingPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public HardwareBranchPredictorTimingPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject hardwareBranchPredictor, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(HrmViewsRepository.Timing.TimingProperties.clock)) {
				// init part
				clockSettings = new EObjectFlatComboSettings(hardwareBranchPredictor, HrmPackage.eINSTANCE.getHardwareResource_Clock());
