 ...
 * @generated
 */
public class ResourceProtectionParameterValuePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ResourceProtectionParameterValuePropertiesEditionPart {
	 ...
	 */
	public ResourceProtectionParameterValuePropertiesEditionPartForm() { super(); }
	 ...
	 * @generated
	 */
	public ResourceProtectionParameterValuePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(AnalysisMessages.ResourceProtectionParameterValuePropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ResourceProtectionParameterValuePropertiesEditionPartForm.this,
							AnalysisViewsRepository.ResourceProtectionParameterValue.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ResourceProtectionParameterValuePropertiesEditionPartForm.this, AnalysisViewsRepository.ResourceProtectionParameterValue.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, AnalysisViewsRepository.ResourceProtectionParameterValue.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.ResourceProtectionParameterValue.Properties.name, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createValueText(FormToolkit widgetFactory, Composite parent) {
		...
		value.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ResourceProtectionParameterValuePropertiesEditionPartForm.this,
							AnalysisViewsRepository.ResourceProtectionParameterValue.Properties.value,
		...
		value.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ResourceProtectionParameterValuePropertiesEditionPartForm.this, AnalysisViewsRepository.ResourceProtectionParameterValue.Properties.value, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, value.getText()));
				}
			}
		});
		EditingUtils.setID(value, AnalysisViewsRepository.ResourceProtectionParameterValue.Properties.value);
		EditingUtils.setEEFtype(value, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.ResourceProtectionParameterValue.Properties.value, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
