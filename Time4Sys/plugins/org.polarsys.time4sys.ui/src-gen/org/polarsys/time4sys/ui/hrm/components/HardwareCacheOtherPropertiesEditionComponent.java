 ...
 * 
 */
public class HardwareCacheOtherPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public HardwareCacheOtherPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject hardwareCache, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(HrmViewsRepository.Other.Properties.pServices)) {
				pServicesSettings = new ReferencesTableSettings(hardwareCache, GrmPackage.eINSTANCE.getResource_PServices());
				otherPart.initPServices(pServicesSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.ownedPort)) {
				ownedPortSettings = new ReferencesTableSettings(hardwareCache, GrmPackage.eINSTANCE.getResource_OwnedPort());
				otherPart.initOwnedPort(ownedPortSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.rServices)) {
				rServicesSettings = new ReferencesTableSettings(hardwareCache, GrmPackage.eINSTANCE.getResource_RServices());
				otherPart.initRServices(rServicesSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.dimension)) {
				otherPart.setDimension(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareCache.getDimension()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.posX)) {
				otherPart.setPosX(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareCache.getPosX()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.posY)) {
				otherPart.setPosY(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareCache.getPosY()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.grid)) {
				otherPart.setGrid(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareCache.getGrid()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.nbPins)) {
				otherPart.setNbPins(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareCache.getNbPins()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.weight)) {
				otherPart.setWeight(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareCache.getWeight()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.price)) {
				otherPart.setPrice(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareCache.getPrice()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.rConditions)) {
				rConditionsSettings = new ReferencesTableSettings(hardwareCache, HrmPackage.eINSTANCE.getHardwareComponent_RConditions());
				otherPart.initRConditions(rConditionsSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.ownedPin)) {
				ownedPinSettings = new ReferencesTableSettings(hardwareCache, HrmPackage.eINSTANCE.getHardwareComponent_OwnedPin());
				otherPart.initOwnedPin(ownedPinSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.ownedWire)) {
				ownedWireSettings = new ReferencesTableSettings(hardwareCache, HrmPackage.eINSTANCE.getHardwareComponent_OwnedWire());
				otherPart.initOwnedWire(ownedWireSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.technology)) {
				otherPart.setTechnology(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareCache.getTechnology()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.nbSets)) {
				otherPart.setNbSets(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareCache.getNbSets()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.blockSize)) {
				otherPart.setBlockSize(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareCache.getBlockSize()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.associativity)) {
				otherPart.setAssociativity(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareCache.getAssociativity()));
			}
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == HrmViewsRepository.Other.Properties.nbSets) {
			return HrmPackage.eINSTANCE.getHardwareCache_NbSets();
		}
		if (editorKey == HrmViewsRepository.Other.Properties.blockSize) {
			return HrmPackage.eINSTANCE.getHardwareCache_BlockSize();
		}
		if (editorKey == HrmViewsRepository.Other.Properties.associativity) {
			return HrmPackage.eINSTANCE.getHardwareCache_Associativity();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (HrmViewsRepository.Other.Properties.dimension == event.getAffectedEditor()) {
			hardwareCache.setDimension((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.posX == event.getAffectedEditor()) {
			hardwareCache.setPosX((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.posY == event.getAffectedEditor()) {
			hardwareCache.setPosY((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.grid == event.getAffectedEditor()) {
			hardwareCache.setGrid((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.nbPins == event.getAffectedEditor()) {
			hardwareCache.setNbPins((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.weight == event.getAffectedEditor()) {
			hardwareCache.setWeight((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.price == event.getAffectedEditor()) {
			hardwareCache.setPrice((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		...
		if (HrmViewsRepository.Other.Properties.technology == event.getAffectedEditor()) {
			hardwareCache.setTechnology((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.nbSets == event.getAffectedEditor()) {
			hardwareCache.setNbSets((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.blockSize == event.getAffectedEditor()) {
			hardwareCache.setBlockSize((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.associativity == event.getAffectedEditor()) {
			hardwareCache.setAssociativity((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
	}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (HrmPackage.eINSTANCE.getHardwareCache_NbSets().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && otherPart != null && isAccessible(HrmViewsRepository.Other.Properties.nbSets)) {
				if (msg.getNewValue() != null) {
					otherPart.setNbSets(EcoreUtil.convertToString(EcorePackage.Literals.EINT, msg.getNewValue()));
				} else {
					otherPart.setNbSets("");
				}
			}
			if (HrmPackage.eINSTANCE.getHardwareCache_BlockSize().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && otherPart != null && isAccessible(HrmViewsRepository.Other.Properties.blockSize)) {
				if (msg.getNewValue() != null) {
					otherPart.setBlockSize(EcoreUtil.convertToString(EcorePackage.Literals.EINT, msg.getNewValue()));
				} else {
					otherPart.setBlockSize("");
				}
			}
			if (HrmPackage.eINSTANCE.getHardwareCache_Associativity().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && otherPart != null && isAccessible(HrmViewsRepository.Other.Properties.associativity)) {
				if (msg.getNewValue() != null) {
					otherPart.setAssociativity(EcoreUtil.convertToString(EcorePackage.Literals.EINT, msg.getNewValue()));
				} else {
					otherPart.setAssociativity("");
				}
			}
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			HrmPackage.eINSTANCE.getHardwareCache_NbSets(),
			HrmPackage.eINSTANCE.getHardwareCache_BlockSize(),
			HrmPackage.eINSTANCE.getHardwareCache_Associativity()		);
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == HrmViewsRepository.Other.Properties.pServices || key == HrmViewsRepository.Other.Properties.ownedPort || key == HrmViewsRepository.Other.Properties.rServices || key == HrmViewsRepository.Other.Properties.dimension || key == HrmViewsRepository.Other.Properties.posX || key == HrmViewsRepository.Other.Properties.posY || key == HrmViewsRepository.Other.Properties.grid || key == HrmViewsRepository.Other.Properties.nbPins || key == HrmViewsRepository.Other.Properties.weight || key == HrmViewsRepository.Other.Properties.price || key == HrmViewsRepository.Other.Properties.rConditions || key == HrmViewsRepository.Other.Properties.ownedPin || key == HrmViewsRepository.Other.Properties.ownedWire || key == HrmViewsRepository.Other.Properties.technology || key == HrmViewsRepository.Other.Properties.nbSets || key == HrmViewsRepository.Other.Properties.blockSize || key == HrmViewsRepository.Other.Properties.associativity || key == HrmViewsRepository.Other.Properties.class;
	}
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (HrmViewsRepository.Other.Properties.nbSets == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HrmPackage.eINSTANCE.getHardwareCache_NbSets().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HrmPackage.eINSTANCE.getHardwareCache_NbSets().getEAttributeType(), newValue);
				}
				if (HrmViewsRepository.Other.Properties.blockSize == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HrmPackage.eINSTANCE.getHardwareCache_BlockSize().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HrmPackage.eINSTANCE.getHardwareCache_BlockSize().getEAttributeType(), newValue);
				}
				if (HrmViewsRepository.Other.Properties.associativity == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HrmPackage.eINSTANCE.getHardwareCache_Associativity().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HrmPackage.eINSTANCE.getHardwareCache_Associativity().getEAttributeType(), newValue);
				}
