 ...
 * 
 */
public class FirmwareArchitectureOtherPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public FirmwareArchitectureOtherPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject firmwareArchitecture, String editing_mode) {
		super(editingContext, firmwareArchitecture, editing_mode);
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final FirmwareArchitecture firmwareArchitecture = (FirmwareArchitecture)elt;
			...
			if (isAccessible(HrmViewsRepository.Other.Properties.pServices)) {
				pServicesSettings = new ReferencesTableSettings(firmwareArchitecture, GrmPackage.eINSTANCE.getResource_PServices());
				otherPart.initPServices(pServicesSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.ownedPort)) {
				ownedPortSettings = new ReferencesTableSettings(firmwareArchitecture, GrmPackage.eINSTANCE.getResource_OwnedPort());
				otherPart.initOwnedPort(ownedPortSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.rServices)) {
				rServicesSettings = new ReferencesTableSettings(firmwareArchitecture, GrmPackage.eINSTANCE.getResource_RServices());
				otherPart.initRServices(rServicesSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.ownedWire)) {
				ownedWireSettings = new ReferencesTableSettings(firmwareArchitecture, HrmPackage.eINSTANCE.getFirmwareArchitecture_OwnedWire());
				otherPart.initOwnedWire(ownedWireSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.ownedPin)) {
				ownedPinSettings = new ReferencesTableSettings(firmwareArchitecture, HrmPackage.eINSTANCE.getFirmwareArchitecture_OwnedPin());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == HrmViewsRepository.Other.Properties.ownedWire) {
			return HrmPackage.eINSTANCE.getFirmwareArchitecture_OwnedWire();
		}
		if (editorKey == HrmViewsRepository.Other.Properties.ownedPin) {
			return HrmPackage.eINSTANCE.getFirmwareArchitecture_OwnedPin();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		FirmwareArchitecture firmwareArchitecture = (FirmwareArchitecture)semanticObject;
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (HrmPackage.eINSTANCE.getFirmwareArchitecture_OwnedWire().equals(msg.getFeature()) && isAccessible(HrmViewsRepository.Other.Properties.ownedWire))
				otherPart.updateOwnedWire();
			if (HrmPackage.eINSTANCE.getFirmwareArchitecture_OwnedPin().equals(msg.getFeature()) && isAccessible(HrmViewsRepository.Other.Properties.ownedPin))
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			HrmPackage.eINSTANCE.getFirmwareArchitecture_OwnedWire(),
			HrmPackage.eINSTANCE.getFirmwareArchitecture_OwnedPin()		);
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == HrmViewsRepository.Other.Properties.pServices || key == HrmViewsRepository.Other.Properties.ownedPort || key == HrmViewsRepository.Other.Properties.rServices || key == HrmViewsRepository.Other.Properties.ownedWire || key == HrmViewsRepository.Other.Properties.ownedPin || key == HrmViewsRepository.Other.Properties.class;
	}
