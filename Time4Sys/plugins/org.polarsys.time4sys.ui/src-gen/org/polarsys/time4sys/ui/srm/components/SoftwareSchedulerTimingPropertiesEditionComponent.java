 ...
 * 
 */
public class SoftwareSchedulerTimingPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public SoftwareSchedulerTimingPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject softwareScheduler, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(SrmViewsRepository.Timing.Properties.accCtrlPolicy)) {
				accCtrlPolicySettings = new ReferencesTableSettings(softwareScheduler, GrmPackage.eINSTANCE.getResourceBroker_AccCtrlPolicy());
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == SrmViewsRepository.Timing.Properties.accCtrlPolicy || key == SrmViewsRepository.Timing.Properties.class;
	}
