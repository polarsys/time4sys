 ...
 * 
 */
public class SecondarySchedulerOtherPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public SecondarySchedulerOtherPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject secondaryScheduler, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(GrmViewsRepository.Other.OtherProperties.pServices)) {
				pServicesSettings = new ReferencesTableSettings(secondaryScheduler, GrmPackage.eINSTANCE.getResource_PServices());
				otherPart.initPServices(pServicesSettings);
			}
			if (isAccessible(GrmViewsRepository.Other.OtherProperties.rServices)) {
				rServicesSettings = new ReferencesTableSettings(secondaryScheduler, GrmPackage.eINSTANCE.getResource_RServices());
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == GrmViewsRepository.Other.OtherProperties.pServices || key == GrmViewsRepository.Other.OtherProperties.rServices || key == GrmViewsRepository.Other.OtherProperties.class;
	}
