 ...
 * 
 */
public class DeadlineMonotonicSchedulingPolicyPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public DeadlineMonotonicSchedulingPolicyPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject deadlineMonotonicSchedulingPolicy, String editing_mode) {
		super(editingContext, deadlineMonotonicSchedulingPolicy, editing_mode);
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		DeadlineMonotonicSchedulingPolicy deadlineMonotonicSchedulingPolicy = (DeadlineMonotonicSchedulingPolicy)semanticObject;
		if (LibraryViewsRepository.General.Properties.name == event.getAffectedEditor()) {
			deadlineMonotonicSchedulingPolicy.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (LibraryViewsRepository.General.Properties.policy == event.getAffectedEditor()) {
			deadlineMonotonicSchedulingPolicy.setPolicy((SchedPolicyKind)event.getNewValue());
		}
		if (LibraryViewsRepository.General.Properties.otherSchedPolicy == event.getAffectedEditor()) {
			deadlineMonotonicSchedulingPolicy.setOtherSchedPolicy((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
	}
