...
public class GeneralPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, GeneralPropertiesEditionPart {
		...
		composer = new PartComposer(generalStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == LibraryViewsRepository.General.Properties.slot) {
					return createSlotMultiValuedEditor(widgetFactory, parent);
				}
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(LibraryMessages.GeneralPropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							...
							LibraryViewsRepository.General.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, LibraryViewsRepository.General.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(LibraryViewsRepository.General.Properties.name, LibraryViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createIsProtectedCheckbox(FormToolkit widgetFactory, Composite parent) {
		isProtected = widgetFactory.createButton(parent, getDescription(LibraryViewsRepository.General.Properties.isProtected, LibraryMessages.GeneralPropertiesEditionPart_IsProtectedLabel), SWT.CHECK);
		isProtected.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.isProtected, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isProtected.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(LibraryViewsRepository.General.Properties.isProtected, LibraryViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createResMultText(FormToolkit widgetFactory, Composite parent) {
		...
		resMult.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this,
							LibraryViewsRepository.General.Properties.resMult,
		...
		resMult.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.resMult, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, resMult.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(LibraryViewsRepository.General.Properties.resMult, LibraryViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPolicyEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		policy.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.policy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getPolicy()));
			}

		});
		policy.setID(LibraryViewsRepository.General.Properties.policy);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(LibraryViewsRepository.General.Properties.policy, LibraryViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createOtherSchedPolicyText(FormToolkit widgetFactory, Composite parent) {
		...
		otherSchedPolicy.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this,
							LibraryViewsRepository.General.Properties.otherSchedPolicy,
		...
		otherSchedPolicy.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.otherSchedPolicy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, otherSchedPolicy.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(LibraryViewsRepository.General.Properties.otherSchedPolicy, LibraryViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * 
	 */
	protected Composite createSlotMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		slot = widgetFactory.createText(parent, "", SWT.READ_ONLY); //$NON-NLS-1$
		...
		editSlot = widgetFactory.createButton(parent, getDescription(LibraryViewsRepository.General.Properties.slot, LibraryMessages.GeneralPropertiesEditionPart_SlotLabel), SWT.NONE);
		...
		editSlot.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.slot, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(slotList)));
					setHasChanged(true);
				}
			}
		});
	...
	protected Composite createClockFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		clock = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(LibraryViewsRepository.General.Properties.clock, LibraryViewsRepository.FORM_KIND));
		...
		clock.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.clock, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getClock()));
			}

		});
		clock.setID(LibraryViewsRepository.General.Properties.clock);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(LibraryViewsRepository.General.Properties.clock, LibraryViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createUsedByReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.usedBy = new ReferencesTable(getDescription(LibraryViewsRepository.General.Properties.usedBy, LibraryMessages.GeneralPropertiesEditionPart_UsedByLabel), new ReferencesTableListener	() {
		...
		this.usedBy.setHelpText(propertiesEditionComponent.getHelpContent(LibraryViewsRepository.General.Properties.usedBy, LibraryViewsRepository.FORM_KIND));
		this.usedBy.createControls(parent, widgetFactory);
		this.usedBy.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.usedBy, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"usedBy", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.usedBy,
	...
	protected void moveUsedBy(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.usedBy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		usedBy.refresh();
	}
	...
	protected void removeFromUsedBy(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.usedBy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		usedBy.refresh();
	}
	...
	protected Composite createRealizedByReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.realizedBy = new ReferencesTable(getDescription(LibraryViewsRepository.General.Properties.realizedBy, LibraryMessages.GeneralPropertiesEditionPart_RealizedByLabel), new ReferencesTableListener	() {
		...
		this.realizedBy.setHelpText(propertiesEditionComponent.getHelpContent(LibraryViewsRepository.General.Properties.realizedBy, LibraryViewsRepository.FORM_KIND));
		this.realizedBy.createControls(parent, widgetFactory);
		this.realizedBy.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.realizedBy, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addRealizedBy() {
		...
		"realizedBy", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.realizedBy,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				realizedBy.refresh();
			}
	...
	protected void moveRealizedBy(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.realizedBy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		realizedBy.refresh();
	}
	...
	protected void removeFromRealizedBy(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.realizedBy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		realizedBy.refresh();
	}
	...
	protected Composite createOwnedResourceTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedResource = new ReferencesTable(getDescription(LibraryViewsRepository.General.Properties.ownedResource, LibraryMessages.GeneralPropertiesEditionPart_OwnedResourceLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.ownedResource, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				ownedResource.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.ownedResource, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				ownedResource.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.ownedResource, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				ownedResource.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.ownedResource, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				ownedResource.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.ownedResource.setHelpText(propertiesEditionComponent.getHelpContent(LibraryViewsRepository.General.Properties.ownedResource, LibraryViewsRepository.FORM_KIND));
		this.ownedResource.createControls(parent, widgetFactory);
		this.ownedResource.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.ownedResource, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createOwnedPortTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedPort = new ReferencesTable(getDescription(LibraryViewsRepository.General.Properties.ownedPort, LibraryMessages.GeneralPropertiesEditionPart_OwnedPortLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.ownedPort, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				ownedPort.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.ownedPort, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				ownedPort.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.ownedPort, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				ownedPort.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.ownedPort, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				ownedPort.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.ownedPort.setHelpText(propertiesEditionComponent.getHelpContent(LibraryViewsRepository.General.Properties.ownedPort, LibraryViewsRepository.FORM_KIND));
		this.ownedPort.createControls(parent, widgetFactory);
		this.ownedPort.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.ownedPort, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createOwnedConnectorTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedConnector = new ReferencesTable(getDescription(LibraryViewsRepository.General.Properties.ownedConnector, LibraryMessages.GeneralPropertiesEditionPart_OwnedConnectorLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.ownedConnector, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				ownedConnector.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.ownedConnector, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				ownedConnector.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.ownedConnector, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				ownedConnector.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.ownedConnector, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				ownedConnector.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.ownedConnector.setHelpText(propertiesEditionComponent.getHelpContent(LibraryViewsRepository.General.Properties.ownedConnector, LibraryViewsRepository.FORM_KIND));
		this.ownedConnector.createControls(parent, widgetFactory);
		this.ownedConnector.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this, LibraryViewsRepository.General.Properties.ownedConnector, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
