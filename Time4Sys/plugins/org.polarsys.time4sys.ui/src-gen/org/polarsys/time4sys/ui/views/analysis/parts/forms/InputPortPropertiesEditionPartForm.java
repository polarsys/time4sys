 ...
 * @generated
 */
public class InputPortPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, InputPortPropertiesEditionPart {
	 ...
	 */
	public InputPortPropertiesEditionPartForm() { super(); }
	 ...
	 * @generated
	 */
	public InputPortPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							InputPortPropertiesEditionPartForm.this,
							AnalysisViewsRepository.InputPort.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputPortPropertiesEditionPartForm.this, AnalysisViewsRepository.InputPort.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, AnalysisViewsRepository.InputPort.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.InputPort.Properties.name, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createParent_FlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		parent_ = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(AnalysisViewsRepository.InputPort.Properties.parent_, AnalysisViewsRepository.FORM_KIND));
		...
		parent_.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputPortPropertiesEditionPartForm.this, AnalysisViewsRepository.InputPort.Properties.parent_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getParent_()));
			}

		});
		parent_.setID(AnalysisViewsRepository.InputPort.Properties.parent_);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.InputPort.Properties.parent_, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * @generated
	 */
	protected Composite createReceiveFromFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		receiveFrom = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(AnalysisViewsRepository.InputPort.Properties.receiveFrom, AnalysisViewsRepository.FORM_KIND));
		widgetFactory.adapt(receiveFrom);
		...
		receiveFrom.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(InputPortPropertiesEditionPartForm.this, AnalysisViewsRepository.InputPort.Properties.receiveFrom, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getReceiveFrom()));
			}

		});
		receiveFrom.setID(AnalysisViewsRepository.InputPort.Properties.receiveFrom);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.InputPort.Properties.receiveFrom, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
