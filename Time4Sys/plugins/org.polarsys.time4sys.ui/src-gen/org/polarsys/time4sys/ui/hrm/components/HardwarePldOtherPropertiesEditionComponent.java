 ...
 * 
 */
public class HardwarePldOtherPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	/**
	 * Settings for architecture EObjectFlatComboViewer
	 */
	private EObjectFlatComboSettings architectureSettings;
	 ...
	 * 
	 */
	public HardwarePldOtherPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject hardwarePld, String editing_mode) {
		super(editingContext, hardwarePld, editing_mode);
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(HrmViewsRepository.Other.Properties.pServices)) {
				pServicesSettings = new ReferencesTableSettings(hardwarePld, GrmPackage.eINSTANCE.getResource_PServices());
				otherPart.initPServices(pServicesSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.ownedPort)) {
				ownedPortSettings = new ReferencesTableSettings(hardwarePld, GrmPackage.eINSTANCE.getResource_OwnedPort());
				otherPart.initOwnedPort(ownedPortSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.rServices)) {
				rServicesSettings = new ReferencesTableSettings(hardwarePld, GrmPackage.eINSTANCE.getResource_RServices());
				otherPart.initRServices(rServicesSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.dimension)) {
				otherPart.setDimension(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwarePld.getDimension()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.posX)) {
				otherPart.setPosX(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwarePld.getPosX()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.posY)) {
				otherPart.setPosY(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwarePld.getPosY()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.grid)) {
				otherPart.setGrid(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwarePld.getGrid()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.nbPins)) {
				otherPart.setNbPins(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwarePld.getNbPins()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.weight)) {
				otherPart.setWeight(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwarePld.getWeight()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.price)) {
				otherPart.setPrice(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwarePld.getPrice()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.rConditions)) {
				rConditionsSettings = new ReferencesTableSettings(hardwarePld, HrmPackage.eINSTANCE.getHardwareComponent_RConditions());
				otherPart.initRConditions(rConditionsSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.ownedPin)) {
				ownedPinSettings = new ReferencesTableSettings(hardwarePld, HrmPackage.eINSTANCE.getHardwareComponent_OwnedPin());
				otherPart.initOwnedPin(ownedPinSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.ownedWire)) {
				ownedWireSettings = new ReferencesTableSettings(hardwarePld, HrmPackage.eINSTANCE.getHardwareComponent_OwnedWire());
				otherPart.initOwnedWire(ownedWireSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.technology)) {
				otherPart.setTechnology(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwarePld.getTechnology()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.opFrequencies)) {
				otherPart.setOpFrequencies(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwarePld.getOpFrequencies()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.pldTechnology)) {
				otherPart.initPldTechnology(EEFUtils.choiceOfValues(hardwarePld, HrmPackage.eINSTANCE.getHardwarePld_PldTechnology()), hardwarePld.getPldTechnology());
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.nbRows)) {
				otherPart.setNbRows(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwarePld.getNbRows()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.nbColumns)) {
				otherPart.setNbColumns(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwarePld.getNbColumns()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.kind)) {
				otherPart.initKind(EEFUtils.choiceOfValues(hardwarePld, HrmPackage.eINSTANCE.getHardwarePld_Kind()), hardwarePld.getKind());
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.nbLuts)) {
				otherPart.setNbLuts(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwarePld.getNbLuts()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.nbLutInputs)) {
				otherPart.setNbLutInputs(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwarePld.getNbLutInputs()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.nbFlipFlops)) {
				otherPart.setNbFlipFlops(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwarePld.getNbFlipFlops()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.architecture)) {
				// init part
				architectureSettings = new EObjectFlatComboSettings(hardwarePld, HrmPackage.eINSTANCE.getHardwarePld_Architecture());
				otherPart.initArchitecture(architectureSettings);
				// set the button mode
				otherPart.setArchitectureButtonMode(ButtonsModeEnum.BROWSE);
			}
			// init filters
			if (isAccessible(HrmViewsRepository.Other.Properties.pServices)) {
			...
			if (isAccessible(HrmViewsRepository.Other.Properties.architecture)) {
				otherPart.addFilterToArchitecture(new ViewerFilter() {
					 ...
					 */
					public boolean select(Viewer viewer, Object parentElement, Object element) {
						return (element instanceof String && element.equals("")) || (element instanceof FirmwareArchitecture); //$NON-NLS-1$ 
					}
					
				});
				// Start of user code for additional businessfilters for architecture
				// End of user code
			}
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == HrmViewsRepository.Other.Properties.pldTechnology) {
			return HrmPackage.eINSTANCE.getHardwarePld_PldTechnology();
		}
		if (editorKey == HrmViewsRepository.Other.Properties.nbRows) {
			return HrmPackage.eINSTANCE.getHardwarePld_NbRows();
		}
		if (editorKey == HrmViewsRepository.Other.Properties.nbColumns) {
			return HrmPackage.eINSTANCE.getHardwarePld_NbColumns();
		}
		if (editorKey == HrmViewsRepository.Other.Properties.kind) {
			return HrmPackage.eINSTANCE.getHardwarePld_Kind();
		}
		if (editorKey == HrmViewsRepository.Other.Properties.nbLuts) {
			return HrmPackage.eINSTANCE.getHardwarePld_NbLuts();
		}
		if (editorKey == HrmViewsRepository.Other.Properties.nbLutInputs) {
			return HrmPackage.eINSTANCE.getHardwarePld_NbLutInputs();
		}
		if (editorKey == HrmViewsRepository.Other.Properties.nbFlipFlops) {
			return HrmPackage.eINSTANCE.getHardwarePld_NbFlipFlops();
		}
		if (editorKey == HrmViewsRepository.Other.Properties.architecture) {
			return HrmPackage.eINSTANCE.getHardwarePld_Architecture();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (HrmViewsRepository.Other.Properties.dimension == event.getAffectedEditor()) {
			hardwarePld.setDimension((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.posX == event.getAffectedEditor()) {
			hardwarePld.setPosX((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.posY == event.getAffectedEditor()) {
			hardwarePld.setPosY((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.grid == event.getAffectedEditor()) {
			hardwarePld.setGrid((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.nbPins == event.getAffectedEditor()) {
			hardwarePld.setNbPins((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.weight == event.getAffectedEditor()) {
			hardwarePld.setWeight((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.price == event.getAffectedEditor()) {
			hardwarePld.setPrice((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		...
		if (HrmViewsRepository.Other.Properties.technology == event.getAffectedEditor()) {
			hardwarePld.setTechnology((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.opFrequencies == event.getAffectedEditor()) {
			hardwarePld.setOpFrequencies((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.pldTechnology == event.getAffectedEditor()) {
			hardwarePld.setPldTechnology((PldTechnology)event.getNewValue());
		}
		if (HrmViewsRepository.Other.Properties.nbRows == event.getAffectedEditor()) {
			hardwarePld.setNbRows((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.nbColumns == event.getAffectedEditor()) {
			hardwarePld.setNbColumns((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.kind == event.getAffectedEditor()) {
			hardwarePld.setKind((PldClass)event.getNewValue());
		}
		if (HrmViewsRepository.Other.Properties.nbLuts == event.getAffectedEditor()) {
			hardwarePld.setNbLuts((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.nbLutInputs == event.getAffectedEditor()) {
			hardwarePld.setNbLutInputs((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.nbFlipFlops == event.getAffectedEditor()) {
			hardwarePld.setNbFlipFlops((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.architecture == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.SET) {
				architectureSettings.setToReference((FirmwareArchitecture)event.getNewValue());
			} else if (event.getKind() == PropertiesEditionEvent.ADD) {
				FirmwareArchitecture eObject = HrmFactory.eINSTANCE.createFirmwareArchitecture();
				...
				architectureSettings.setToReference(eObject);
			}
		}
	}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (HrmPackage.eINSTANCE.getHardwarePld_PldTechnology().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(HrmViewsRepository.Other.Properties.pldTechnology))
				otherPart.setPldTechnology((PldTechnology)msg.getNewValue());
			
			if (HrmPackage.eINSTANCE.getHardwarePld_NbRows().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && otherPart != null && isAccessible(HrmViewsRepository.Other.Properties.nbRows)) {
				if (msg.getNewValue() != null) {
					otherPart.setNbRows(EcoreUtil.convertToString(EcorePackage.Literals.EINT, msg.getNewValue()));
				} else {
					otherPart.setNbRows("");
				}
			}
			if (HrmPackage.eINSTANCE.getHardwarePld_NbColumns().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && otherPart != null && isAccessible(HrmViewsRepository.Other.Properties.nbColumns)) {
				if (msg.getNewValue() != null) {
					otherPart.setNbColumns(EcoreUtil.convertToString(EcorePackage.Literals.EINT, msg.getNewValue()));
				} else {
					otherPart.setNbColumns("");
				}
			}
			if (HrmPackage.eINSTANCE.getHardwarePld_Kind().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && isAccessible(HrmViewsRepository.Other.Properties.kind))
				otherPart.setKind((PldClass)msg.getNewValue());
			
			if (HrmPackage.eINSTANCE.getHardwarePld_NbLuts().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && otherPart != null && isAccessible(HrmViewsRepository.Other.Properties.nbLuts)) {
				if (msg.getNewValue() != null) {
					otherPart.setNbLuts(EcoreUtil.convertToString(EcorePackage.Literals.EINT, msg.getNewValue()));
				} else {
					otherPart.setNbLuts("");
				}
			}
			if (HrmPackage.eINSTANCE.getHardwarePld_NbLutInputs().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && otherPart != null && isAccessible(HrmViewsRepository.Other.Properties.nbLutInputs)) {
				if (msg.getNewValue() != null) {
					otherPart.setNbLutInputs(EcoreUtil.convertToString(EcorePackage.Literals.EINT, msg.getNewValue()));
				} else {
					otherPart.setNbLutInputs("");
				}
			}
			if (HrmPackage.eINSTANCE.getHardwarePld_NbFlipFlops().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && otherPart != null && isAccessible(HrmViewsRepository.Other.Properties.nbFlipFlops)) {
				if (msg.getNewValue() != null) {
					otherPart.setNbFlipFlops(EcoreUtil.convertToString(EcorePackage.Literals.EINT, msg.getNewValue()));
				} else {
					otherPart.setNbFlipFlops("");
				}
			}
			if (HrmPackage.eINSTANCE.getHardwarePld_Architecture().equals(msg.getFeature()) && otherPart != null && isAccessible(HrmViewsRepository.Other.Properties.architecture))
				otherPart.setArchitecture((EObject)msg.getNewValue());
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			HrmPackage.eINSTANCE.getHardwarePld_PldTechnology(),
			HrmPackage.eINSTANCE.getHardwarePld_NbRows(),
			HrmPackage.eINSTANCE.getHardwarePld_NbColumns(),
			HrmPackage.eINSTANCE.getHardwarePld_Kind(),
			HrmPackage.eINSTANCE.getHardwarePld_NbLuts(),
			HrmPackage.eINSTANCE.getHardwarePld_NbLutInputs(),
			HrmPackage.eINSTANCE.getHardwarePld_NbFlipFlops(),
			HrmPackage.eINSTANCE.getHardwarePld_Architecture()		);
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == HrmViewsRepository.Other.Properties.pServices || key == HrmViewsRepository.Other.Properties.ownedPort || key == HrmViewsRepository.Other.Properties.rServices || key == HrmViewsRepository.Other.Properties.dimension || key == HrmViewsRepository.Other.Properties.posX || key == HrmViewsRepository.Other.Properties.posY || key == HrmViewsRepository.Other.Properties.grid || key == HrmViewsRepository.Other.Properties.nbPins || key == HrmViewsRepository.Other.Properties.weight || key == HrmViewsRepository.Other.Properties.price || key == HrmViewsRepository.Other.Properties.rConditions || key == HrmViewsRepository.Other.Properties.ownedPin || key == HrmViewsRepository.Other.Properties.ownedWire || key == HrmViewsRepository.Other.Properties.technology || key == HrmViewsRepository.Other.Properties.opFrequencies || key == HrmViewsRepository.Other.Properties.pldTechnology || key == HrmViewsRepository.Other.Properties.nbRows || key == HrmViewsRepository.Other.Properties.nbColumns || key == HrmViewsRepository.Other.Properties.kind || key == HrmViewsRepository.Other.Properties.nbLuts || key == HrmViewsRepository.Other.Properties.nbLutInputs || key == HrmViewsRepository.Other.Properties.nbFlipFlops || key == HrmViewsRepository.Other.Properties.architecture || key == HrmViewsRepository.Other.Properties.class;
	}
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (HrmViewsRepository.Other.Properties.pldTechnology == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HrmPackage.eINSTANCE.getHardwarePld_PldTechnology().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HrmPackage.eINSTANCE.getHardwarePld_PldTechnology().getEAttributeType(), newValue);
				}
				if (HrmViewsRepository.Other.Properties.nbRows == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HrmPackage.eINSTANCE.getHardwarePld_NbRows().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HrmPackage.eINSTANCE.getHardwarePld_NbRows().getEAttributeType(), newValue);
				}
				if (HrmViewsRepository.Other.Properties.nbColumns == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HrmPackage.eINSTANCE.getHardwarePld_NbColumns().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HrmPackage.eINSTANCE.getHardwarePld_NbColumns().getEAttributeType(), newValue);
				}
				if (HrmViewsRepository.Other.Properties.kind == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HrmPackage.eINSTANCE.getHardwarePld_Kind().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HrmPackage.eINSTANCE.getHardwarePld_Kind().getEAttributeType(), newValue);
				}
				if (HrmViewsRepository.Other.Properties.nbLuts == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HrmPackage.eINSTANCE.getHardwarePld_NbLuts().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HrmPackage.eINSTANCE.getHardwarePld_NbLuts().getEAttributeType(), newValue);
				}
				if (HrmViewsRepository.Other.Properties.nbLutInputs == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HrmPackage.eINSTANCE.getHardwarePld_NbLutInputs().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HrmPackage.eINSTANCE.getHardwarePld_NbLutInputs().getEAttributeType(), newValue);
				}
				if (HrmViewsRepository.Other.Properties.nbFlipFlops == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HrmPackage.eINSTANCE.getHardwarePld_NbFlipFlops().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HrmPackage.eINSTANCE.getHardwarePld_NbFlipFlops().getEAttributeType(), newValue);
				}
