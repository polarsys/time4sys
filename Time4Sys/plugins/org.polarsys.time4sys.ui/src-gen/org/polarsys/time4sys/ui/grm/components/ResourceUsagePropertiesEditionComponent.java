 ...
 * 
 */
public class ResourceUsagePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public ResourceUsagePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject resourceUsage, String editing_mode) {
		super(editingContext, resourceUsage, editing_mode);
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final ResourceUsage resourceUsage = (ResourceUsage)elt;
			final GeneralPropertiesEditionPart generalPart = (GeneralPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(GrmViewsRepository.General.Properties.workload)) {
				workloadSettings = new ReferencesTableSettings(resourceUsage, GrmPackage.eINSTANCE.getResourceUsage_Workload());
				generalPart.initWorkload(workloadSettings);
			}
			if (isAccessible(GrmViewsRepository.General.Properties.requiredAmount)) {
				requiredAmountSettings = new ReferencesTableSettings(resourceUsage, GrmPackage.eINSTANCE.getResourceUsage_RequiredAmount());
				generalPart.initRequiredAmount(requiredAmountSettings);
			}
			if (isAccessible(GrmViewsRepository.General.Properties.usedResource)) {
				usedResourceSettings = new ReferencesTableSettings(resourceUsage, GrmPackage.eINSTANCE.getResourceUsage_UsedResource());
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		ResourceUsage resourceUsage = (ResourceUsage)semanticObject;
