...
public class OtherPropertiesEditionPartForm extends SectionPropertiesEditingPart
	...
	protected Composite createPacketSizeText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.packetSize,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.packetSize, SrmViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createIsStaticSchedulingFeatureCheckbox(FormToolkit widgetFactory, Composite parent) {
		isStaticSchedulingFeature = widgetFactory.createButton(parent,
				getDescription(SrmViewsRepository.Other.Properties.isStaticSchedulingFeature,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				SrmViewsRepository.Other.Properties.isStaticSchedulingFeature, SrmViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createIsIntraMemoryPartitionInteractionCheckbox(FormToolkit widgetFactory, Composite parent) {
		isIntraMemoryPartitionInteraction = widgetFactory
				.createButton(parent,
						getDescription(SrmViewsRepository.Other.Properties.isIntraMemoryPartitionInteraction,
	 ...
	 * 
	 */
	protected Composite createMemoryBlockAddressElementsMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		memoryBlockAddressElements = widgetFactory.createText(parent, "", SWT.READ_ONLY); //$NON-NLS-1$
		...
		editMemoryBlockAddressElements = widgetFactory.createButton(parent,
				getDescription(SrmViewsRepository.Other.Properties.memoryBlockAddressElements,
	 ...
	 * 
	 */
	protected Composite createStackSizeElementsMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		stackSizeElements = widgetFactory.createText(parent, "", SWT.READ_ONLY); //$NON-NLS-1$
		...
		editStackSizeElements = widgetFactory.createButton(parent,
				getDescription(SrmViewsRepository.Other.Properties.stackSizeElements,
		...
		editStackSizeElements.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.stackSizeElements,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null,
	 ...
	 * 
	 */
	protected Composite createHeapSizeElementsMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		heapSizeElements = widgetFactory.createText(parent, "", SWT.READ_ONLY); //$NON-NLS-1$
		...
		editHeapSizeElements = widgetFactory.createButton(parent,
				getDescription(SrmViewsRepository.Other.Properties.heapSizeElements,
	 ...
	 * 
	 */
	protected Composite createMaskElementsMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		maskElements = widgetFactory.createText(parent, "", SWT.READ_ONLY); //$NON-NLS-1$
		...
		editMaskElements = widgetFactory.createButton(parent,
				getDescription(SrmViewsRepository.Other.Properties.maskElements,
	...
	protected Composite createVectorElementsMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editVectorElements = widgetFactory.createButton(parent,
				getDescription(SrmViewsRepository.Other.Properties.vectorElements,
	 ...
	 * 
	 */
	protected Composite createMemoryBlockSizeElementsMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		memoryBlockSizeElements = widgetFactory.createText(parent, "", SWT.READ_ONLY); //$NON-NLS-1$
		...
		editMemoryBlockSizeElements = widgetFactory.createButton(parent,
				getDescription(SrmViewsRepository.Other.Properties.memoryBlockSizeElements,
	...
	protected Composite createOwnedServiceTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedService = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.ownedService,
				SrmMessages.OtherPropertiesEditionPart_OwnedServiceLabel), new ReferencesTableListener() {
					public void handleAdd() {
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
								OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.ownedService,
		...
		this.ownedService.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.ownedService, SrmViewsRepository.FORM_KIND));
	...
	protected Composite createPInterfaceReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.pInterface = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.pInterface,
				SrmMessages.OtherPropertiesEditionPart_PInterfaceLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addPInterface();
					}
		...
		this.pInterface.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.pInterface, SrmViewsRepository.FORM_KIND));
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(pInterface.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.pInterface,
	...
	protected Composite createRInterfaceReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.rInterface = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.rInterface,
				SrmMessages.OtherPropertiesEditionPart_RInterfaceLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addRInterface();
					}
		...
		this.rInterface.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.rInterface, SrmViewsRepository.FORM_KIND));
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(rInterface.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.rInterface,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				rInterface.refresh();
			}
	...
	protected Composite createPServicesTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.pServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.pServices,
				SrmMessages.OtherPropertiesEditionPart_PServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
								OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.pServices,
								PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
						pServices.refresh();
					}
		...
		this.pServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.pServices, SrmViewsRepository.FORM_KIND));
	...
	protected Composite createRServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.rServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.rServices,
				SrmMessages.OtherPropertiesEditionPart_RServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addRServices();
					}
		...
		this.rServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.rServices, SrmViewsRepository.FORM_KIND));
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(rServices.getInput(), rServicesFilters,
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.rServices,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				rServices.refresh();
			}
	 ...
	 * 
	 */
	protected Composite createCreateServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.createServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.createServices,
				SrmMessages.OtherPropertiesEditionPart_CreateServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addCreateServices();
					}
		...
		this.createServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.createServices, SrmViewsRepository.FORM_KIND));
		this.createServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createCreateServicesReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(createServices.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.createServices,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	 ...
	 * 
	 */
	protected Composite createDeleteServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.deleteServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.deleteServices,
				SrmMessages.OtherPropertiesEditionPart_DeleteServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addDeleteServices();
					}
		...
		this.deleteServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.deleteServices, SrmViewsRepository.FORM_KIND));
		this.deleteServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createDeleteServicesReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(deleteServices.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.deleteServices,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	 ...
	 * 
	 */
	protected Composite createInitializeServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.initializeServices = new ReferencesTable(
				getDescription(SrmViewsRepository.Other.Properties.initializeServices,
		...
		this.initializeServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.initializeServices, SrmViewsRepository.FORM_KIND));
		this.initializeServices.createControls(parent, widgetFactory);
		this.initializeServices.addSelectionListener(new SelectionAdapter() {

			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.initializeServices,
		...
		// Start of user code for createInitializeServicesReferencesTable
	 ...
	 * 
	 */
	protected Composite createActivateServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.activateServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.activateServices,
				SrmMessages.OtherPropertiesEditionPart_ActivateServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addActivateServices();
					}
		...
		this.activateServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.activateServices, SrmViewsRepository.FORM_KIND));
		this.activateServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createActivateServicesReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(activateServices.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.activateServices,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	 ...
	 * 
	 */
	protected Composite createResumeServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.resumeServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.resumeServices,
				SrmMessages.OtherPropertiesEditionPart_ResumeServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addResumeServices();
					}
		...
		this.resumeServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.resumeServices, SrmViewsRepository.FORM_KIND));
		this.resumeServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createResumeServicesReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(resumeServices.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.resumeServices,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	 ...
	 * 
	 */
	protected Composite createSuspendServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.suspendServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.suspendServices,
				SrmMessages.OtherPropertiesEditionPart_SuspendServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addSuspendServices();
					}
		...
		this.suspendServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.suspendServices, SrmViewsRepository.FORM_KIND));
		this.suspendServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createSuspendServicesReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(suspendServices.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.suspendServices,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	 ...
	 * 
	 */
	protected Composite createEnableConcurrencyServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.enableConcurrencyServices = new ReferencesTable(
				getDescription(SrmViewsRepository.Other.Properties.enableConcurrencyServices,
		...
		this.enableConcurrencyServices.setHelpText(propertiesEditionComponent.getHelpContent(
				SrmViewsRepository.Other.Properties.enableConcurrencyServices, SrmViewsRepository.FORM_KIND));
		this.enableConcurrencyServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createEnableConcurrencyServicesReferencesTable
	 ...
	 * 
	 */
	protected Composite createDisableConcurrencyServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.disableConcurrencyServices = new ReferencesTable(
				getDescription(SrmViewsRepository.Other.Properties.disableConcurrencyServices,
		...
		this.disableConcurrencyServices.setHelpText(propertiesEditionComponent.getHelpContent(
				SrmViewsRepository.Other.Properties.disableConcurrencyServices, SrmViewsRepository.FORM_KIND));
		this.disableConcurrencyServices.createControls(parent, widgetFactory);
		...
		// Start of user code for
		// createDisableConcurrencyServicesReferencesTable
	 ...
	 * 
	 */
	protected Composite createForkServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.forkServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.forkServices,
				SrmMessages.OtherPropertiesEditionPart_ForkServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addForkServices();
					}
		...
		this.forkServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.forkServices, SrmViewsRepository.FORM_KIND));
		this.forkServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createForkServicesReferencesTable
	 ...
	 * 
	 */
	protected Composite createExitServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.exitServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.exitServices,
				SrmMessages.OtherPropertiesEditionPart_ExitServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addExitServices();
					}
		...
		this.exitServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.exitServices, SrmViewsRepository.FORM_KIND));
		this.exitServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createExitServicesReferencesTable
	 ...
	 * 
	 */
	protected Composite createMemorySpacesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.memorySpaces = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.memorySpaces,
				SrmMessages.OtherPropertiesEditionPart_MemorySpacesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addMemorySpaces();
					}
		...
		this.memorySpaces.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.memorySpaces, SrmViewsRepository.FORM_KIND));
		this.memorySpaces.createControls(parent, widgetFactory);
		...
		// Start of user code for createMemorySpacesReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(memorySpaces.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.memorySpaces,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	 ...
	 * 
	 */
	protected Composite createCloseServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.closeServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.closeServices,
				SrmMessages.OtherPropertiesEditionPart_CloseServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addCloseServices();
					}
		...
		this.closeServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.closeServices, SrmViewsRepository.FORM_KIND));
		this.closeServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createCloseServicesReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(closeServices.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.closeServices,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	 ...
	 * 
	 */
	protected Composite createOpenServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.openServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.openServices,
				SrmMessages.OtherPropertiesEditionPart_OpenServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addOpenServices();
					}
		...
		this.openServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.openServices, SrmViewsRepository.FORM_KIND));
		this.openServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createOpenServicesReferencesTable
	 ...
	 * 
	 */
	protected Composite createAcquireServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.acquireServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.acquireServices,
				SrmMessages.OtherPropertiesEditionPart_AcquireServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addAcquireServices();
					}
		...
		this.acquireServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.acquireServices, SrmViewsRepository.FORM_KIND));
		this.acquireServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createAcquireServicesReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(acquireServices.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.acquireServices,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	 ...
	 * 
	 */
	protected Composite createReleaseServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.releaseServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.releaseServices,
				SrmMessages.OtherPropertiesEditionPart_ReleaseServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addReleaseServices();
					}
		...
		this.releaseServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.releaseServices, SrmViewsRepository.FORM_KIND));
		this.releaseServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createReleaseServicesReferencesTable
	 ...
	 * 
	 */
	protected Composite createControlServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.controlServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.controlServices,
				SrmMessages.OtherPropertiesEditionPart_ControlServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addControlServices();
					}
		...
		this.controlServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.controlServices, SrmViewsRepository.FORM_KIND));
		this.controlServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createControlServicesReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(controlServices.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.controlServices,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	 ...
	 * 
	 */
	protected Composite createSendServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.sendServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.sendServices,
				SrmMessages.OtherPropertiesEditionPart_SendServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addSendServices();
					}
		...
		this.sendServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.sendServices, SrmViewsRepository.FORM_KIND));
		this.sendServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createSendServicesReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(sendServices.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.sendServices,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	 ...
	 * 
	 */
	protected Composite createReceiveServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.receiveServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.receiveServices,
				SrmMessages.OtherPropertiesEditionPart_ReceiveServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addReceiveServices();
					}
		...
		this.receiveServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.receiveServices, SrmViewsRepository.FORM_KIND));
		this.receiveServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createReceiveServicesReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(receiveServices.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.receiveServices,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	 ...
	 * 
	 */
	protected Composite createReadServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.readServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.readServices,
				SrmMessages.OtherPropertiesEditionPart_ReadServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addReadServices();
					}
		...
		this.readServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.readServices, SrmViewsRepository.FORM_KIND));
		this.readServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createReadServicesReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(readServices.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.readServices,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	 ...
	 * 
	 */
	protected Composite createWriteServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.writeServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.writeServices,
				SrmMessages.OtherPropertiesEditionPart_WriteServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addWriteServices();
					}
		...
		this.writeServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.writeServices, SrmViewsRepository.FORM_KIND));
		this.writeServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createWriteServicesReferencesTable
	 ...
	 * 
	 */
	protected Composite createFlushServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.flushServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.flushServices,
				SrmMessages.OtherPropertiesEditionPart_FlushServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addFlushServices();
					}
		...
		this.flushServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.flushServices, SrmViewsRepository.FORM_KIND));
		this.flushServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createFlushServicesReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(flushServices.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.flushServices,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	 ...
	 * 
	 */
	protected Composite createSignalServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.signalServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.signalServices,
				SrmMessages.OtherPropertiesEditionPart_SignalServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addSignalServices();
					}
		...
		this.signalServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.signalServices, SrmViewsRepository.FORM_KIND));
		this.signalServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createSignalServicesReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(signalServices.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.signalServices,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	 ...
	 * 
	 */
	protected Composite createWaitServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.waitServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.waitServices,
				SrmMessages.OtherPropertiesEditionPart_WaitServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addWaitServices();
					}
		...
		this.waitServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.waitServices, SrmViewsRepository.FORM_KIND));
		this.waitServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createWaitServicesReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(waitServices.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.waitServices,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	 ...
	 * 
	 */
	protected Composite createClearServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.clearServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.clearServices,
				SrmMessages.OtherPropertiesEditionPart_ClearServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addClearServices();
					}
		...
		this.clearServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.clearServices, SrmViewsRepository.FORM_KIND));
		this.clearServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createClearServicesReferencesTable
	 ...
	 * 
	 */
	protected Composite createLockServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.lockServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.lockServices,
				SrmMessages.OtherPropertiesEditionPart_LockServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addLockServices();
					}
		...
		this.lockServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.lockServices, SrmViewsRepository.FORM_KIND));
		this.lockServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createLockServicesReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(lockServices.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.lockServices,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	 ...
	 * 
	 */
	protected Composite createUnlockServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.unlockServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.unlockServices,
				SrmMessages.OtherPropertiesEditionPart_UnlockServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addUnlockServices();
					}
		...
		this.unlockServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.unlockServices, SrmViewsRepository.FORM_KIND));
		this.unlockServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createUnlockServicesReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(unlockServices.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.unlockServices,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	 ...
	 * 
	 */
	protected Composite createJoinServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.joinServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.joinServices,
				SrmMessages.OtherPropertiesEditionPart_JoinServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addJoinServices();
					}
		...
		this.joinServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.joinServices, SrmViewsRepository.FORM_KIND));
		this.joinServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createJoinServicesReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(joinServices.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.joinServices,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	 ...
	 * 
	 */
	protected Composite createYieldServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.yieldServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.yieldServices,
				SrmMessages.OtherPropertiesEditionPart_YieldServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addYieldServices();
					}
		...
		this.yieldServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.yieldServices, SrmViewsRepository.FORM_KIND));
		this.yieldServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createYieldServicesReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(yieldServices.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.yieldServices,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	 ...
	 * 
	 */
	protected Composite createDelayServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.delayServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.delayServices,
				SrmMessages.OtherPropertiesEditionPart_DelayServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addDelayServices();
					}
		...
		this.delayServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.delayServices, SrmViewsRepository.FORM_KIND));
		this.delayServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createDelayServicesReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(delayServices.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.delayServices,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	 ...
	 * 
	 */
	protected Composite createMapServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.mapServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.mapServices,
				SrmMessages.OtherPropertiesEditionPart_MapServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addMapServices();
					}
		...
		this.mapServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.mapServices, SrmViewsRepository.FORM_KIND));
		this.mapServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createMapServicesReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(mapServices.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OtherPropertiesEditionPartForm.this, SrmViewsRepository.Other.Properties.mapServices,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				mapServices.refresh();
			}
	 ...
	 * 
	 */
	protected Composite createUnmapServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.unmapServices = new ReferencesTable(getDescription(SrmViewsRepository.Other.Properties.unmapServices,
				SrmMessages.OtherPropertiesEditionPart_UnmapServicesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addUnmapServices();
					}
		...
		this.unmapServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.unmapServices, SrmViewsRepository.FORM_KIND));
		this.unmapServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createUnmapServicesReferencesTable
	 ...
	 * 
	 */
	protected Composite createTerminateServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.terminateServices = new ReferencesTable(
				getDescription(SrmViewsRepository.Other.Properties.terminateServices,
		...
		this.terminateServices.setHelpText(propertiesEditionComponent
				.getHelpContent(SrmViewsRepository.Other.Properties.terminateServices, SrmViewsRepository.FORM_KIND));
		this.terminateServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createTerminateServicesReferencesTable
	 ...
	 * 
	 */
	protected Composite createRoutineConnectServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.routineConnectServices = new ReferencesTable(
				getDescription(SrmViewsRepository.Other.Properties.routineConnectServices,
		...
		this.routineConnectServices.setHelpText(propertiesEditionComponent.getHelpContent(
				SrmViewsRepository.Other.Properties.routineConnectServices, SrmViewsRepository.FORM_KIND));
		this.routineConnectServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createRoutineConnectServicesReferencesTable
	 ...
	 * 
	 */
	protected Composite createRoutineDisconnectServicesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.routineDisconnectServices = new ReferencesTable(
				getDescription(SrmViewsRepository.Other.Properties.routineDisconnectServices,
		...
		this.routineDisconnectServices.setHelpText(propertiesEditionComponent.getHelpContent(
				SrmViewsRepository.Other.Properties.routineDisconnectServices, SrmViewsRepository.FORM_KIND));
		this.routineDisconnectServices.createControls(parent, widgetFactory);
		...
		// Start of user code for createRoutineDisconnectServicesReferencesTable
