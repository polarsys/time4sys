 ...
 * 
 */
public class ResourceInstancePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public ResourceInstancePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject resourceInstance, String editing_mode) {
		super(editingContext, resourceInstance, editing_mode);
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final ResourceInstance resourceInstance = (ResourceInstance)elt;
			final GeneralPropertiesEditionPart generalPart = (GeneralPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(GrmViewsRepository.General.Properties.name))
				generalPart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, resourceInstance.getName()));
			
			if (isAccessible(GrmViewsRepository.General.Properties.type)) {
				// init part
				typeSettings = new EObjectFlatComboSettings(resourceInstance, GrmPackage.eINSTANCE.getResourceInstance_Type());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == GrmViewsRepository.General.Properties.type) {
			return GrmPackage.eINSTANCE.getResourceInstance_Type();
		}
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			GrmPackage.eINSTANCE.getResourceInstance_Type()		);
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == GrmViewsRepository.General.Properties.name || key == GrmViewsRepository.General.Properties.type || key == GrmViewsRepository.General.Properties.class;
	}
	...
	public boolean isRequired(Object key, int kind) {
		return key == GrmViewsRepository.General.Properties.type;
	}
