 ...
 * 
 */
public class ExecutionStepGeneralPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public ExecutionStepGeneralPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject executionStep, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(GqamViewsRepository.General.Properties.name))
				generalPart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, executionStep.getName()));
			
			if (isAccessible(GqamViewsRepository.General.Properties.isAtomic)) {
				generalPart.setIsAtomic(executionStep.isIsAtomic());
			}
			if (isAccessible(GqamViewsRepository.General.Properties.repetitions)) {
				generalPart.setRepetitions(EEFConverterUtil.convertToString(EcorePackage.Literals.EDOUBLE, executionStep.getRepetitions()));
			}
			
			if (isAccessible(GqamViewsRepository.General.Properties.probability)) {
				generalPart.setProbability(EEFConverterUtil.convertToString(EcorePackage.Literals.EDOUBLE, executionStep.getProbability()));
			}
			
			if (isAccessible(GqamViewsRepository.General.Properties.priority)) {
				generalPart.setPriority(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, executionStep.getPriority()));
			}
			
			if (isAccessible(GqamViewsRepository.General.Properties.serviceCount)) {
				generalPart.setServiceCount(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, executionStep.getServiceCount()));
			}
			
			if (isAccessible(GqamViewsRepository.General.Properties.root)) {
				// init part
				rootSettings = new EObjectFlatComboSettings(executionStep, GqamPackage.eINSTANCE.getBehaviorScenario_Root());
			...
			if (isAccessible(GqamViewsRepository.General.Properties.parentStep)) {
				// init part
				parentStepSettings = new EObjectFlatComboSettings(executionStep, GqamPackage.eINSTANCE.getBehaviorScenario_ParentStep());
			...
			if (isAccessible(GqamViewsRepository.General.Properties.scenario)) {
				// init part
				scenarioSettings = new EObjectFlatComboSettings(executionStep, GqamPackage.eINSTANCE.getStep_Scenario());
			...
			if (isAccessible(GqamViewsRepository.General.Properties.childScenario)) {
				// init part
				childScenarioSettings = new EObjectFlatComboSettings(executionStep, GqamPackage.eINSTANCE.getStep_ChildScenario());
			...
			if (isAccessible(GqamViewsRepository.General.Properties.inputRel)) {
				// init part
				inputRelSettings = new EObjectFlatComboSettings(executionStep, GqamPackage.eINSTANCE.getStep_InputRel());
			...
			if (isAccessible(GqamViewsRepository.General.Properties.outputRel)) {
				// init part
				outputRelSettings = new EObjectFlatComboSettings(executionStep, GqamPackage.eINSTANCE.getStep_OutputRel());
			...
			if (isAccessible(GqamViewsRepository.General.Properties.concurRes)) {
				// init part
				concurResSettings = new EObjectFlatComboSettings(executionStep, GqamPackage.eINSTANCE.getStep_ConcurRes());
			...
			if (isAccessible(GqamViewsRepository.General.Properties.steps)) {
				stepsSettings = new ReferencesTableSettings(executionStep, GqamPackage.eINSTANCE.getBehaviorScenario_Steps());
				generalPart.initSteps(stepsSettings);
			}
			if (isAccessible(GqamViewsRepository.General.Properties.cause)) {
				causeSettings = new ReferencesTableSettings(executionStep, GqamPackage.eINSTANCE.getBehaviorScenario_Cause());
				generalPart.initCause(causeSettings);
			}
			if (isAccessible(GqamViewsRepository.General.Properties.connectors)) {
				connectorsSettings = new ReferencesTableSettings(executionStep, GqamPackage.eINSTANCE.getBehaviorScenario_Connectors());
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (GqamViewsRepository.General.Properties.name == event.getAffectedEditor()) {
			executionStep.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		if (GqamViewsRepository.General.Properties.isAtomic == event.getAffectedEditor()) {
			executionStep.setIsAtomic((Boolean)event.getNewValue());
		}
		if (GqamViewsRepository.General.Properties.repetitions == event.getAffectedEditor()) {
			executionStep.setRepetitions((EEFConverterUtil.createDoubleFromString(EcorePackage.Literals.EDOUBLE, (String)event.getNewValue())));
		}
		if (GqamViewsRepository.General.Properties.probability == event.getAffectedEditor()) {
			executionStep.setProbability((EEFConverterUtil.createDoubleFromString(EcorePackage.Literals.EDOUBLE, (String)event.getNewValue())));
		}
		if (GqamViewsRepository.General.Properties.priority == event.getAffectedEditor()) {
			executionStep.setPriority((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (GqamViewsRepository.General.Properties.serviceCount == event.getAffectedEditor()) {
			executionStep.setServiceCount((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
