 ...
 * 
 */
public class SharedDataComResourceOtherPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public SharedDataComResourceOtherPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject sharedDataComResource, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(SrmViewsRepository.Other.Properties.packetSize)) {
				otherPart.setPacketSize(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, sharedDataComResource.getPacketSize()));
			}
			
			if (isAccessible(SrmViewsRepository.Other.Properties.pServices)) {
				pServicesSettings = new ReferencesTableSettings(sharedDataComResource, GrmPackage.eINSTANCE.getResource_PServices());
				otherPart.initPServices(pServicesSettings);
			}
			if (isAccessible(SrmViewsRepository.Other.Properties.rServices)) {
				rServicesSettings = new ReferencesTableSettings(sharedDataComResource, GrmPackage.eINSTANCE.getResource_RServices());
				otherPart.initRServices(rServicesSettings);
			}
			if (isAccessible(SrmViewsRepository.Other.Properties.createServices)) {
				createServicesSettings = new ReferencesTableSettings(sharedDataComResource, SrmPackage.eINSTANCE.getSoftwareResource_CreateServices());
				otherPart.initCreateServices(createServicesSettings);
			}
			if (isAccessible(SrmViewsRepository.Other.Properties.deleteServices)) {
				deleteServicesSettings = new ReferencesTableSettings(sharedDataComResource, SrmPackage.eINSTANCE.getSoftwareResource_DeleteServices());
			...
			if (isAccessible(SrmViewsRepository.Other.Properties.initializeServices)) {
				initializeServicesSettings = new ReferencesTableSettings(sharedDataComResource, SrmPackage.eINSTANCE.getSoftwareResource_InitializeServices());
			...
			if (isAccessible(SrmViewsRepository.Other.Properties.isIntraMemoryPartitionInteraction)) {
				otherPart.setIsIntraMemoryPartitionInteraction(sharedDataComResource.isIsIntraMemoryPartitionInteraction());
			}
			if (isAccessible(SrmViewsRepository.Other.Properties.readServices)) {
				readServicesSettings = new ReferencesTableSettings(sharedDataComResource, SrmPackage.eINSTANCE.getSharedDataComResource_ReadServices());
				otherPart.initReadServices(readServicesSettings);
			}
			if (isAccessible(SrmViewsRepository.Other.Properties.writeServices)) {
				writeServicesSettings = new ReferencesTableSettings(sharedDataComResource, SrmPackage.eINSTANCE.getSharedDataComResource_WriteServices());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == SrmViewsRepository.Other.Properties.readServices) {
			return SrmPackage.eINSTANCE.getSharedDataComResource_ReadServices();
		}
		if (editorKey == SrmViewsRepository.Other.Properties.writeServices) {
			return SrmPackage.eINSTANCE.getSharedDataComResource_WriteServices();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (SrmViewsRepository.Other.Properties.packetSize == event.getAffectedEditor()) {
			sharedDataComResource.setPacketSize((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		...
		if (SrmViewsRepository.Other.Properties.isIntraMemoryPartitionInteraction == event.getAffectedEditor()) {
			sharedDataComResource.setIsIntraMemoryPartitionInteraction((Boolean)event.getNewValue());
		}
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			SrmPackage.eINSTANCE.getSharedDataComResource_ReadServices(),
			SrmPackage.eINSTANCE.getSharedDataComResource_WriteServices()		);
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == SrmViewsRepository.Other.Properties.packetSize || key == SrmViewsRepository.Other.Properties.pServices || key == SrmViewsRepository.Other.Properties.rServices || key == SrmViewsRepository.Other.Properties.createServices || key == SrmViewsRepository.Other.Properties.deleteServices || key == SrmViewsRepository.Other.Properties.initializeServices || key == SrmViewsRepository.Other.Properties.isIntraMemoryPartitionInteraction || key == SrmViewsRepository.Other.Properties.readServices || key == SrmViewsRepository.Other.Properties.writeServices || key == SrmViewsRepository.Other.Properties.class;
	}
