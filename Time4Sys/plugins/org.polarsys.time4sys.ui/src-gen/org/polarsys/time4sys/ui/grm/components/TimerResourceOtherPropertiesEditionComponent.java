 ...
 * 
 */
public class TimerResourceOtherPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public TimerResourceOtherPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject timerResource, String editing_mode) {
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(GrmViewsRepository.Other.OtherProperties.pServices)) {
				pServicesSettings = new ReferencesTableSettings(timerResource, GrmPackage.eINSTANCE.getResource_PServices());
				otherPart.initPServices(pServicesSettings);
			}
			if (isAccessible(GrmViewsRepository.Other.OtherProperties.rServices)) {
				rServicesSettings = new ReferencesTableSettings(timerResource, GrmPackage.eINSTANCE.getResource_RServices());
