 ...
 * @generated
 */
public class FragmentPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, FragmentPropertiesEditionPart {
	 ...
	 */
	public FragmentPropertiesEditionPartForm() { super(); }
	 ...
	 * @generated
	 */
	public FragmentPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(fragmentStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == AnalysisViewsRepository.Fragment.Properties.next) {
					return createNextFlatComboViewer(parent, widgetFactory);
				}
				if (key == AnalysisViewsRepository.Fragment.Properties.previous) {
					return createPreviousFlatComboViewer(parent, widgetFactory);
				}
				if (key == AnalysisViewsRepository.Fragment.Properties.task) {
					return createTaskFlatComboViewer(parent, widgetFactory);
				}
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(AnalysisMessages.FragmentPropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							FragmentPropertiesEditionPartForm.this,
							AnalysisViewsRepository.Fragment.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FragmentPropertiesEditionPartForm.this, AnalysisViewsRepository.Fragment.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, AnalysisViewsRepository.Fragment.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Fragment.Properties.name, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createLockedMutexesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.lockedMutexes = new ReferencesTable(getDescription(AnalysisViewsRepository.Fragment.Properties.lockedMutexes, AnalysisMessages.FragmentPropertiesEditionPart_LockedMutexesLabel), new ReferencesTableListener	() {
		...
		this.lockedMutexes.setHelpText(propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Fragment.Properties.lockedMutexes, AnalysisViewsRepository.FORM_KIND));
		...
		this.lockedMutexes.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FragmentPropertiesEditionPartForm.this, AnalysisViewsRepository.Fragment.Properties.lockedMutexes, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"lockedMutexes", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FragmentPropertiesEditionPartForm.this, AnalysisViewsRepository.Fragment.Properties.lockedMutexes,
	...
	protected void moveLockedMutexes(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FragmentPropertiesEditionPartForm.this, AnalysisViewsRepository.Fragment.Properties.lockedMutexes, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		lockedMutexes.refresh();
	}
	...
	protected void removeFromLockedMutexes(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FragmentPropertiesEditionPartForm.this, AnalysisViewsRepository.Fragment.Properties.lockedMutexes, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		lockedMutexes.refresh();
	}
	 ...
	 * @generated
	 */
	protected Composite createNextFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		next = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(AnalysisViewsRepository.Fragment.Properties.next, AnalysisViewsRepository.FORM_KIND));
		widgetFactory.adapt(next);
		...
		next.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FragmentPropertiesEditionPartForm.this, AnalysisViewsRepository.Fragment.Properties.next, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getNext()));
			}

		});
		next.setID(AnalysisViewsRepository.Fragment.Properties.next);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Fragment.Properties.next, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * @generated
	 */
	protected Composite createPreviousFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		previous = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(AnalysisViewsRepository.Fragment.Properties.previous, AnalysisViewsRepository.FORM_KIND));
		widgetFactory.adapt(previous);
		...
		previous.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FragmentPropertiesEditionPartForm.this, AnalysisViewsRepository.Fragment.Properties.previous, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getPrevious()));
			}

		});
		previous.setID(AnalysisViewsRepository.Fragment.Properties.previous);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Fragment.Properties.previous, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createTaskFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		task = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(AnalysisViewsRepository.Fragment.Properties.task, AnalysisViewsRepository.FORM_KIND));
		...
		task.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FragmentPropertiesEditionPartForm.this, AnalysisViewsRepository.Fragment.Properties.task, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getTask()));
			}

		});
		task.setID(AnalysisViewsRepository.Fragment.Properties.task);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Fragment.Properties.task, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCETText(FormToolkit widgetFactory, Composite parent) {
		...
		cET.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							FragmentPropertiesEditionPartForm.this,
							AnalysisViewsRepository.Fragment.Properties.cET,
		...
		cET.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(FragmentPropertiesEditionPartForm.this, AnalysisViewsRepository.Fragment.Properties.cET, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, cET.getText()));
				}
			}
		});
		EditingUtils.setID(cET, AnalysisViewsRepository.Fragment.Properties.cET);
		EditingUtils.setEEFtype(cET, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Fragment.Properties.cET, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
