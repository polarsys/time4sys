 ...
 * @generated
 */
public class OutputPortPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, OutputPortPropertiesEditionPart {
	 ...
	 */
	public OutputPortPropertiesEditionPartForm() { super(); }
	 ...
	 * @generated
	 */
	public OutputPortPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(AnalysisMessages.OutputPortPropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							OutputPortPropertiesEditionPartForm.this,
							AnalysisViewsRepository.OutputPort.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputPortPropertiesEditionPartForm.this, AnalysisViewsRepository.OutputPort.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, AnalysisViewsRepository.OutputPort.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.OutputPort.Properties.name, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createParent_FlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		parent_ = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(AnalysisViewsRepository.OutputPort.Properties.parent_, AnalysisViewsRepository.FORM_KIND));
		...
		parent_.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputPortPropertiesEditionPartForm.this, AnalysisViewsRepository.OutputPort.Properties.parent_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getParent_()));
			}

		});
		parent_.setID(AnalysisViewsRepository.OutputPort.Properties.parent_);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.OutputPort.Properties.parent_, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * @generated
	 */
	protected Composite createSendToFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		sendTo = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(AnalysisViewsRepository.OutputPort.Properties.sendTo, AnalysisViewsRepository.FORM_KIND));
		widgetFactory.adapt(sendTo);
		...
		sendTo.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(OutputPortPropertiesEditionPartForm.this, AnalysisViewsRepository.OutputPort.Properties.sendTo, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getSendTo()));
			}

		});
		sendTo.setID(AnalysisViewsRepository.OutputPort.Properties.sendTo);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.OutputPort.Properties.sendTo, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
