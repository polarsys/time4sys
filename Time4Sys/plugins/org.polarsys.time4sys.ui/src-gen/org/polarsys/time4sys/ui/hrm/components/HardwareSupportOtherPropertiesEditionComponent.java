 ...
 * 
 */
public class HardwareSupportOtherPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public HardwareSupportOtherPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject hardwareSupport, String editing_mode) {
		super(editingContext, hardwareSupport, editing_mode);
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(HrmViewsRepository.Other.Properties.pServices)) {
				pServicesSettings = new ReferencesTableSettings(hardwareSupport, GrmPackage.eINSTANCE.getResource_PServices());
				otherPart.initPServices(pServicesSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.ownedPort)) {
				ownedPortSettings = new ReferencesTableSettings(hardwareSupport, GrmPackage.eINSTANCE.getResource_OwnedPort());
				otherPart.initOwnedPort(ownedPortSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.rServices)) {
				rServicesSettings = new ReferencesTableSettings(hardwareSupport, GrmPackage.eINSTANCE.getResource_RServices());
				otherPart.initRServices(rServicesSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.dimension)) {
				otherPart.setDimension(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareSupport.getDimension()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.posX)) {
				otherPart.setPosX(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareSupport.getPosX()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.posY)) {
				otherPart.setPosY(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareSupport.getPosY()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.grid)) {
				otherPart.setGrid(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareSupport.getGrid()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.nbPins)) {
				otherPart.setNbPins(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareSupport.getNbPins()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.weight)) {
				otherPart.setWeight(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareSupport.getWeight()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.price)) {
				otherPart.setPrice(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareSupport.getPrice()));
			}
			
			if (isAccessible(HrmViewsRepository.Other.Properties.rConditions)) {
				rConditionsSettings = new ReferencesTableSettings(hardwareSupport, HrmPackage.eINSTANCE.getHardwareComponent_RConditions());
				otherPart.initRConditions(rConditionsSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.ownedPin)) {
				ownedPinSettings = new ReferencesTableSettings(hardwareSupport, HrmPackage.eINSTANCE.getHardwareComponent_OwnedPin());
				otherPart.initOwnedPin(ownedPinSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.ownedWire)) {
				ownedWireSettings = new ReferencesTableSettings(hardwareSupport, HrmPackage.eINSTANCE.getHardwareComponent_OwnedWire());
				otherPart.initOwnedWire(ownedWireSettings);
			}
			if (isAccessible(HrmViewsRepository.Other.Properties.technology)) {
				otherPart.setTechnology(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareSupport.getTechnology()));
			}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		HardwareSupport hardwareSupport = (HardwareSupport)semanticObject;
		...
		if (HrmViewsRepository.Other.Properties.dimension == event.getAffectedEditor()) {
			hardwareSupport.setDimension((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.posX == event.getAffectedEditor()) {
			hardwareSupport.setPosX((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.posY == event.getAffectedEditor()) {
			hardwareSupport.setPosY((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.grid == event.getAffectedEditor()) {
			hardwareSupport.setGrid((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.nbPins == event.getAffectedEditor()) {
			hardwareSupport.setNbPins((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.weight == event.getAffectedEditor()) {
			hardwareSupport.setWeight((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.Other.Properties.price == event.getAffectedEditor()) {
			hardwareSupport.setPrice((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		...
		if (HrmViewsRepository.Other.Properties.technology == event.getAffectedEditor()) {
			hardwareSupport.setTechnology((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
	}
