...
public class TaskPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, TaskPropertiesEditionPart {
		...
		composer = new PartComposer(taskStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == AnalysisViewsRepository.Task.Properties.lockedMutexes) {
					return createLockedMutexesReferencesTable(widgetFactory, parent);
				}
				if (key == AnalysisViewsRepository.Task.Properties.mappedTo) {
					return createMappedToFlatComboViewer(parent, widgetFactory);
				}
				if (key == AnalysisViewsRepository.Task.Properties.fragments) {
					return createFragmentsTableComposition(widgetFactory, parent);
				}
				if (key == AnalysisViewsRepository.Task.Properties.first) {
					return createFirstFlatComboViewer(parent, widgetFactory);
				}
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(AnalysisMessages.TaskPropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							...
							AnalysisViewsRepository.Task.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, AnalysisViewsRepository.Task.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Task.Properties.name, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPortsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ports = new ReferencesTable(getDescription(AnalysisViewsRepository.Task.Properties.ports, AnalysisMessages.TaskPropertiesEditionPart_PortsLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.ports, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				ports.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.ports, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				ports.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.ports, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				ports.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.ports, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				ports.refresh();
			}
		...
		this.ports.setHelpText(propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Task.Properties.ports, AnalysisViewsRepository.FORM_KIND));
		this.ports.createControls(parent, widgetFactory);
		this.ports.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.ports, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createBehaviorKindEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		behaviorKind.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.behaviorKind, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getBehaviorKind()));
			}

		});
		behaviorKind.setID(AnalysisViewsRepository.Task.Properties.behaviorKind);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Task.Properties.behaviorKind, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createParent_FlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		parent_ = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(AnalysisViewsRepository.Task.Properties.parent_, AnalysisViewsRepository.FORM_KIND));
		...
		parent_.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.parent_, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getParent_()));
			}

		});
		parent_.setID(AnalysisViewsRepository.Task.Properties.parent_);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Task.Properties.parent_, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createScheduledByFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		scheduledBy = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(AnalysisViewsRepository.Task.Properties.scheduledBy, AnalysisViewsRepository.FORM_KIND));
		...
		scheduledBy.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.scheduledBy, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getScheduledBy()));
			}

		});
		scheduledBy.setID(AnalysisViewsRepository.Task.Properties.scheduledBy);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Task.Properties.scheduledBy, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createCETText(FormToolkit widgetFactory, Composite parent) {
		...
		cET.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TaskPropertiesEditionPartForm.this,
							AnalysisViewsRepository.Task.Properties.cET,
		...
		cET.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.cET, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, cET.getText()));
				}
			}
		});
		EditingUtils.setID(cET, AnalysisViewsRepository.Task.Properties.cET);
		EditingUtils.setEEFtype(cET, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Task.Properties.cET, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createSchedulingParametersTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.schedulingParameters = new ReferencesTable(getDescription(AnalysisViewsRepository.Task.Properties.schedulingParameters, AnalysisMessages.TaskPropertiesEditionPart_SchedulingParametersLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.schedulingParameters, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				schedulingParameters.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.schedulingParameters, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				schedulingParameters.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.schedulingParameters, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				schedulingParameters.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.schedulingParameters, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				schedulingParameters.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.schedulingParameters.setHelpText(propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Task.Properties.schedulingParameters, AnalysisViewsRepository.FORM_KIND));
		...
		this.schedulingParameters.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.schedulingParameters, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createOriginalNameText(FormToolkit widgetFactory, Composite parent) {
		...
		originalName.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TaskPropertiesEditionPartForm.this,
							AnalysisViewsRepository.Task.Properties.originalName,
		...
		originalName.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.originalName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, originalName.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Task.Properties.originalName, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * @generated
	 */
	protected Composite createLockedMutexesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.lockedMutexes = new ReferencesTable(getDescription(AnalysisViewsRepository.Task.Properties.lockedMutexes, AnalysisMessages.TaskPropertiesEditionPart_LockedMutexesLabel), new ReferencesTableListener	() {
		...
		this.lockedMutexes.setHelpText(propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Task.Properties.lockedMutexes, AnalysisViewsRepository.FORM_KIND));
		this.lockedMutexes.createControls(parent, widgetFactory);
		this.lockedMutexes.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.lockedMutexes, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		// Start of user code for createLockedMutexesReferencesTable
		...
		"lockedMutexes", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.lockedMutexes,
	...
	protected void moveLockedMutexes(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.lockedMutexes, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		lockedMutexes.refresh();
	}
	...
	protected void removeFromLockedMutexes(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.lockedMutexes, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		lockedMutexes.refresh();
	}
	 ...
	 * @generated
	 */
	protected Composite createMappedToFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		mappedTo = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(AnalysisViewsRepository.Task.Properties.mappedTo, AnalysisViewsRepository.FORM_KIND));
		widgetFactory.adapt(mappedTo);
		...
		mappedTo.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.mappedTo, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getMappedTo()));
			}

		});
		mappedTo.setID(AnalysisViewsRepository.Task.Properties.mappedTo);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Task.Properties.mappedTo, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	 ...
	 * @generated
	 */
	protected Composite createFragmentsTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.fragments = new ReferencesTable(getDescription(AnalysisViewsRepository.Task.Properties.fragments, AnalysisMessages.TaskPropertiesEditionPart_FragmentsLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.fragments, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				fragments.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.fragments, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				fragments.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.fragments, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				fragments.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.fragments, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				fragments.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.fragments.setHelpText(propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Task.Properties.fragments, AnalysisViewsRepository.FORM_KIND));
		this.fragments.createControls(parent, widgetFactory);
		this.fragments.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.fragments, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		// Start of user code for createFragmentsTableComposition
	 ...
	 * @generated
	 */
	protected Composite createFirstFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		first = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(AnalysisViewsRepository.Task.Properties.first, AnalysisViewsRepository.FORM_KIND));
		widgetFactory.adapt(first);
		...
		first.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.first, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getFirst()));
			}

		});
		first.setID(AnalysisViewsRepository.Task.Properties.first);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Task.Properties.first, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createBlockingTimeText(FormToolkit widgetFactory, Composite parent) {
		...
		blockingTime.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TaskPropertiesEditionPartForm.this,
							AnalysisViewsRepository.Task.Properties.blockingTime,
		...
		blockingTime.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(TaskPropertiesEditionPartForm.this, AnalysisViewsRepository.Task.Properties.blockingTime, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, blockingTime.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.Task.Properties.blockingTime, AnalysisViewsRepository.FORM_KIND), null); //$NON-NLS-1$
