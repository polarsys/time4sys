...
public class TimingPropertiesEditionPartImpl extends CompositePropertiesEditionPart
		...
		composer = new PartComposer(timingStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == HrmViewsRepository.Timing.TimingProperties.replPolicy) {
					return createReplPolicyEMFComboViewer(parent);
				}
				if (key == HrmViewsRepository.Timing.TimingProperties.writePolicy) {
					return createWritePolicyEMFComboViewer(parent);
				}
				...
				if (key == HrmViewsRepository.Timing.TimingProperties.timings) {
					return createTimingsMultiValuedEditor(parent);
				}
				if (key == HrmViewsRepository.Timing.TimingProperties.inputClock) {
					return createInputClockFlatComboViewer(parent);
				}
	...
	protected Composite createReplPolicyEMFComboViewer(Composite parent) {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TimingPropertiesEditionPartImpl.this, HrmViewsRepository.Timing.TimingProperties.replPolicy,
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				HrmViewsRepository.Timing.TimingProperties.replPolicy, HrmViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createWritePolicyEMFComboViewer(Composite parent) {
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				HrmViewsRepository.Timing.TimingProperties.writePolicy, HrmViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createClockFlatComboViewer(Composite parent) {
		...
		clock = new EObjectFlatComboViewer(parent, !propertiesEditionComponent
				.isRequired(HrmViewsRepository.Timing.TimingProperties.clock, HrmViewsRepository.SWT_KIND));
		...
		clock.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						TimingPropertiesEditionPartImpl.this, HrmViewsRepository.Timing.TimingProperties.clock,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getClock()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.Timing.TimingProperties.clock, HrmViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createTimingsMultiValuedEditor(Composite parent) {
		timings = SWTUtils.createScrollableText(parent, SWT.BORDER | SWT.READ_ONLY);
		...
		editTimings = new Button(parent, SWT.NONE);
		editTimings.setText(getDescription(HrmViewsRepository.Timing.TimingProperties.timings,
	 ...
	 * 
	 */
	protected Composite createInputClockFlatComboViewer(Composite parent) {
		...
		inputClock = new EObjectFlatComboViewer(parent, !propertiesEditionComponent
				.isRequired(HrmViewsRepository.Timing.TimingProperties.inputClock, HrmViewsRepository.SWT_KIND));
		...
		inputClock.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
						TimingPropertiesEditionPartImpl.this, HrmViewsRepository.Timing.TimingProperties.inputClock,
						PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getInputClock()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(
				HrmViewsRepository.Timing.TimingProperties.inputClock, HrmViewsRepository.SWT_KIND), null); // $NON-NLS-1$
	...
	protected Composite createAccCtrlPolicyAdvancedTableComposition(Composite parent) {
		...
		this.accCtrlPolicy.setHelpText(propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.Timing.TimingProperties.accCtrlPolicy, HrmViewsRepository.SWT_KIND));
