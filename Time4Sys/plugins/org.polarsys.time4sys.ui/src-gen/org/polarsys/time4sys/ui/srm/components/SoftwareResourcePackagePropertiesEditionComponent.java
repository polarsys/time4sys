 ...
 * 
 */
public class SoftwareResourcePackagePropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public SoftwareResourcePackagePropertiesEditionComponent(PropertiesEditingContext editingContext, EObject softwareResourcePackage, String editing_mode) {
		super(editingContext, softwareResourcePackage, editing_mode);
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			if (isAccessible(SrmViewsRepository.General.Properties.ownedElement)) {
				ownedElementSettings = new ReferencesTableSettings(softwareResourcePackage, CoreElementsPackage.eINSTANCE.getPackage_OwnedElement());
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		SoftwareResourcePackage softwareResourcePackage = (SoftwareResourcePackage)semanticObject;
		if (SrmViewsRepository.General.Properties.name == event.getAffectedEditor()) {
			softwareResourcePackage.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
