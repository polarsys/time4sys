 ...
 * 
 */
public class ProtectionParameterGeneralPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public ProtectionParameterGeneralPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject protectionParameter, String editing_mode) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (GrmViewsRepository.General.Properties.name == event.getAffectedEditor()) {
			protectionParameter.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
	}
