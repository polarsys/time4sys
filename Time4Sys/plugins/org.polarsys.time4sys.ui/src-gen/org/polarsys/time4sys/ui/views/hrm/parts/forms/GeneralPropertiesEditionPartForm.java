...
public class GeneralPropertiesEditionPartForm extends SectionPropertiesEditingPart
		...
		composer = new PartComposer(generalStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == HrmViewsRepository.General.Properties.family) {
					return createFamilyText(widgetFactory, parent);
				}
				...
				if (key == HrmViewsRepository.General.Properties.memoryProtection) {
					return createMemoryProtectionCheckbox(widgetFactory, parent);
				}
				if (key == HrmViewsRepository.General.Properties.range) {
					return createRangeText(widgetFactory, parent);
				}
				...
				if (key == HrmViewsRepository.General.Properties.isNonVolatile) {
					return createIsNonVolatileCheckbox(widgetFactory, parent);
				}
				if (key == HrmViewsRepository.General.Properties.memorySize) {
					return createMemorySizeText(widgetFactory, parent);
				}
				if (key == HrmViewsRepository.General.Properties.addressSize) {
					return createAddressSizeText(widgetFactory, parent);
				}
				if (key == HrmViewsRepository.General.Properties.nbChannels) {
					return createNbChannelsText(widgetFactory, parent);
				}
				if (key == HrmViewsRepository.General.Properties.transferWidth) {
					return createTransferWidthText(widgetFactory, parent);
				}
				...
				if (key == HrmViewsRepository.General.Properties.realizedBy) {
					return createRealizedByReferencesTable(widgetFactory, parent);
				}
				...
				if (key == HrmViewsRepository.General.Properties.sides) {
					return createSidesReferencesTable(widgetFactory, parent);
				}
				if (key == HrmViewsRepository.General.Properties.managedMemories) {
					return createManagedMemoriesReferencesTable(widgetFactory, parent);
				}
				if (key == HrmViewsRepository.General.Properties.controlledMedia) {
					return createControlledMediaReferencesTable(widgetFactory, parent);
				}
				if (key == HrmViewsRepository.General.Properties.drivenBy) {
					return createDrivenByReferencesTable(widgetFactory, parent);
				}
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.name,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
					propertiesEditionComponent
							.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this,
									HrmViewsRepository.General.Properties.name, PropertiesEditionEvent.FOCUS_CHANGED,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.name, HrmViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		type.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.type,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.type, HrmViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createFamilyText(FormToolkit widgetFactory, Composite parent) {
		...
		family = widgetFactory.createText(parent, ""); //$NON-NLS-1$
		family.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
		widgetFactory.paintBordersFor(parent);
		...
		family.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.family,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, family.getText()));
					propertiesEditionComponent
							.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this,
									HrmViewsRepository.General.Properties.family, PropertiesEditionEvent.FOCUS_CHANGED,
									PropertiesEditionEvent.FOCUS_LOST, null, family.getText()));
				}
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.family, HrmViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createStatusEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		status.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.status,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.status, HrmViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createDescriptionText(FormToolkit widgetFactory, Composite parent) {
		...
		description.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.description,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.description, HrmViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createSpeedFactorText(FormToolkit widgetFactory, Composite parent) {
		...
		speedFactor.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.speedFactor,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.speedFactor, HrmViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createMemoryProtectionCheckbox(FormToolkit widgetFactory, Composite parent) {
		memoryProtection = widgetFactory.createButton(parent,
				getDescription(HrmViewsRepository.General.Properties.memoryProtection,
		...
		FormUtils
				.createHelpButton(widgetFactory, parent,
						propertiesEditionComponent.getHelpContent(
								HrmViewsRepository.General.Properties.memoryProtection, HrmViewsRepository.FORM_KIND),
						null); // $NON-NLS-1$
	...
	protected Composite createRangeText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, HrmViewsRepository.General.Properties.range,
				HrmMessages.GeneralPropertiesEditionPart_RangeLabel);
		range = widgetFactory.createText(parent, ""); //$NON-NLS-1$
		range.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
		widgetFactory.paintBordersFor(parent);
		...
		range.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.range,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, range.getText()));
					propertiesEditionComponent
							.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this,
									HrmViewsRepository.General.Properties.range, PropertiesEditionEvent.FOCUS_CHANGED,
									PropertiesEditionEvent.FOCUS_LOST, null, range.getText()));
				}
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.range, HrmViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createIsActiveCheckbox(FormToolkit widgetFactory, Composite parent) {
		isActive = widgetFactory.createButton(parent, getDescription(HrmViewsRepository.General.Properties.isActive,
				HrmMessages.GeneralPropertiesEditionPart_IsActiveLabel), SWT.CHECK);
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.isActive, HrmViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createIsProtectedCheckbox(FormToolkit widgetFactory, Composite parent) {
		isProtected = widgetFactory.createButton(parent,
				getDescription(HrmViewsRepository.General.Properties.isProtected,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.isProtected, HrmViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createIsSynchronousCheckbox(FormToolkit widgetFactory, Composite parent) {
		isSynchronous = widgetFactory.createButton(parent,
				getDescription(HrmViewsRepository.General.Properties.isSynchronous,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				HrmViewsRepository.General.Properties.isSynchronous, HrmViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createMemorySizeText(FormToolkit widgetFactory, Composite parent) {
		...
		memorySize = widgetFactory.createText(parent, ""); //$NON-NLS-1$
		memorySize.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
		widgetFactory.paintBordersFor(parent);
		...
		memorySize.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.memorySize,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.memorySize, HrmViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createAddressSizeText(FormToolkit widgetFactory, Composite parent) {
		...
		addressSize = widgetFactory.createText(parent, ""); //$NON-NLS-1$
		addressSize.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
		widgetFactory.paintBordersFor(parent);
		...
		addressSize.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.addressSize,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.addressSize, HrmViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createNbChannelsText(FormToolkit widgetFactory, Composite parent) {
		...
		nbChannels = widgetFactory.createText(parent, ""); //$NON-NLS-1$
		nbChannels.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
		widgetFactory.paintBordersFor(parent);
		...
		nbChannels.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.nbChannels,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.nbChannels, HrmViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createTransferWidthText(FormToolkit widgetFactory, Composite parent) {
		...
		transferWidth = widgetFactory.createText(parent, ""); //$NON-NLS-1$
		transferWidth.setData(FormToolkit.KEY_DRAW_BORDER, FormToolkit.TEXT_BORDER);
		widgetFactory.paintBordersFor(parent);
		...
		transferWidth.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.transferWidth,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, transferWidth.getText()));
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.transferWidth,
							PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST, null,
							transferWidth.getText()));
				}
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				HrmViewsRepository.General.Properties.transferWidth, HrmViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createThroughputText(FormToolkit widgetFactory, Composite parent) {
		...
		throughput.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.throughput,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.throughput, HrmViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createLevelText(FormToolkit widgetFactory, Composite parent) {
		...
		level.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.level,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, level.getText()));
					propertiesEditionComponent
							.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this,
									HrmViewsRepository.General.Properties.level, PropertiesEditionEvent.FOCUS_CHANGED,
									PropertiesEditionEvent.FOCUS_LOST, null, level.getText()));
				}
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.level, HrmViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createResMultText(FormToolkit widgetFactory, Composite parent) {
		...
		resMult.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.resMult,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, resMult.getText()));
					propertiesEditionComponent
							.firePropertiesChanged(new PropertiesEditionEvent(GeneralPropertiesEditionPartForm.this,
									HrmViewsRepository.General.Properties.resMult, PropertiesEditionEvent.FOCUS_CHANGED,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.resMult, HrmViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createSourcePortFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		sourcePort = new EObjectFlatComboViewer(parent, !propertiesEditionComponent
				.isRequired(HrmViewsRepository.General.Properties.sourcePort, HrmViewsRepository.FORM_KIND));
		...
		sourcePort.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.sourcePort,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.sourcePort, HrmViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createTargetPortFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		targetPort = new EObjectFlatComboViewer(parent, !propertiesEditionComponent
				.isRequired(HrmViewsRepository.General.Properties.targetPort, HrmViewsRepository.FORM_KIND));
		...
		targetPort.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.targetPort,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.targetPort, HrmViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createMainSchedulerFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		mainScheduler = new EObjectFlatComboViewer(parent, !propertiesEditionComponent
				.isRequired(HrmViewsRepository.General.Properties.mainScheduler, HrmViewsRepository.FORM_KIND));
		...
		mainScheduler.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.mainScheduler,
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(
				HrmViewsRepository.General.Properties.mainScheduler, HrmViewsRepository.FORM_KIND), null); // $NON-NLS-1$
	...
	protected Composite createUsedByReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.usedBy = new ReferencesTable(getDescription(HrmViewsRepository.General.Properties.usedBy,
				HrmMessages.GeneralPropertiesEditionPart_UsedByLabel), new ReferencesTableListener() {
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(usedBy.getInput(), usedByFilters,
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.usedBy,
	 ...
	 * 
	 */
	protected Composite createRealizedByReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.realizedBy = new ReferencesTable(getDescription(HrmViewsRepository.General.Properties.realizedBy,
				HrmMessages.GeneralPropertiesEditionPart_RealizedByLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addRealizedBy();
					}
		...
		this.realizedBy.setHelpText(propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.realizedBy, HrmViewsRepository.FORM_KIND));
		this.realizedBy.createControls(parent, widgetFactory);
		...
		// Start of user code for createRealizedByReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(realizedBy.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.realizedBy,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				realizedBy.refresh();
			}
	...
	protected Composite createArbitersReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.arbiters = new ReferencesTable(getDescription(HrmViewsRepository.General.Properties.arbiters,
				HrmMessages.GeneralPropertiesEditionPart_ArbitersLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addArbiters();
					}
		...
		this.arbiters.setHelpText(propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.arbiters, HrmViewsRepository.FORM_KIND));
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(arbiters.getInput(), arbitersFilters,
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.arbiters,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				arbiters.refresh();
			}
	 ...
	 * 
	 */
	protected Composite createSidesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.sides = new ReferencesTable(getDescription(HrmViewsRepository.General.Properties.sides,
				HrmMessages.GeneralPropertiesEditionPart_SidesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addSides();
					}
		...
		this.sides.setHelpText(propertiesEditionComponent.getHelpContent(HrmViewsRepository.General.Properties.sides,
				HrmViewsRepository.FORM_KIND));
		this.sides.createControls(parent, widgetFactory);
		...
		// Start of user code for createSidesReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(sides.getInput(), sidesFilters,
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.sides,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				sides.refresh();
			}
	 ...
	 * 
	 */
	protected Composite createManagedMemoriesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.managedMemories = new ReferencesTable(getDescription(HrmViewsRepository.General.Properties.managedMemories,
				HrmMessages.GeneralPropertiesEditionPart_ManagedMemoriesLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addManagedMemories();
					}
		...
		this.managedMemories.setHelpText(propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.managedMemories, HrmViewsRepository.FORM_KIND));
		this.managedMemories.createControls(parent, widgetFactory);
		...
		// Start of user code for createManagedMemoriesReferencesTable
	...
	protected void moveManagedMemories(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.managedMemories,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		managedMemories.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createControlledMediaReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.controlledMedia = new ReferencesTable(getDescription(HrmViewsRepository.General.Properties.controlledMedia,
				HrmMessages.GeneralPropertiesEditionPart_ControlledMediaLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addControlledMedia();
					}
		...
		this.controlledMedia.setHelpText(propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.controlledMedia, HrmViewsRepository.FORM_KIND));
		this.controlledMedia.createControls(parent, widgetFactory);
		...
		// Start of user code for createControlledMediaReferencesTable
	...
	protected void moveControlledMedia(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
				GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.controlledMedia,
				PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		controlledMedia.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createDrivenByReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.drivenBy = new ReferencesTable(getDescription(HrmViewsRepository.General.Properties.drivenBy,
				HrmMessages.GeneralPropertiesEditionPart_DrivenByLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addDrivenBy();
					}
		...
		this.drivenBy.setHelpText(propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.drivenBy, HrmViewsRepository.FORM_KIND));
		this.drivenBy.createControls(parent, widgetFactory);
		...
		// Start of user code for createDrivenByReferencesTable
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(drivenBy.getInput(), drivenByFilters,
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.drivenBy,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				drivenBy.refresh();
			}
	...
	protected Composite createBrokedResourceReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.brokedResource = new ReferencesTable(getDescription(HrmViewsRepository.General.Properties.brokedResource,
				HrmMessages.GeneralPropertiesEditionPart_BrokedResourceLabel), new ReferencesTableListener() {
					public void handleAdd() {
						addBrokedResource();
					}
		...
		this.brokedResource.setHelpText(propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.brokedResource, HrmViewsRepository.FORM_KIND));
		...
		TabElementTreeSelectionDialog dialog = new TabElementTreeSelectionDialog(brokedResource.getInput(),
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							GeneralPropertiesEditionPartForm.this, HrmViewsRepository.General.Properties.brokedResource,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected Composite createOwnedElementTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.ownedElement.setHelpText(propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.ownedElement, HrmViewsRepository.FORM_KIND));
	...
	protected Composite createOwnedResourceTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.ownedResource.setHelpText(propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.ownedResource, HrmViewsRepository.FORM_KIND));
	...
	protected Composite createOwnedConnectorTableComposition(FormToolkit widgetFactory, Composite parent) {
		...
		this.ownedConnector.setHelpText(propertiesEditionComponent
				.getHelpContent(HrmViewsRepository.General.Properties.ownedConnector, HrmViewsRepository.FORM_KIND));
