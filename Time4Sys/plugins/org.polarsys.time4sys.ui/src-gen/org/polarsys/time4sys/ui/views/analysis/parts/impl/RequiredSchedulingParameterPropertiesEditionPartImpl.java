 ...
 * @generated
 */
public class RequiredSchedulingParameterPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, RequiredSchedulingParameterPropertiesEditionPart {
	 ...
	 * @generated
	 */
	public RequiredSchedulingParameterPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(AnalysisMessages.RequiredSchedulingParameterPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RequiredSchedulingParameterPropertiesEditionPartImpl.this, AnalysisViewsRepository.RequiredSchedulingParameter.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.RequiredSchedulingParameter.Properties.name, AnalysisViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createParent_FlatComboViewer(Composite parent) {
		...
		parent_ = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(AnalysisViewsRepository.RequiredSchedulingParameter.Properties.parent_, AnalysisViewsRepository.SWT_KIND));
		...
		parent_.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(RequiredSchedulingParameterPropertiesEditionPartImpl.this, AnalysisViewsRepository.RequiredSchedulingParameter.Properties.parent_, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getParent_()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(AnalysisViewsRepository.RequiredSchedulingParameter.Properties.parent_, AnalysisViewsRepository.SWT_KIND), null); //$NON-NLS-1$
