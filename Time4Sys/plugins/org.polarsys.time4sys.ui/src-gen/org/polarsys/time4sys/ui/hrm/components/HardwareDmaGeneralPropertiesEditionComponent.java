 ...
 * 
 */
public class HardwareDmaGeneralPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	/**
	 * Settings for controlledMedia ReferencesTable
	 */
	private ReferencesTableSettings controlledMediaSettings;
	
	/**
	 * Settings for drivenBy ReferencesTable
	 */
	private ReferencesTableSettings drivenBySettings;
	 ...
	 * 
	 */
	public HardwareDmaGeneralPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject hardwareDma, String editing_mode) {
		super(editingContext, hardwareDma, editing_mode);
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			final HardwareDma hardwareDma = (HardwareDma)elt;
			final GeneralPropertiesEditionPart generalPart = (GeneralPropertiesEditionPart)editingPart;
			// init values
			if (isAccessible(HrmViewsRepository.General.Properties.name))
				generalPart.setName(EEFConverterUtil.convertToString(EcorePackage.Literals.ESTRING, hardwareDma.getName()));
			
			if (isAccessible(HrmViewsRepository.General.Properties.ownedResource)) {
				ownedResourceSettings = new ReferencesTableSettings(hardwareDma, GrmPackage.eINSTANCE.getResource_OwnedResource());
				generalPart.initOwnedResource(ownedResourceSettings);
			}
			if (isAccessible(HrmViewsRepository.General.Properties.resMult)) {
				generalPart.setResMult(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareDma.getResMult()));
			}
			
			if (isAccessible(HrmViewsRepository.General.Properties.isProtected)) {
				generalPart.setIsProtected(hardwareDma.isIsProtected());
			}
			if (isAccessible(HrmViewsRepository.General.Properties.isActive)) {
				generalPart.setIsActive(hardwareDma.isIsActive());
			}
			if (isAccessible(HrmViewsRepository.General.Properties.ownedConnector)) {
				ownedConnectorSettings = new ReferencesTableSettings(hardwareDma, GrmPackage.eINSTANCE.getResource_OwnedConnector());
				generalPart.initOwnedConnector(ownedConnectorSettings);
			}
			if (isAccessible(HrmViewsRepository.General.Properties.usedBy)) {
				usedBySettings = new ReferencesTableSettings(hardwareDma, GrmPackage.eINSTANCE.getResource_UsedBy());
				generalPart.initUsedBy(usedBySettings);
			}
			if (isAccessible(HrmViewsRepository.General.Properties.brokedResource)) {
				brokedResourceSettings = new ReferencesTableSettings(hardwareDma, GrmPackage.eINSTANCE.getResourceBroker_BrokedResource());
			...
			if (isAccessible(HrmViewsRepository.General.Properties.managedMemories)) {
				managedMemoriesSettings = new ReferencesTableSettings(hardwareDma, HrmPackage.eINSTANCE.getHardwareStorageManager_ManagedMemories());
				generalPart.initManagedMemories(managedMemoriesSettings);
			}
			if (isAccessible(HrmViewsRepository.General.Properties.realizedBy)) {
				realizedBySettings = new ReferencesTableSettings(hardwareDma, HrmPackage.eINSTANCE.getHardwareChannel_RealizedBy());
				generalPart.initRealizedBy(realizedBySettings);
			}
			if (isAccessible(HrmViewsRepository.General.Properties.controlledMedia)) {
				controlledMediaSettings = new ReferencesTableSettings(hardwareDma, HrmPackage.eINSTANCE.getHardwareArbiter_ControlledMedia());
				generalPart.initControlledMedia(controlledMediaSettings);
			}
			if (isAccessible(HrmViewsRepository.General.Properties.nbChannels)) {
				generalPart.setNbChannels(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareDma.getNbChannels()));
			}
			
			if (isAccessible(HrmViewsRepository.General.Properties.transferWidth)) {
				generalPart.setTransferWidth(EEFConverterUtil.convertToString(EcorePackage.Literals.EINT, hardwareDma.getTransferWidth()));
			}
			
			if (isAccessible(HrmViewsRepository.General.Properties.drivenBy)) {
				drivenBySettings = new ReferencesTableSettings(hardwareDma, HrmPackage.eINSTANCE.getHardwareDma_DrivenBy());
				generalPart.initDrivenBy(drivenBySettings);
			}
			// init filters
			...
			if (isAccessible(HrmViewsRepository.General.Properties.controlledMedia)) {
				generalPart.addFilterToControlledMedia(new EObjectFilter(HrmPackage.Literals.HARDWARE_MEDIA));
				// Start of user code for additional businessfilters for controlledMedia
				// End of user code
			}
			
			
			if (isAccessible(HrmViewsRepository.General.Properties.drivenBy)) {
				generalPart.addFilterToDrivenBy(new EObjectFilter(HrmPackage.Literals.HARDWARE_PROCESSOR));
				// Start of user code for additional businessfilters for drivenBy
				// End of user code
			}
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		...
		if (editorKey == HrmViewsRepository.General.Properties.controlledMedia) {
			return HrmPackage.eINSTANCE.getHardwareArbiter_ControlledMedia();
		}
		if (editorKey == HrmViewsRepository.General.Properties.nbChannels) {
			return HrmPackage.eINSTANCE.getHardwareDma_NbChannels();
		}
		if (editorKey == HrmViewsRepository.General.Properties.transferWidth) {
			return HrmPackage.eINSTANCE.getHardwareDma_TransferWidth();
		}
		if (editorKey == HrmViewsRepository.General.Properties.drivenBy) {
			return HrmPackage.eINSTANCE.getHardwareDma_DrivenBy();
		}
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		HardwareDma hardwareDma = (HardwareDma)semanticObject;
		if (HrmViewsRepository.General.Properties.name == event.getAffectedEditor()) {
			hardwareDma.setName((java.lang.String)EEFConverterUtil.createFromString(EcorePackage.Literals.ESTRING, (String)event.getNewValue()));
		}
		...
		if (HrmViewsRepository.General.Properties.resMult == event.getAffectedEditor()) {
			hardwareDma.setResMult((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.General.Properties.isProtected == event.getAffectedEditor()) {
			hardwareDma.setIsProtected((Boolean)event.getNewValue());
		}
		if (HrmViewsRepository.General.Properties.isActive == event.getAffectedEditor()) {
			hardwareDma.setIsActive((Boolean)event.getNewValue());
		}
		...
		if (HrmViewsRepository.General.Properties.controlledMedia == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
				if (event.getNewValue() instanceof HardwareMedia) {
					controlledMediaSettings.addToReference((EObject) event.getNewValue());
				}
			} else if (event.getKind() == PropertiesEditionEvent.REMOVE) {
				controlledMediaSettings.removeFromReference((EObject) event.getNewValue());
			} else if (event.getKind() == PropertiesEditionEvent.MOVE) {
				controlledMediaSettings.move(event.getNewIndex(), (HardwareMedia) event.getNewValue());
			}
		}
		if (HrmViewsRepository.General.Properties.nbChannels == event.getAffectedEditor()) {
			hardwareDma.setNbChannels((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.General.Properties.transferWidth == event.getAffectedEditor()) {
			hardwareDma.setTransferWidth((EEFConverterUtil.createIntFromString(EcorePackage.Literals.EINT, (String)event.getNewValue())));
		}
		if (HrmViewsRepository.General.Properties.drivenBy == event.getAffectedEditor()) {
			if (event.getKind() == PropertiesEditionEvent.ADD) {
				if (event.getNewValue() instanceof HardwareProcessor) {
					drivenBySettings.addToReference((EObject) event.getNewValue());
				}
			} else if (event.getKind() == PropertiesEditionEvent.REMOVE) {
				drivenBySettings.removeFromReference((EObject) event.getNewValue());
			} else if (event.getKind() == PropertiesEditionEvent.MOVE) {
				drivenBySettings.move(event.getNewIndex(), (HardwareProcessor) event.getNewValue());
			}
		}
	}
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (HrmPackage.eINSTANCE.getHardwareDma_NbChannels().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && generalPart != null && isAccessible(HrmViewsRepository.General.Properties.nbChannels)) {
				if (msg.getNewValue() != null) {
					generalPart.setNbChannels(EcoreUtil.convertToString(EcorePackage.Literals.EINT, msg.getNewValue()));
				} else {
					generalPart.setNbChannels("");
				}
			}
			if (HrmPackage.eINSTANCE.getHardwareDma_TransferWidth().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && generalPart != null && isAccessible(HrmViewsRepository.General.Properties.transferWidth)) {
				if (msg.getNewValue() != null) {
					generalPart.setTransferWidth(EcoreUtil.convertToString(EcorePackage.Literals.EINT, msg.getNewValue()));
				} else {
					generalPart.setTransferWidth("");
				}
			}
			if (HrmPackage.eINSTANCE.getHardwareDma_DrivenBy().equals(msg.getFeature())  && isAccessible(HrmViewsRepository.General.Properties.drivenBy))
				generalPart.updateDrivenBy();
	...
	protected NotificationFilter[] getNotificationFilters() {
		NotificationFilter filter = new EStructuralFeatureNotificationFilter(
			...
			HrmPackage.eINSTANCE.getHardwareArbiter_ControlledMedia(),
			HrmPackage.eINSTANCE.getHardwareDma_NbChannels(),
			HrmPackage.eINSTANCE.getHardwareDma_TransferWidth(),
			HrmPackage.eINSTANCE.getHardwareDma_DrivenBy()		);
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == HrmViewsRepository.General.Properties.name || key == HrmViewsRepository.General.Properties.ownedResource || key == HrmViewsRepository.General.Properties.resMult || key == HrmViewsRepository.General.Properties.isProtected || key == HrmViewsRepository.General.Properties.isActive || key == HrmViewsRepository.General.Properties.ownedConnector || key == HrmViewsRepository.General.Properties.usedBy || key == HrmViewsRepository.General.Properties.brokedResource || key == HrmViewsRepository.General.Properties.managedMemories || key == HrmViewsRepository.General.Properties.realizedBy || key == HrmViewsRepository.General.Properties.controlledMedia || key == HrmViewsRepository.General.Properties.nbChannels || key == HrmViewsRepository.General.Properties.transferWidth || key == HrmViewsRepository.General.Properties.drivenBy || key == HrmViewsRepository.General.Properties.class;
	}
	...
	public boolean isRequired(Object key, int kind) {
		return key == HrmViewsRepository.General.Properties.brokedResource || key == HrmViewsRepository.Timing.TimingProperties.accCtrlPolicy || key == HrmViewsRepository.General.Properties.managedMemories || key == HrmViewsRepository.General.Properties.controlledMedia;
	}
		...
		if (event.getNewValue() != null) {
			try {
				...
				if (HrmViewsRepository.General.Properties.nbChannels == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HrmPackage.eINSTANCE.getHardwareDma_NbChannels().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HrmPackage.eINSTANCE.getHardwareDma_NbChannels().getEAttributeType(), newValue);
				}
				if (HrmViewsRepository.General.Properties.transferWidth == event.getAffectedEditor()) {
					Object newValue = event.getNewValue();
					if (newValue instanceof String) {
						newValue = EEFConverterUtil.createFromString(HrmPackage.eINSTANCE.getHardwareDma_TransferWidth().getEAttributeType(), (String)newValue);
					}
					ret = Diagnostician.INSTANCE.validate(HrmPackage.eINSTANCE.getHardwareDma_TransferWidth().getEAttributeType(), newValue);
				}
