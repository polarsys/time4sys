...
import org.polarsys.time4sys.ui.design.components.DesignModelPropertiesEditionComponent;

/**
 * 
 * @generated
 */
public class DesignModelPropertiesEditionProvider extends PropertiesEditingProviderImpl {

	/**
	 * Constructor without provider for super types.
	 */
	public DesignModelPropertiesEditionProvider() {
		super();
	}
	 ...
	 */
	public DesignModelPropertiesEditionProvider(List<PropertiesEditingProvider> superProviders) {
	...
	public IPropertiesEditionComponent getPropertiesEditingComponent(PropertiesEditingContext editingContext, String mode, String part, java.lang.Class refinement) {
		if (editingContext.getEObject() instanceof DesignModel) {
			if (DesignModelPropertiesEditionComponent.BASE_PART.equals(part)
				&& refinement == DesignModelPropertiesEditionComponent.class)
				return new DesignModelPropertiesEditionComponent(editingContext, editingContext.getEObject(), mode);
		}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && DesignPackage.Literals.DESIGN_MODEL == eObj.eClass();
		}
