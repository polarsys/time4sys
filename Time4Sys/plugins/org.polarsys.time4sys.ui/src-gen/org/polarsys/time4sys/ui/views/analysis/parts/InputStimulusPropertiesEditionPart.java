 ...
 * @generated
 */
public interface InputStimulusPropertiesEditionPart {
	...
	/**
	 * Update the outputPorts
	 * @param newValue the outputPorts to update
	 * @generated
	 */
	public void updateOutputPorts();

	/**
	 * Adds the given filter to the outputPorts edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the outputPorts table
	 * @generated
	 */
