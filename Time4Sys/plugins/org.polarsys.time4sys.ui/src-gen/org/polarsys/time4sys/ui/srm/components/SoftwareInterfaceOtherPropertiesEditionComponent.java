 ...
 * 
 */
public class SoftwareInterfaceOtherPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	 ...
	 * 
	 */
	public SoftwareInterfaceOtherPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject softwareInterface, String editing_mode) {
		super(editingContext, softwareInterface, editing_mode);
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(SrmViewsRepository.Other.Properties.ownedService)) {
				ownedServiceSettings = new ReferencesTableSettings(softwareInterface, GrmPackage.eINSTANCE.getResourceInterface_OwnedService());
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == SrmViewsRepository.Other.Properties.ownedService) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		SoftwareInterface softwareInterface = (SoftwareInterface)semanticObject;
		if (SrmViewsRepository.Other.Properties.ownedService == event.getAffectedEditor()) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (GrmPackage.eINSTANCE.getResourceInterface_OwnedService().equals(msg.getFeature()) && isAccessible(SrmViewsRepository.Other.Properties.ownedService))
	...
	public boolean mustBeComposed(Object key, int kind) {
		return key == SrmViewsRepository.Other.Properties.ownedService || key == SrmViewsRepository.Other.Properties.class;
	}
