...
public class SamSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SamPackage.END_TO_END_FLOW: {
				...
				if (result == null) result = caseAnnotatedElement(endToEndFlow);
				if (result == null) result = caseENamedElement(endToEndFlow);
				if (result == null) result = caseModelElement(endToEndFlow);
				if (result == null) result = caseEModelElement(endToEndFlow);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SamPackage.SCHEDULING_OBSERVER: {
				SchedulingObserver schedulingObserver = (SchedulingObserver)theEObject;
				T result = caseSchedulingObserver(schedulingObserver);
				if (result == null) result = caseTimedObserver(schedulingObserver);
				if (result == null) result = caseAnnotation_Constraint(schedulingObserver);
				if (result == null) result = caseConstraint(schedulingObserver);
				if (result == null) result = casePackageableElement(schedulingObserver);
				if (result == null) result = caseNamedElement(schedulingObserver);
				if (result == null) result = caseENamedElement(schedulingObserver);
				if (result == null) result = caseModelElement(schedulingObserver);
				if (result == null) result = caseEModelElement(schedulingObserver);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Scheduling Observer</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Scheduling Observer</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSchedulingObserver(SchedulingObserver object) {
		return null;
	}
