...
public class SamAdapterFactory extends AdapterFactoryImpl {
	...
	protected SamSwitch<Adapter> modelSwitch =
		new SamSwitch<Adapter>() {
			...
			@Override
			public Adapter caseSchedulingObserver(SchedulingObserver object) {
				return createSchedulingObserverAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.time4sys.marte.sam.EndToEndFlow <em>End To End Flow</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.time4sys.marte.sam.SchedulingObserver <em>Scheduling Observer</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
