...
package org.polarsys.time4sys.grm.contextual.explorer.queries.resourceport;
...
public class ReferencedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		ResourcePort object = (ResourcePort) object_p;
		for (EObject eObject : object.getPInterface())
			result.add(eObject);
		for (EObject eObject : object.getRInterface())
			result.add(eObject);
