...
package org.polarsys.time4sys.grm.contextual.explorer.queries.resourceusage;
...
public class ReferencedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		ResourceUsage object = (ResourceUsage) object_p;
		for (EObject eObject : object.getWorkload())
			result.add(eObject);
		for (EObject eObject : object.getUsedResource())
			result.add(eObject);
