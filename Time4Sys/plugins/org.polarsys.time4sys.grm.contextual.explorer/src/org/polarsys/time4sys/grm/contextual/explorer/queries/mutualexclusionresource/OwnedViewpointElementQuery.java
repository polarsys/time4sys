...
package org.polarsys.time4sys.grm.contextual.explorer.queries.mutualexclusionresource;
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		if (object.getProtocol() != null)
			result.add(object.getProtocol());
		for (EObject eObject : object.getProtectParams())
			result.add(eObject);
