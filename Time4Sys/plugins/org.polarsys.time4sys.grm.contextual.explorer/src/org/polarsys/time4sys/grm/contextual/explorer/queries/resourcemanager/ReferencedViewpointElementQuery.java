...
package org.polarsys.time4sys.grm.contextual.explorer.queries.resourcemanager;
...
public class ReferencedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		ResourceManager object = (ResourceManager) object_p;
		for (EObject eObject : object.getManagedResource())
			result.add(eObject);
