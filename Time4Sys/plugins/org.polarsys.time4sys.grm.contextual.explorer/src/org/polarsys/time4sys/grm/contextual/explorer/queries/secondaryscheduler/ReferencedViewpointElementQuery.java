...
package org.polarsys.time4sys.grm.contextual.explorer.queries.secondaryscheduler;
...
public class ReferencedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		SecondaryScheduler object = (SecondaryScheduler) object_p;
		for (EObject eObject : object.getVirtualProcessingUnit())
			result.add(eObject);
