...
package org.polarsys.time4sys.grm.contextual.explorer.queries.resourceinterface;
...
public class OwnedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		ResourceInterface object = (ResourceInterface) object_p;

		for (EObject eObject : object.getOwnedService())
			result.add(eObject);
