...
package org.polarsys.time4sys.grm.contextual.explorer.queries.resourceinstance;
...
public class ReferencedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		ResourceInstance object = (ResourceInstance) object_p;
		if (object.getType() != null)
			result.add(object.getType());
		for (EObject eObject : object.getPort())
			result.add(eObject);
