...
public class ReferencedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		SchedulableResource object = (SchedulableResource) object_p;
		if (object.getDependentScheduler() != null)
			result.add(object.getDependentScheduler());
		if (object.getHost() != null)
			result.add(object.getHost());
