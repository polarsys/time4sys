...
package org.polarsys.time4sys.srm.contextual.explorer.queries.interruptresource;
...
public class ReferencedExternalElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		InterruptResource object = (InterruptResource) object_p;

		for (EObject eObject : object.getRoutineConnectServices())
			result.add(eObject);

		for (EObject eObject : object.getRoutineDisconnectServices())
			result.add(eObject);
