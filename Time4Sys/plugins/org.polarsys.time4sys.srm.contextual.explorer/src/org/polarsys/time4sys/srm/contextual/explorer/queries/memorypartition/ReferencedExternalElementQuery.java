...
public class ReferencedExternalElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		MemoryPartition object = (MemoryPartition) object_p;

		for (EObject eObject : object.getForkServices())
			result.add(eObject);

		for (EObject eObject : object.getExitServices())
			result.add(eObject);

		for (EObject eObject : object.getMemorySpaces())
			result.add(eObject);
