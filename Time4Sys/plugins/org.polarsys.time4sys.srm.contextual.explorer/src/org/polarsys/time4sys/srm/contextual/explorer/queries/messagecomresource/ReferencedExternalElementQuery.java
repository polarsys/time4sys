...
package org.polarsys.time4sys.srm.contextual.explorer.queries.messagecomresource;
...
public class ReferencedExternalElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		MessageComResource object = (MessageComResource) object_p;

		for (EObject eObject : object.getSendServices())
		result.add(eObject);

		for (EObject eObject : object.getReceiveServices())
			result.add(eObject);
