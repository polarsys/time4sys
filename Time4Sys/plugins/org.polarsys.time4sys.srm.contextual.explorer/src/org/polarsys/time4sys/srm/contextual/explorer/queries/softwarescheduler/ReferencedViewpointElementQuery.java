...
package org.polarsys.time4sys.srm.contextual.explorer.queries.softwarescheduler;
...
public class ReferencedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		SoftwareScheduler object = (SoftwareScheduler) object_p;
		for (EObject eObject : object.getScheduledResource())
			result.add(eObject);
