 ...
 * <!-- end-user-doc -->
 * @see org.polarsys.time4sys.design.DesignPackage
 * @generated
 */
public class DesignSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DesignPackage.DESIGN_MODEL: {
				DesignModel designModel = (DesignModel)theEObject;
				T result = caseDesignModel(designModel);
				if (result == null) result = casePackage(designModel);
				if (result == null) result = caseAnnotatedModel(designModel);
				if (result == null) result = casePackageableElement(designModel);
				if (result == null) result = caseNamedElement(designModel);
				if (result == null) result = caseENamedElement(designModel);
				if (result == null) result = caseModelElement(designModel);
				if (result == null) result = caseEModelElement(designModel);
