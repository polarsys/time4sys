...
public class AnnotationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AnnotationPackage.ANNOTATED_ELEMENT: {
				AnnotatedElement annotatedElement = (AnnotatedElement)theEObject;
				T result = caseAnnotatedElement(annotatedElement);
				if (result == null) result = caseModelElement(annotatedElement);
				if (result == null) result = caseEModelElement(annotatedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnnotationPackage.ANNOTATED_MODEL: {
				AnnotatedModel annotatedModel = (AnnotatedModel)theEObject;
				T result = caseAnnotatedModel(annotatedModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnnotationPackage.MODELING_CONCERN: {
				ModelingConcern modelingConcern = (ModelingConcern)theEObject;
				T result = caseModelingConcern(modelingConcern);
				if (result == null) result = casePackageableElement(modelingConcern);
				if (result == null) result = caseNamedElement(modelingConcern);
				if (result == null) result = caseENamedElement(modelingConcern);
				if (result == null) result = caseModelElement(modelingConcern);
				if (result == null) result = caseEModelElement(modelingConcern);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AnnotationPackage.CONSTRAINT: {
				Constraint constraint = (Constraint)theEObject;
				T result = caseConstraint(constraint);
				if (result == null) result = caseCoreElements_Constraint(constraint);
	 ...
	 * @generated
	 */
	public T caseCoreElements_Constraint(org.polarsys.time4sys.marte.nfp.coreelements.Constraint object) {
		return null;
	}
