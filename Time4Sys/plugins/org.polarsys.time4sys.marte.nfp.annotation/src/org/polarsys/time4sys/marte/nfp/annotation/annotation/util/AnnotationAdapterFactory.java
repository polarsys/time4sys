...
public class AnnotationAdapterFactory extends AdapterFactoryImpl {
	...
	protected AnnotationSwitch<Adapter> modelSwitch =
		new AnnotationSwitch<Adapter>() {
			...
			@Override
			public Adapter caseCoreElements_Constraint(org.polarsys.time4sys.marte.nfp.coreelements.Constraint object) {
				return createCoreElements_ConstraintAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.time4sys.marte.nfp.annotation.annotation.AnnotatedModel <em>Annotated Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.time4sys.marte.nfp.annotation.annotation.ModelingConcern <em>Modeling Concern</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCoreElements_ConstraintAdapter() {
		return null;
	}
