...
public class AnnotationFactoryImpl extends EFactoryImpl implements AnnotationFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case AnnotationPackage.MODELING_CONCERN: return createModelingConcern();
			case AnnotationPackage.CONSTRAINT: return createConstraint();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case AnnotationPackage.CONSTRAINT_KIND:
