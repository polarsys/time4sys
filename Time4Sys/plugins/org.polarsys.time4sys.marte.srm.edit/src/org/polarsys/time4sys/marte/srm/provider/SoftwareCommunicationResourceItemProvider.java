...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.marte.srm.SoftwareCommunicationResource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SoftwareCommunicationResourceItemProvider extends SoftwareInteractionResourceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SoftwareCommunicationResourceItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((SoftwareCommunicationResource)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SoftwareCommunicationResource_type") :
			getString("_UI_SoftwareCommunicationResource_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SoftwareCommunicationResource.class)) {
