...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.model.time4sys.AnalysisResult} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnalysisResultItemProvider extends ModelElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AnalysisResult_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AnalysisResult_name_feature", "_UI_AnalysisResult_type"),
				 Time4sysPackage.Literals.ANALYSIS_RESULT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Time4sysPackage.Literals.ANALYSIS_RESULT__MAPPING);
			childrenFeatures.add(Time4sysPackage.Literals.ANALYSIS_RESULT__ANALYSIS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Time4sysPackage.Literals.ANALYSIS_RESULT__MAPPING,
				 MappingFactory.eINSTANCE.createMapping()));

		newChildDescriptors.add
			(createChildParameter
				(Time4sysPackage.Literals.ANALYSIS_RESULT__ANALYSIS,
