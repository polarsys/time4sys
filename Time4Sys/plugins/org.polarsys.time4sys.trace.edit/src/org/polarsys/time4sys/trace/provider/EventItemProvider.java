...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.trace.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TracePackage.Literals.EVENT__TIMESTAMP,
				 true,
				 false,
				 false,
	...
	protected void addAboutPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_about_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_about_feature", "_UI_Event_type"),
				 TracePackage.Literals.EVENT__ABOUT,
				 true,
				 false,
				 true,
				 null,
