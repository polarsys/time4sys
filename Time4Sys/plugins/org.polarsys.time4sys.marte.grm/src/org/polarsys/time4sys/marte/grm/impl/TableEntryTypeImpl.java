 ...
 * </p>
 * <ul>
 * <li>{@link org.polarsys.time4sys.marte.grm.impl.TableEntryTypeImpl#getSchedule
 * <em>Schedule</em>}</li>
 * <li>{@link org.polarsys.time4sys.marte.grm.impl.TableEntryTypeImpl#getTimeSlot
 * <em>Time Slot</em>}</li>
 * <li>{@link org.polarsys.time4sys.marte.grm.impl.TableEntryTypeImpl#getOffset
 * <em>Offset</em>}</li>
 * <li>{@link org.polarsys.time4sys.marte.grm.impl.TableEntryTypeImpl#getInitialBudget
 * <em>Initial Budget</em>}</li>
 * <li>{@link org.polarsys.time4sys.marte.grm.impl.TableEntryTypeImpl#getActivation
 * <em>Activation</em>}</li>
 * </ul>
 *
 * @generated
...
public class TableEntryTypeImpl extends SchedulingParameterImpl implements TableEntryType {
	/**
	 * The cached value of the '{@link #getSchedule() <em>Schedule</em>}'
	...
	/**
	 * The cached value of the '{@link #getTimeSlot() <em>Time Slot</em>}'
	...
	/**
	 * The default value of the '{@link #getInitialBudget() <em>Initial
	 * Budget</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getInitialBudget() <em>Initial
	 * Budget</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getInitialBudget()
	 * @generated
	 ...
	 * @ordered
	 */
	protected EList<TimeInterval> activation;
		...
		if (schedule != null && schedule.eIsProxy()) {
			...
			if (schedule != oldSchedule) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GrmPackage.TABLE_ENTRY_TYPE__SCHEDULE,
	...
	public NotificationChain basicSetSchedule(TableDrivenSchedule newSchedule, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					GrmPackage.TABLE_ENTRY_TYPE__SCHEDULE, oldSchedule, newSchedule);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setSchedule(TableDrivenSchedule newSchedule) {
		if (newSchedule != schedule) {
			...
			if (schedule != null)
				msgs = ((InternalEObject) schedule).eInverseRemove(this, GrmPackage.TABLE_DRIVEN_SCHEDULE__ENTRIES,
						TableDrivenSchedule.class, msgs);
			if (newSchedule != null)
				msgs = ((InternalEObject) newSchedule).eInverseAdd(this, GrmPackage.TABLE_DRIVEN_SCHEDULE__ENTRIES,
						TableDrivenSchedule.class, msgs);
			msgs = basicSetSchedule(newSchedule, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrmPackage.TABLE_ENTRY_TYPE__SCHEDULE, newSchedule,
					newSchedule));
	}
	...
	public void eNotify(final Notification notification) {
		...
		final int featureID = notification.getFeatureID(TableEntryType.class);
		if (featureID == GrmPackage.TABLE_ENTRY_TYPE__OFFSET || featureID == GrmPackage.TABLE_ENTRY_TYPE__TIME_SLOT) {
			activation = null;
		}
	}
	...
	public void setInitialBudget(Duration newInitialBudget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrmPackage.TABLE_ENTRY_TYPE__INITIAL_BUDGET,
					oldInitialBudget, initialBudget));
	}
	 ...
	 * @generated NOT
	 */
	synchronized public EList<TimeInterval> getActivation() {
		if (activation == null) {
			final List<TimeInterval> data = new ArrayList<>();
			if (!getTimeSlot().isEmpty() && getOffset().isEmpty()) {
				getOffset().add(NfpFactory.eINSTANCE.createDurationFromString("0ps"));
			}
			assert (getTimeSlot().isEmpty() || !getOffset().isEmpty());
			final int nbSlots = getTimeSlot().size();
			final int nbOffsets = getOffset().size();
			final int maxIter = Math.max(nbSlots, nbOffsets);
			for (int i = 0; i < maxIter; ++i) {
				final TimeInterval slotTime = NfpFactory.eINSTANCE.createTimeInterval();
				final Duration startTime = getOffset().get(i % nbOffsets);
				final Duration lengthTime = getTimeSlot().get(i % nbSlots);
			...
			activation = new DelegatingEcoreEList.UnmodifiableEList<TimeInterval>(this,
					GrmPackage.eINSTANCE.getTableEntryType_Activation(), data);
		}
		return activation;
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case GrmPackage.TABLE_ENTRY_TYPE__ACTIVATION:
			getActivation().clear();
			getActivation().addAll((Collection<? extends TimeInterval>) newValue);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case GrmPackage.TABLE_ENTRY_TYPE__INITIAL_BUDGET:
			return INITIAL_BUDGET_EDEFAULT == null ? initialBudget != null
					: !INITIAL_BUDGET_EDEFAULT.equals(initialBudget);
		case GrmPackage.TABLE_ENTRY_TYPE__ACTIVATION:
