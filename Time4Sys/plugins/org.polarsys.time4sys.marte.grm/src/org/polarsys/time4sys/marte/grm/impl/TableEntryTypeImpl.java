 ...
 *   <li>{@link org.polarsys.time4sys.marte.grm.impl.TableEntryTypeImpl#getActivation <em>Activation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableEntryTypeImpl extends SchedulingParameterImpl implements TableEntryType {
	...
	/**
	 * The cached value of the '{@link #getActivation() <em>Activation</em>}' attribute list.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see #getActivation()
	 * @generated
	 * @ordered
	...
	public EList<Duration> getTimeSlot() {
		if (timeSlot == null) {
			timeSlot = new EDataTypeEList<Duration>(Duration.class, this, GrmPackage.TABLE_ENTRY_TYPE__TIME_SLOT);
		}
		return timeSlot;
	}
	...
	public EList<Duration> getOffset() {
		if (offset == null) {
			offset = new EDataTypeUniqueEList<Duration>(Duration.class, this, GrmPackage.TABLE_ENTRY_TYPE__OFFSET);
		}
		return offset;
	}
