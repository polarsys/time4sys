 ...
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.time4sys.marte.nfp.coreelements.impl.DirectedRelationshipImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.polarsys.time4sys.marte.nfp.coreelements.impl.DirectedRelationshipImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DirectedRelationshipImpl extends MinimalEObjectImpl.Container implements DirectedRelationship {
	...
	public EList<EObject> getSource() {
		if (source == null) {
			source = new EObjectResolvingEList<EObject>(EObject.class, this, CoreElementsPackage.DIRECTED_RELATIONSHIP__SOURCE);
		}
		return source;
	}
	...
	public EList<EObject> getTarget() {
		if (target == null) {
			target = new EObjectResolvingEList<EObject>(EObject.class, this, CoreElementsPackage.DIRECTED_RELATIONSHIP__TARGET);
		}
		return target;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CoreElementsPackage.DIRECTED_RELATIONSHIP__SOURCE:
				return getSource();
			case CoreElementsPackage.DIRECTED_RELATIONSHIP__TARGET:
				return getTarget();
		}
