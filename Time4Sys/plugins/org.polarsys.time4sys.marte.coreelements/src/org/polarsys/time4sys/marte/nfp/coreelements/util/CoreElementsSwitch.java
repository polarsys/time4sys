...
public class CoreElementsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CoreElementsPackage.ABSTRACTION: {
				...
				if (result == null) result = caseENamedElement(abstraction);
				if (result == null) result = caseModelElement(abstraction);
				if (result == null) result = caseEModelElement(abstraction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CoreElementsPackage.CONSTRAINT: {
			...
			case CoreElementsPackage.DEPENDENCY: {
			...
			case CoreElementsPackage.DIRECTED_RELATIONSHIP: {
			...
			case CoreElementsPackage.MODEL_ELEMENT: {
				ModelElement modelElement = (ModelElement)theEObject;
				T result = caseModelElement(modelElement);
				if (result == null) result = caseEModelElement(modelElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CoreElementsPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = caseENamedElement(namedElement);
				if (result == null) result = caseModelElement(namedElement);
				if (result == null) result = caseEModelElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CoreElementsPackage.PACKAGE: {
				org.polarsys.time4sys.marte.nfp.coreelements.Package package_ = (org.polarsys.time4sys.marte.nfp.coreelements.Package)theEObject;
			...
			case CoreElementsPackage.PACKAGEABLE_ELEMENT: {
				...
				if (result == null) result = caseENamedElement(packageableElement);
