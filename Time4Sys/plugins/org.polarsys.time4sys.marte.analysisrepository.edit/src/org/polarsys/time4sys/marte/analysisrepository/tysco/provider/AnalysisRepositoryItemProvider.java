...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.marte.analysisrepository.tysco.AnalysisRepository} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnalysisRepositoryItemProvider 
	 ...
	 * @generated
	 */
	public AnalysisRepositoryItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AnalysisRepository_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AnalysisRepository_name_feature", "_UI_AnalysisRepository_type"),
				 TyscoPackage.Literals.ANALYSIS_REPOSITORY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AnalysisRepository_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AnalysisRepository_description_feature", "_UI_AnalysisRepository_type"),
				 TyscoPackage.Literals.ANALYSIS_REPOSITORY__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns AnalysisRepository.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AnalysisRepository"));
	}
	...
	public String getText(Object object) {
		String label = ((AnalysisRepository)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AnalysisRepository_type") :
			getString("_UI_AnalysisRepository_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AnalysisRepository.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TyscoPackage.Literals.ANALYSIS_REPOSITORY__ALL_CONTEXT_MODELS,
				 TyscoFactory.eINSTANCE.createContextModel()));

		newChildDescriptors.add
			(createChildParameter
				(TyscoPackage.Literals.ANALYSIS_REPOSITORY__ALL_RULES,
				 TyscoFactory.eINSTANCE.createIdentificationRule()));
