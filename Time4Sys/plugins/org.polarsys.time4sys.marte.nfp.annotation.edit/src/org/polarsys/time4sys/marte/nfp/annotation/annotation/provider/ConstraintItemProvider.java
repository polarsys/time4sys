...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.marte.nfp.annotation.annotation.Constraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConstraintItemProvider extends org.polarsys.time4sys.marte.nfp.coreelements.provider.ConstraintItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AnnotationPackage.Literals.CONSTRAINT__CONSTRAINED_ELEMENT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AnnotationPackage.Literals.CONSTRAINT__CONTEXT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addKindPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constraint_kind_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constraint_kind_feature", "_UI_Constraint_type"),
				 AnnotationPackage.Literals.CONSTRAINT__KIND,
				 true,
				 false,
				 false,
