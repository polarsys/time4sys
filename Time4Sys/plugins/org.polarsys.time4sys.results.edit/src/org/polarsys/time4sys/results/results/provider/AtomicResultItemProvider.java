...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.results.results.AtomicResult} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AtomicResultItemProvider extends AbstractResultItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AtomicResultItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AtomicResult)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AtomicResult_type") :
			getString("_UI_AtomicResult_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AtomicResult.class)) {
			case ResultsPackage.ATOMIC_RESULT__LOAD:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case ResultsPackage.ATOMIC_RESULT__PARAMETER:
