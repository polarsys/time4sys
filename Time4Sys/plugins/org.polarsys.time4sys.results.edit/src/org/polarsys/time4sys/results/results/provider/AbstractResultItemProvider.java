...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.results.results.AbstractResult} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractResultItemProvider extends NamedElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AbstractResultItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractResult)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractResult_type") :
			getString("_UI_AbstractResult_type") + " " + label;
	}
