...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.results.results.AbstractResultReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractResultReferenceItemProvider extends NamedElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AbstractResultReferenceItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractResultReference)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractResultReference_type") :
			getString("_UI_AbstractResultReference_type") + " " + label;
	}
