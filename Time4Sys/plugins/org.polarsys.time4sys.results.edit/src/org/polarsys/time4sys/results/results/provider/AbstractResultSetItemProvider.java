...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.results.results.AbstractResultSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractResultSetItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
	 ...
	 * @generated
	 */
	public AbstractResultSetItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractResultSet)object).getToolName();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractResultSet_type") :
			getString("_UI_AbstractResultSet_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractResultSet.class)) {
