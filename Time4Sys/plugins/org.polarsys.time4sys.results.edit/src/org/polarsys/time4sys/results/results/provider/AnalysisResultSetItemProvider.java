...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.results.results.AnalysisResultSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnalysisResultSetItemProvider extends NamedElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AnalysisResultSetItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addNbOfIterationsPropertyDescriptor(object);
			addHasConvergedPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Nb Of Iterations feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNbOfIterationsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AnalysisResultSet_nbOfIterations_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AnalysisResultSet_nbOfIterations_feature", "_UI_AnalysisResultSet_type"),
				 ResultsPackage.Literals.ANALYSIS_RESULT_SET__NB_OF_ITERATIONS,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Has Converged feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addHasConvergedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AnalysisResultSet_hasConverged_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AnalysisResultSet_hasConverged_feature", "_UI_AnalysisResultSet_type"),
				 ResultsPackage.Literals.ANALYSIS_RESULT_SET__HAS_CONVERGED,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns AnalysisResultSet.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AnalysisResultSet"));
	}
	...
	public String getText(Object object) {
		String label = ((AnalysisResultSet)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AnalysisResultSet_type") :
			getString("_UI_AnalysisResultSet_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AnalysisResultSet.class)) {
