...
package org.polarsys.time4sys.gqam.contextual.explorer.queries.acquirestep;
...
public class ReferencedExternalElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		AcquireStep object = (AcquireStep) object_p;

		if (object.getAcqRes() != null)
			result.add(object.getAcqRes());
