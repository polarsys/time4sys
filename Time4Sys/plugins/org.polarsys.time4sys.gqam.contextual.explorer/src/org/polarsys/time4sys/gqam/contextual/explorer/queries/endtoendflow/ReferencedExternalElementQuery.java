...
package org.polarsys.time4sys.gqam.contextual.explorer.queries.endtoendflow;
...
public class ReferencedExternalElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		EndToEndFlow object = (EndToEndFlow) object_p;

		if (object.getEndToEndTime() != null)
			result.add(object.getEndToEndTime());

		if (object.getEndToEndDeadline() != null)
			result.add(object.getEndToEndDeadline());
