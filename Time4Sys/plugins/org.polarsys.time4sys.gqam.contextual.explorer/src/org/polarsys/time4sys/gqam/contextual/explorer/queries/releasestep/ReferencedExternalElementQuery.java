...
package org.polarsys.time4sys.gqam.contextual.explorer.queries.releasestep;
...
public class ReferencedExternalElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		ReleaseStep object = (ReleaseStep) object_p;

		if (object.getRelRes() != null)
			result.add(object.getRelRes());
