...
package org.polarsys.time4sys.gqam.contextual.explorer.queries.sporadicpattern;
...
public class ReferencedExternalElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		SporadicPattern object = (SporadicPattern) object_p;

		if (object.getMinInterarrival() != null)
			result.add(object.getMinInterarrival());

		if (object.getMaxInterarrival() != null)
			result.add(object.getMaxInterarrival());

		if (object.getJitter() != null)
			result.add(object.getJitter());
