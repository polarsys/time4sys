...
package org.polarsys.time4sys.gqam.contextual.explorer.queries.workloadbehavior;
...
public class OwnedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		WorkloadBehavior object = (WorkloadBehavior) object_p;

		for (EObject eObject : object.getBehavior())
			result.add(eObject);
		for (EObject eObject : object.getDemand())
			result.add(eObject);
		for (EObject eObject : object.getReferences())
			result.add(eObject);
