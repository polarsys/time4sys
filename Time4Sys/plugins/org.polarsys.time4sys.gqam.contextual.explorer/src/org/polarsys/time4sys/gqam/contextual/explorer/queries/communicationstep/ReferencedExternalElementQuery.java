...
package org.polarsys.time4sys.gqam.contextual.explorer.queries.communicationstep;
...
public class ReferencedExternalElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		CommunicationStep object = (CommunicationStep) object_p;

		if (object.getComRes() != null)
			result.add(object.getComRes());
