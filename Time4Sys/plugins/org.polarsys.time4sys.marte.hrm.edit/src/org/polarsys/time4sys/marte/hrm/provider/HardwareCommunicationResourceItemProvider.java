...
import org.polarsys.time4sys.marte.grm.provider.CommunicationResourceItemProvider;
 ...
 * @generated
 */
public class HardwareCommunicationResourceItemProvider extends CommunicationResourceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HardwareCommunicationResourceItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns HardwareCommunicationResource.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HardwareCommunicationResource"));
	}
	...
	public String getText(Object object) {
		String label = ((HardwareCommunicationResource)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HardwareCommunicationResource_type") :
			getString("_UI_HardwareCommunicationResource_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HardwareCommunicationResource.class)) {
