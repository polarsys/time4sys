...
import org.polarsys.time4sys.marte.grm.provider.ResourcePortItemProvider;
import org.polarsys.time4sys.marte.hrm.HardwarePort;
import org.polarsys.time4sys.marte.hrm.HrmFactory;
import org.polarsys.time4sys.marte.hrm.HrmPackage;

/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.marte.hrm.HardwarePort} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HardwarePortItemProvider extends ResourcePortItemProvider {
	/**
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HardwarePort_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HardwarePort_type_feature", "_UI_HardwarePort_type"),
				 HrmPackage.Literals.HARDWARE_PORT__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addRealizedByPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HardwarePort_realizedBy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HardwarePort_realizedBy_feature", "_UI_HardwarePort_type"),
				 HrmPackage.Literals.HARDWARE_PORT__REALIZED_BY,
				 true,
				 false,
				 true,
				 null,
