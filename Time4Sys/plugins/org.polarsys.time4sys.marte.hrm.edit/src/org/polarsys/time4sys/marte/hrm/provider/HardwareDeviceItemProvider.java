...
import org.polarsys.time4sys.marte.grm.provider.DeviceResourceItemProvider;
...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.marte.hrm.HardwareDevice} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HardwareDeviceItemProvider extends DeviceResourceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HardwareDeviceItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns HardwareDevice.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HardwareDevice"));
	}
	...
	public String getText(Object object) {
		String label = ((HardwareDevice)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HardwareDevice_type") :
			getString("_UI_HardwareDevice_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HardwareDevice.class)) {
