...
import org.polarsys.time4sys.marte.grm.provider.StorageResourceItemProvider;
import org.polarsys.time4sys.marte.hrm.HardwareMemory;
import org.polarsys.time4sys.marte.hrm.HrmFactory;
import org.polarsys.time4sys.marte.hrm.HrmPackage;

/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.marte.hrm.HardwareMemory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HardwareMemoryItemProvider extends StorageResourceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HardwareMemoryItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addAddressSizePropertyDescriptor(object);
			addTimingsPropertyDescriptor(object);
	...
	protected void addMemorySizePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HardwareMemory_memorySize_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HardwareMemory_memorySize_feature", "_UI_HardwareMemory_type"),
				 HrmPackage.Literals.HARDWARE_MEMORY__MEMORY_SIZE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Address Size feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addAddressSizePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HardwareMemory_addressSize_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HardwareMemory_addressSize_feature", "_UI_HardwareMemory_type"),
				 HrmPackage.Literals.HARDWARE_MEMORY__ADDRESS_SIZE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Timings feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTimingsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HardwareMemory_timings_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HardwareMemory_timings_feature", "_UI_HardwareMemory_type"),
				 HrmPackage.Literals.HARDWARE_MEMORY__TIMINGS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addThroughputPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HardwareMemory_throughput_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HardwareMemory_throughput_feature", "_UI_HardwareMemory_type"),
				 HrmPackage.Literals.HARDWARE_MEMORY__THROUGHPUT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	/**
	 * This returns HardwareMemory.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HardwareMemory"));
	}
	...
	public String getText(Object object) {
		String label = ((HardwareMemory)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HardwareMemory_type") :
			getString("_UI_HardwareMemory_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HardwareMemory.class)) {
