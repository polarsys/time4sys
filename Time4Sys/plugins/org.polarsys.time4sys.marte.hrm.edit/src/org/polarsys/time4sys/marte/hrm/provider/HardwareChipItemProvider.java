...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.marte.hrm.HardwareChip} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HardwareChipItemProvider extends HardwareComponentItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HardwareChipItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		HardwareChip hardwareChip = (HardwareChip)object;
		return getString("_UI_HardwareChip_type") + " " + hardwareChip.getDimension();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(HardwareChip.class)) {
