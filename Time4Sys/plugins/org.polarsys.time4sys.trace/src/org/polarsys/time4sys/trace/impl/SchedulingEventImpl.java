...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Scheduling Event</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.time4sys.trace.impl.SchedulingEventImpl#getKind <em>Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SchedulingEventImpl extends EventImpl implements SchedulingEvent {
	 ...
	 * @generated
	 */
	public void setKind(SchedulingEventKind newKind) {
		SchedulingEventKind oldKind = kind;
		kind = newKind == null ? KIND_EDEFAULT : newKind;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TracePackage.SCHEDULING_EVENT__KIND, oldKind, kind));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case TracePackage.SCHEDULING_EVENT__KIND:
				setKind((SchedulingEventKind)newValue);
				return;
		}
