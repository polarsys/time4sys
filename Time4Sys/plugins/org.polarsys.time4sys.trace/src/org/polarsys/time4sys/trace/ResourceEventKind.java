...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Resource Event Kind</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.polarsys.time4sys.trace.TracePackage#getResourceEventKind()
 * @model
 * @generated
 */
public enum ResourceEventKind implements Enumerator {
	/**
	 * The '<em><b>ACQUIRED</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #ACQUIRED_VALUE
	 * @generated
	...
	/**
	 * The '<em><b>ACQUIRED</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>ACQUIRED</b></em>' literal object isn't clear,
	...
	/**
	 * An array of all the '<em><b>Resource Event Kind</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ResourceEventKind[] VALUES_ARRAY =
		new ResourceEventKind[] {
			ACQUIRED,
			RELEASED,
			REQUESTED,
		};
	...
	/**
	 * A public read-only list of all the '<em><b>Resource Event Kind</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ResourceEventKind> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Resource Event Kind</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the '<em><b>Resource Event Kind</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	...
	/**
	 * Returns the '<em><b>Resource Event Kind</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public static ResourceEventKind get(int value) {
		switch (value) {
			case ACQUIRED_VALUE: return ACQUIRED;
