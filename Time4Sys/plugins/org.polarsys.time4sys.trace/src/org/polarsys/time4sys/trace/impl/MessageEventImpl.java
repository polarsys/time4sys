 ...
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.time4sys.trace.impl.MessageEventImpl#getKind <em>Kind</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MessageEventImpl extends EventImpl implements MessageEvent {
	 ...
	 * @ordered
	 */
	protected static final MessageEventKind KIND_EDEFAULT = MessageEventKind.INSTANTIATED;
	...
	protected EClass eStaticClass() {
		return TracePackage.Literals.MESSAGE_EVENT;
	}
	...
	public void setKind(MessageEventKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TracePackage.MESSAGE_EVENT__KIND, oldKind, kind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TracePackage.MESSAGE_EVENT__KIND:
				return getKind();
		}
