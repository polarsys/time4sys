...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.schedulingtrace.TaskTrace} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskTraceItemProvider extends SliceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TaskTraceItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TaskTrace_jobWithMaxRT_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TaskTrace_jobWithMaxRT_feature", "_UI_TaskTrace_type"),
				 SchedulingtracePackage.Literals.TASK_TRACE__JOB_WITH_MAX_RT,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SchedulingtracePackage.Literals.TASK_TRACE__JOBS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TaskTrace"));
	}
	...
	public String getText(Object object) {
		String label = ((TaskTrace)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_TaskTrace_type") :
			getString("_UI_TaskTrace_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TaskTrace.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SchedulingtracePackage.Literals.TASK_TRACE__JOBS,
				 SchedulingtraceFactory.eINSTANCE.createJob()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == SchedulingtracePackage.Literals.TASK_TRACE__JOBS;
