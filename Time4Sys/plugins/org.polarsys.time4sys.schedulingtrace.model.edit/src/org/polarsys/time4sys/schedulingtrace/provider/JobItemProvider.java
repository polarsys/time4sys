...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.schedulingtrace.Job} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JobItemProvider extends SliceItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Job_schedulableResource_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Job_schedulableResource_feature", "_UI_Job_type"),
				 SchedulingtracePackage.Literals.JOB__SCHEDULABLE_RESOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SchedulingtracePackage.Literals.JOB__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SchedulingtracePackage.Literals.JOB__FUNCTION_INSTANCES);
			childrenFeatures.add(SchedulingtracePackage.Literals.JOB__LIST_PREEMPTED_BY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SchedulingtracePackage.Literals.JOB__FUNCTION_INSTANCES,
				 SchedulingtraceFactory.eINSTANCE.createFunctionInstance()));

		newChildDescriptors.add
			(createChildParameter
				(SchedulingtracePackage.Literals.JOB__LIST_PREEMPTED_BY,
				 SchedulingtraceFactory.eINSTANCE.createPreemptedBy()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == SchedulingtracePackage.Literals.JOB__FUNCTION_INSTANCES;
