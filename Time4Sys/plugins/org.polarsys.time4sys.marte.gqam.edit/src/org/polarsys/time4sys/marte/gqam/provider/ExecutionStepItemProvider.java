...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.marte.gqam.ExecutionStep} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExecutionStepItemProvider extends StepItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((ExecutionStep)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ExecutionStep_type") :
			getString("_UI_ExecutionStep_type") + " " + label;
	}
