...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.marte.gqam.WorkloadEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WorkloadEventItemProvider extends NamedElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public WorkloadEventItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GqamPackage.Literals.WORKLOAD_EVENT__PATTERN);
		}
	...
	/**
	 * This returns WorkloadEvent.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/WorkloadEvent"));
	}
	...
	public String getText(Object object) {
		String label = ((WorkloadEvent)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_WorkloadEvent_type") :
			getString("_UI_WorkloadEvent_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(WorkloadEvent.class)) {
