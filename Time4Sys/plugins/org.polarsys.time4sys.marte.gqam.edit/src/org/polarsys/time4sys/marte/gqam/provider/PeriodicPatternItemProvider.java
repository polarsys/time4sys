...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.marte.gqam.PeriodicPattern} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PeriodicPatternItemProvider extends ArrivalPatternItemProvider {
	/**
	...
	protected void addOccurencesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PeriodicPattern_occurences_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PeriodicPattern_occurences_feature", "_UI_PeriodicPattern_type"),
				 GqamPackage.Literals.PERIODIC_PATTERN__OCCURENCES,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Duration labelValue = ((PeriodicPattern)object).getJitter();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_PeriodicPattern_type") :
			getString("_UI_PeriodicPattern_type") + " " + label;
	}
