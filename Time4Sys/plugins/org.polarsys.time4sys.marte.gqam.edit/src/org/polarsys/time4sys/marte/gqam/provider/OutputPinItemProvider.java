...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.marte.gqam.OutputPin} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OutputPinItemProvider extends ControlPinItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OutputPin_successors_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OutputPin_successors_feature", "_UI_OutputPin_type"),
				 GqamPackage.Literals.OUTPUT_PIN__SUCCESSORS,
				 true,
				 false,
				 true,
				 null,
