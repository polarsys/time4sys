...
package org.polarsys.time4sys.hrm.contextual.explorer.queries.hardwaretimer;
...
public class ReferencedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		HardwareTimer object = (HardwareTimer) object_p;
		if (object.getInputClock() != null)
			result.add(object.getInputClock());
