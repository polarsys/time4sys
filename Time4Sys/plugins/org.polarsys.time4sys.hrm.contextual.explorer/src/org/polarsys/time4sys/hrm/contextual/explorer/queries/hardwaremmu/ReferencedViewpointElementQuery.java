...
package org.polarsys.time4sys.hrm.contextual.explorer.queries.hardwaremmu;
...
public class ReferencedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		HardwareMmu object = (HardwareMmu) object_p;
		for (EObject eObject : object.getOwnedTlbs())
			result.add(eObject);
