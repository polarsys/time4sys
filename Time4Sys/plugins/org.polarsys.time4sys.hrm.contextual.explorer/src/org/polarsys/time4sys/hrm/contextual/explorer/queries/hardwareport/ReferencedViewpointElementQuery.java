...
package org.polarsys.time4sys.hrm.contextual.explorer.queries.hardwareport;
...
public class ReferencedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		HardwarePort object = (HardwarePort) object_p;
		for (EObject eObject : object.getRealizedBy())
			result.add(eObject);
