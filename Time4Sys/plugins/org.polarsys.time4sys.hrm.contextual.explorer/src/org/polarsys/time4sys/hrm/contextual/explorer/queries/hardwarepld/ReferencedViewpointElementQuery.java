...
package org.polarsys.time4sys.hrm.contextual.explorer.queries.hardwarepld;
...
public class ReferencedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		HardwarePld object = (HardwarePld) object_p;
		for (EObject eObject : object.getBlocksRam())
			result.add(eObject);
		if (object.getArchitecture() != null)
			result.add(object.getArchitecture());
		for (EObject eObject : object.getIpBlock())
			result.add(eObject);
