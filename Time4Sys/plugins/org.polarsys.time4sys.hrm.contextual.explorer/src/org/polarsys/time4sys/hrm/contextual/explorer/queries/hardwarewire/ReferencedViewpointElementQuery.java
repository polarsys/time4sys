...
package org.polarsys.time4sys.hrm.contextual.explorer.queries.hardwarewire;
...
public class ReferencedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		HardwareWire object = (HardwareWire) object_p;
		if (object.getSourcePin() != null)
			result.add(object.getSourcePin());
		if (object.getTargetPin() != null)
			result.add(object.getTargetPin());
