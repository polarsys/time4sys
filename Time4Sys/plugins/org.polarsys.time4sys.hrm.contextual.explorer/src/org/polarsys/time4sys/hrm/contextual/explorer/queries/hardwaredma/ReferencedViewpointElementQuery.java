...
package org.polarsys.time4sys.hrm.contextual.explorer.queries.hardwaredma;
...
public class ReferencedViewpointElementQuery implements IQuery {
	...
	*/
	public List<Object> compute(Object object_p) {
		...
		HardwareDma object = (HardwareDma) object_p;
		for (EObject eObject : object.getDrivenBy())
			result.add(eObject);
