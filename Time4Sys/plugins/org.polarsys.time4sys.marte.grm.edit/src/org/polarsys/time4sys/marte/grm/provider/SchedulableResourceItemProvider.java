...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.marte.grm.SchedulableResource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SchedulableResourceItemProvider extends ConcurrencyResourceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SchedulableResourceItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SchedulableResource.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SchedulableResource"));
	}
	...
	public String getText(Object object) {
		String label = ((SchedulableResource)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SchedulableResource_type") :
			getString("_UI_SchedulableResource_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SchedulableResource.class)) {
