...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.marte.grm.SecondaryScheduler} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SecondarySchedulerItemProvider extends SchedulerItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addVirtualProcessingUnitPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Virtual Processing Unit feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addVirtualProcessingUnitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SecondaryScheduler_virtualProcessingUnit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SecondaryScheduler_virtualProcessingUnit_feature", "_UI_SecondaryScheduler_type"),
				 GrmPackage.Literals.SECONDARY_SCHEDULER__VIRTUAL_PROCESSING_UNIT,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((SecondaryScheduler)object).getName();
