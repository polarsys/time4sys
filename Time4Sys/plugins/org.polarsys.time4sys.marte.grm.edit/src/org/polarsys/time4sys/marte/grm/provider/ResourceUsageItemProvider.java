...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.marte.grm.ResourceUsage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceUsageItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceUsage_workload_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceUsage_workload_feature", "_UI_ResourceUsage_type"),
				 GrmPackage.Literals.RESOURCE_USAGE__WORKLOAD,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addUsedResourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceUsage_usedResource_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceUsage_usedResource_feature", "_UI_ResourceUsage_type"),
				 GrmPackage.Literals.RESOURCE_USAGE__USED_RESOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GrmPackage.Literals.RESOURCE_USAGE__REQUIRED_AMOUNT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GrmPackage.Literals.RESOURCE_USAGE__REQUIRED_AMOUNT,
