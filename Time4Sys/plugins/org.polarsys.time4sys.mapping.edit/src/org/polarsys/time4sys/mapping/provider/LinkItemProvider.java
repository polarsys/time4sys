...
/**
 * This is the item provider adapter for a {@link org.polarsys.time4sys.mapping.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Link_rationale_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Link_rationale_feature", "_UI_Link_type"),
				 MappingPackage.Literals.LINK__RATIONALE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MappingPackage.Literals.LINK__SUB_LINKS);
			childrenFeatures.add(MappingPackage.Literals.LINK__SOURCES);
			childrenFeatures.add(MappingPackage.Literals.LINK__TARGETS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MappingPackage.Literals.LINK__SUB_LINKS,
		...
		newChildDescriptors.add
			(createChildParameter
				(MappingPackage.Literals.LINK__SOURCES,
				 MappingFactory.eINSTANCE.createMappableArtefact()));

		newChildDescriptors.add
			(createChildParameter
				(MappingPackage.Literals.LINK__SOURCES,
				 MappingFactory.eINSTANCE.createResourceArtefact()));

		newChildDescriptors.add
			(createChildParameter
				(MappingPackage.Literals.LINK__TARGETS,
				 MappingFactory.eINSTANCE.createMappableArtefact()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == MappingPackage.Literals.LINK__SOURCES ||
			childFeature == MappingPackage.Literals.LINK__TARGETS;
