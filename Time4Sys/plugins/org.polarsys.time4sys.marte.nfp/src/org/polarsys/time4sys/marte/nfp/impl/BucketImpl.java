 ...
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.time4sys.marte.nfp.impl.BucketImpl#getProbability <em>Probability</em>}</li>
 *   <li>{@link org.polarsys.time4sys.marte.nfp.impl.BucketImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BucketImpl extends MinimalEObjectImpl.Container implements Bucket {
	...
	public void setProbability(double newProbability) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NfpPackage.BUCKET__PROBABILITY, oldProbability, probability));
	}
	...
	public void setValue(Duration newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NfpPackage.BUCKET__VALUE, oldValue, value));
	}
